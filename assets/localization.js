 ...
 */
var _onContainerKeyDown = /*#__PURE__*/new WeakMap();
var _LocalizationFormComponent_brand = /*#__PURE__*/new WeakSet();
var _onSearchKeyDown = /*#__PURE__*/new WeakMap();
var _onCountryListScroll = /*#__PURE__*/new WeakMap();
var LocalizationFormComponent = /*#__PURE__*/function (_Component) {
  function LocalizationFormComponent() {
    var _this;
    _classCallCheck(this, LocalizationFormComponent);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, LocalizationFormComponent, [].concat(args));
    /**
     ...
     */
    _classPrivateMethodInitSpec(_this, _LocalizationFormComponent_brand);
    /**
     * Handles the keydown event for the container.
     *
     * @param {KeyboardEvent} event - The event object.
     */
    _classPrivateFieldInitSpec(_this, _onContainerKeyDown, function (event) {
      var _this$refs = _this.refs,
        countryInput = _this$refs.countryInput,
        countryListItems = _this$refs.countryListItems,
        form = _this$refs.form;
      switch (event.key) {
        case 'ArrowUp':
          event.preventDefault();
          event.stopPropagation();
          _assertClassBrand(_LocalizationFormComponent_brand, _this, _changeCountryFocus).call(_this, 'UP');
          break;
        case 'ArrowDown':
          event.preventDefault();
          event.stopPropagation();
          _assertClassBrand(_LocalizationFormComponent_brand, _this, _changeCountryFocus).call(_this, 'DOWN');
          break;
        case 'Enter':
          {
            event.preventDefault();
            event.stopPropagation();
            var focusedItem = countryListItems.find(function (item) {
              return item.getAttribute('aria-selected') === 'true';
            });
            if (focusedItem) {
              var _focusedItem$dataset$;
              countryInput.value = (_focusedItem$dataset$ = focusedItem.dataset.value) !== null && _focusedItem$dataset$ !== void 0 ? _focusedItem$dataset$ : '';
              form.submit();
            }
            break;
          }
      ...
      setTimeout(function () {
        var focusableItems = _this.refs.countryListItems.filter(function (item) {
          return !item.hasAttribute('hidden');
        });
        var focusedItemIndex = focusableItems.findIndex(function (item) {
          return item === document.activeElement;
        });
        var focusedItem = focusableItems[focusedItemIndex];
        if (focusedItem) {
          _this.refs.search.setAttribute('aria-activedescendant', focusedItem.id);
        } else {
          _this.refs.search.setAttribute('aria-activedescendant', '');
        }
      });
    });
    /**
     ...
     */
    _defineProperty(_this, "selectCountry", function (countryName, event) {
      event.preventDefault();
      var _this$refs2 = _this.refs,
        countryInput = _this$refs2.countryInput,
        form = _this$refs2.form;
      countryInput.value = countryName;
      form === null || form === void 0 || form.submit();
    });
    /**
     ...
     * @param {KeyboardEvent} event - The event object.
     */
    _classPrivateFieldInitSpec(_this, _onSearchKeyDown, function (event) {
      if (event.key === 'Enter') {
        event.preventDefault();
        event.stopPropagation();
        return;
      }
      _classPrivateFieldGet(_onContainerKeyDown, _this).call(_this, event);
    });
    /**
     ...
     */
    _classPrivateFieldInitSpec(_this, _onCountryListScroll, function (event) {
      var countryFilter = _this.querySelector('.country-filter');
      var countryList = event.target instanceof HTMLElement ? event.target : null;
      if (countryFilter && countryList) {
        var shouldShowBorder = countryList.scrollTop > 0;
        countryFilter.classList.toggle('is-scrolled', shouldShowBorder);
      }
    });
    return _this;
  }
  _inherits(LocalizationFormComponent, _Component);
  return _createClass(LocalizationFormComponent, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(LocalizationFormComponent, "connectedCallback", this, 3)([]);
      this.refs.search && this.refs.search.addEventListener('keydown', _classPrivateFieldGet(_onSearchKeyDown, this));
      this.refs.countryList && this.refs.countryList.addEventListener('keydown', _classPrivateFieldGet(_onContainerKeyDown, this));
      this.refs.countryList && this.refs.countryList.addEventListener('scroll', _classPrivateFieldGet(_onCountryListScroll, this));
      this.resizeLanguageInput();
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(LocalizationFormComponent, "disconnectedCallback", this, 3)([]);
      this.refs.search && this.refs.search.removeEventListener('keydown', _classPrivateFieldGet(_onSearchKeyDown, this));
      this.refs.countryList && this.refs.countryList.removeEventListener('keydown', _classPrivateFieldGet(_onContainerKeyDown, this));
      this.refs.countryList && this.refs.countryList.removeEventListener('scroll', _classPrivateFieldGet(_onCountryListScroll, this));
    }
  }, {
    key: "changeLanguage",
    value:
    ...
    function changeLanguage(event) {
      var _this$refs3 = this.refs,
        form = _this$refs3.form,
        languageInput = _this$refs3.languageInput;
      var value = event.target instanceof HTMLSelectElement ? event.target.value : null;
      if (value) {
    ...
    key: "resizeLanguageInput",
    value: function resizeLanguageInput() {
      var languageInput = this.refs.languageInput;
      if (!languageInput) return;

      // Hide all options except the selected option
      var _iterator = _createForOfIteratorHelper(languageInput.options),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var originalElementWidth = "".concat(Math.ceil(languageInput.offsetWidth) + 1, "px");
      ...
      var _iterator2 = _createForOfIteratorHelper(languageInput.options),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _option = _step2.value;
          if (_option.dataset.optionLabel) {
            _option.textContent = _option.dataset.optionLabel;
            delete _option.dataset.optionLabel;
          }
        }
      } catch (err) {
        _iterator2.e(err);
    ...
    function filterCountries() {
      var _this$refs4 = this.refs,
        countryList = _this$refs4.countryList,
        countryListItems = _this$refs4.countryListItems,
        liveRegion = _this$refs4.liveRegion,
        noResultsMessage = _this$refs4.noResultsMessage,
        popularCountries = _this$refs4.popularCountries,
        resetButton = _this$refs4.resetButton,
        search = _this$refs4.search;
      var labelResultsCount = this.dataset.labelResultsCount;
      var searchValue = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.normalizeString)(search.value);
      var countVisibleCountries = 0;
      resetButton.toggleAttribute('hidden', !searchValue);
      if (popularCountries) {
        popularCountries.toggleAttribute('hidden', Boolean(searchValue));
      }
      var wrapper = this.querySelector('.country-selector-form__wrapper');
      if (wrapper) {
        wrapper.classList.toggle('is-searching', !!searchValue);
      }
      var _iterator3 = _createForOfIteratorHelper(countryListItems),
        _step3;
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          var countryEl = _step3.value;
          if (searchValue === '') {
            countryEl.removeAttribute('hidden');
            var countrySpan = countryEl.querySelector('.country');
            if (countrySpan) {
            ...
            var matches = _assertClassBrand(_LocalizationFormComponent_brand, this, _findMatches).call(this, searchValue, countryEl);
            ...
            if (matches.label || matches.alias || matches.iso || matches.currency) {
              countryEl.removeAttribute('hidden');
              var _countrySpan = countryEl.querySelector('.country');
              if (_countrySpan) {
                _countrySpan.innerHTML = _assertClassBrand(_LocalizationFormComponent_brand, this, _highlightMatches).call(this, _countrySpan.textContent, searchValue);
              }
              countVisibleCountries++;
            } else {
      ...
      if (liveRegion && labelResultsCount) {
        liveRegion.innerText = labelResultsCount.replace('[count]', "".concat(countVisibleCountries));
      }
     ...
     * @param {Event} event - The event object.
     */
    function resetCountriesFilter(event) {
 ...
 */
function _findMatches(searchValue, countryEl) {
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {
  ...
  var matchTypes = {};
  var _countryEl$dataset = countryEl.dataset,
    aliases = _countryEl$dataset.aliases,
    iso = _countryEl$dataset.value;
  if (options.matchLabel) {
    var _countryEl$querySelec, _countryEl$querySelec2;
    var countryName = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.normalizeString)((_countryEl$querySelec = (_countryEl$querySelec2 = countryEl.querySelector('.country')) === null || _countryEl$querySelec2 === void 0 ? void 0 : _countryEl$querySelec2.textContent) !== null && _countryEl$querySelec !== void 0 ? _countryEl$querySelec : '');
    if (!countryName) return matchTypes;
    matchTypes.label = options.labelMatchStart ? countryName.startsWith(searchValue) : countryName.includes(searchValue);
  }
  if (options.matchCurrency) {
    var _countryEl$querySelec3, _countryEl$querySelec4;
    var currency = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.normalizeString)((_countryEl$querySelec3 = (_countryEl$querySelec4 = countryEl.querySelector('.localization-form__currency')) === null || _countryEl$querySelec4 === void 0 ? void 0 : _countryEl$querySelec4.textContent) !== null && _countryEl$querySelec3 !== void 0 ? _countryEl$querySelec3 : '');
    matchTypes.currency = currency.includes(searchValue);
  }
  if (options.matchIso) {
    matchTypes.iso = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.normalizeString)(iso !== null && iso !== void 0 ? iso : '') == searchValue;
  }
  if (options.matchAlias) {
    var countryAliases = aliases === null || aliases === void 0 ? void 0 : aliases.split(',').map(function (alias) {
      return (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.normalizeString)(alias);
    });
    if (!countryAliases) return matchTypes;
    matchTypes.alias = countryAliases.length > 0 && countryAliases.find(function (alias) {
      return options.aliasExactMatch ? alias === searchValue : alias.startsWith(searchValue);
    }) !== undefined;
  }
  return matchTypes;
}
 ...
 */
function _highlightMatches(text, searchValue) {
  if (!text || !searchValue) return text !== null && text !== void 0 ? text : '';
  var normalizedText = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.normalizeString)(text);
  var normalizedSearch = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.normalizeString)(searchValue);
  var startIndex = normalizedText.indexOf(normalizedSearch);
  if (startIndex === -1) return text;
  var endIndex = startIndex + normalizedSearch.length;
  var before = text.slice(0, startIndex);
  var match = text.slice(startIndex, endIndex);
  var after = text.slice(endIndex);
  var result = '';
  if (before) {
    result += "<mark>".concat(before, "</mark>");
  }
  result += match;
  if (after) {
    result += "<mark>".concat(after, "</mark>");
  }
  return result;
}
function _changeCountryFocus(direction) {
  var _itemToFocus, _itemToFocus2;
  var countryListItems = this.refs.countryListItems;
  var focusableItems = countryListItems.filter(function (item) {
    return !item.hasAttribute('hidden');
  });
  var focusedItemIndex = focusableItems.findIndex(function (item) {
    return item === document.activeElement;
  ...
  (_itemToFocus = itemToFocus) === null || _itemToFocus === void 0 || _itemToFocus.setAttribute('aria-selected', 'true');
  (_itemToFocus2 = itemToFocus) === null || _itemToFocus2 === void 0 || _itemToFocus2.focus();
}
var _handleClickOutside = /*#__PURE__*/new WeakMap();
var _DropdownLocalizationComponent_brand = /*#__PURE__*/new WeakSet();
var _handleKeyUp = /*#__PURE__*/new WeakMap();
var DropdownLocalizationComponent = /*#__PURE__*/function (_Component2) {
  function DropdownLocalizationComponent() {
    var _this2;
    _classCallCheck(this, DropdownLocalizationComponent);
    for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
      args[_key2] = arguments[_key2];
    }
    _this2 = _callSuper(this, DropdownLocalizationComponent, [].concat(args));
    /**
     * Updates the width of the panel.
     */
    _classPrivateMethodInitSpec(_this2, _DropdownLocalizationComponent_brand);
    /**
     * Hides the panel.
     */
    _defineProperty(_this2, "hidePanel", function () {
      var _this2$refs$button, _this2$refs$localizat;
      if (_this2.isHidden) return;
      _this2.removeEventListener('keyup', _classPrivateFieldGet(_handleKeyUp, _this2));
      document.removeEventListener('click', _classPrivateFieldGet(_handleClickOutside, _this2));
      (_this2$refs$button = _this2.refs.button) === null || _this2$refs$button === void 0 || _this2$refs$button.setAttribute('aria-expanded', 'false');
      _this2.refs.panel.setAttribute('hidden', '');
      (_this2$refs$localizat = _this2.refs.localizationForm) === null || _this2$refs$localizat === void 0 || _this2$refs$localizat.resetForm();
    });
    /**
     ...
     */
    _classPrivateFieldInitSpec(_this2, _handleClickOutside, function (event) {
      if ((0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.isClickedOutside)(event, _this2)) {
        _this2.hidePanel();
      }
    });
    /**
     ...
     * @param {KeyboardEvent} event - The event object.
     */
    _classPrivateFieldInitSpec(_this2, _handleKeyUp, function (event) {
      var _this2$refs$button2;
      switch (event.key) {
        case 'Escape':
          _this2.hidePanel();
          event.stopPropagation();
          (_this2$refs$button2 = _this2.refs.button) === null || _this2$refs$button2 === void 0 || _this2$refs$button2.focus();
          break;
      }
    });
    return _this2;
  }
  _inherits(DropdownLocalizationComponent, _Component2);
  return _createClass(DropdownLocalizationComponent, [{
    key: "isHidden",
    get: function get() {
    ...
    value: function showPanel() {
      ...
      document.addEventListener('click', _classPrivateFieldGet(_handleClickOutside, this));
      this.refs.panel.removeAttribute('hidden');
      this.refs.button.setAttribute('aria-expanded', 'true');
      (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.onAnimationEnd)(this.refs.panel, function () {
        var _this3$refs$localizat;
        _assertClassBrand(_DropdownLocalizationComponent_brand, _this3, _updateWidth).call(_this3);
        (_this3$refs$localizat = _this3.refs.localizationForm) === null || _this3$refs$localizat === void 0 || _this3$refs$localizat.focusSearchInput();
      });
    }
  }]);
}(_theme_component__WEBPACK_IMPORTED_MODULE_0__.Component);
...
function _updateWidth() {
  this.style.setProperty('--width', "".concat(this.refs.localizationForm.offsetWidth, "px"));
}
var _onCountryListScroll2 = /*#__PURE__*/new WeakMap();
var DrawerLocalizationComponent = /*#__PURE__*/function (_Component3) {
  function DrawerLocalizationComponent() {
    var _this4;
    _classCallCheck(this, DrawerLocalizationComponent);
    for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
      args[_key3] = arguments[_key3];
    }
    _this4 = _callSuper(this, DrawerLocalizationComponent, [].concat(args));
    /**
     * Handles the scroll event on the country list.
     *
     * @param {Event} event - The scroll event object.
     */
    _classPrivateFieldInitSpec(_this4, _onCountryListScroll2, function (event) {
      var countryFilter = _this4.querySelector('.country-filter');
      var countryList = event.target instanceof HTMLElement ? event.target : null;
      if (countryFilter && countryList) {
        var shouldShowBorder = countryList.scrollTop > 0;
        countryFilter.classList.toggle('is-scrolled', shouldShowBorder);
  ...
  _inherits(DrawerLocalizationComponent, _Component3);
  return _createClass(DrawerLocalizationComponent, [{
    key: "toggle",
    value:
    /**
     * Toggles the dialog.
    ...
    function toggle(event) {
      ...
      var localizationForm = this.refs.localizationForm;
      if (!localizationForm || !(target instanceof HTMLDetailsElement)) return;
      var countryList = localizationForm.querySelector('.country-selector-form__wrapper');
      if (target.open) {
        if (countryList) countryList.addEventListener('scroll', _classPrivateFieldGet(_onCountryListScroll2, this));
        (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.onAnimationEnd)(target, localizationForm.focusSearchInput);
      } else {
        countryList === null || countryList === void 0 || countryList.removeEventListener('scroll', _classPrivateFieldGet(_onCountryListScroll2, this));
