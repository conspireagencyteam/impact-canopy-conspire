...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DialogCloseEvent: () => (/* binding */ DialogCloseEvent),
/* harmony export */   DialogComponent: () => (/* binding */ DialogComponent),
/* harmony export */   DialogOpenEvent: () => (/* binding */ DialogOpenEvent)
/* harmony export */ });
...
var _DialogComponent_brand = /*#__PURE__*/new WeakSet();
var DialogComponent = /*#__PURE__*/function (_Component) {
  function DialogComponent() {
    ...
    _this = _callSuper(this, DialogComponent, [].concat(args));
    /**
     * Closes the dialog when the user clicks outside of it.
     *
     * @param {MouseEvent} event - The mouse event.
     */
    _classPrivateMethodInitSpec(_this, _DialogComponent_brand);
    _defineProperty(_this, "requiredRefs", ['dialog']);
    _classPrivateFieldInitSpec(_this, _handleResize, (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.debounce)(function () {
      var _this2 = _this,
        minWidth = _this2.minWidth,
    ...
    _classPrivateFieldInitSpec(_this, _previousScrollY, 0);
    /**
     * Closes the dialog.
     */
    _defineProperty(_this, "closeDialog", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      var dialog;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            dialog = _this.refs.dialog;
            if (dialog.open) {
              _context.n = 1;
              break;
            }
            return _context.a(2);
          case 1:
            _this.removeEventListener('click', _assertClassBrand(_DialogComponent_brand, _this, _handleClick));
            _this.removeEventListener('keydown', _assertClassBrand(_DialogComponent_brand, _this, _handleKeyDown));
            ...
            _context.n = 2;
            return (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.onAnimationEnd)(dialog, undefined, {
              subtree: false
            });
          case 2:
            ...
            window.scrollTo({
              top: _classPrivateFieldGet(_previousScrollY, _this),
              behavior: 'instant'
            });
            dialog.close();
            dialog.classList.remove('dialog-closing');
            _this.dispatchEvent(new DialogCloseEvent());
          case 3:
            return _context.a(2);
        }
      }, _callee);
     ...
     * Toggles the dialog.
     */
    _defineProperty(_this, "toggleDialog", function () {
      if (_this.refs.dialog.open) {
        _this.closeDialog();
      } else {
        _this.showDialog();
      }
  ...
  return _createClass(DialogComponent, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(DialogComponent, "connectedCallback", this, 3)([]);
      if (this.minWidth || this.maxWidth) {
        window.addEventListener('resize', _classPrivateFieldGet(_handleResize, this));
      }
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(DialogComponent, "disconnectedCallback", this, 3)([]);
      if (this.minWidth || this.maxWidth) {
        window.removeEventListener('resize', _classPrivateFieldGet(_handleResize, this));
      }
    }
  }, {
    key: "showDialog",
    ...
    function showDialog() {
      ...
      _classPrivateFieldSet(_previousScrollY, this, scrollY);
      ...
      requestAnimationFrame(function () {
        ...
        dialog.showModal();
        _this3.dispatchEvent(new DialogOpenEvent());
        _this3.addEventListener('click', _assertClassBrand(_DialogComponent_brand, _this3, _handleClick));
        _this3.addEventListener('keydown', _assertClassBrand(_DialogComponent_brand, _this3, _handleKeyDown));
      });
    }
  }, {
    key: "minWidth",
...
function _handleClick(event) {
  var dialog = this.refs.dialog;
  if ((0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.isClickedOutside)(event, dialog)) {
    this.closeDialog();
  }
}
/**
...
var DialogOpenEvent = /*#__PURE__*/function (_CustomEvent) {
  function DialogOpenEvent() {
    _classCallCheck(this, DialogOpenEvent);
    return _callSuper(this, DialogOpenEvent, [DialogOpenEvent.eventName]);
  }
  _inherits(DialogOpenEvent, _CustomEvent);
  return _createClass(DialogOpenEvent);
}(/*#__PURE__*/_wrapNativeSuper(CustomEvent));
_defineProperty(DialogOpenEvent, "eventName", 'dialog:open');
var DialogCloseEvent = /*#__PURE__*/function (_CustomEvent2) {
  function DialogCloseEvent() {
    _classCallCheck(this, DialogCloseEvent);
    return _callSuper(this, DialogCloseEvent, [DialogCloseEvent.eventName]);
  }
  _inherits(DialogCloseEvent, _CustomEvent2);
  return _createClass(DialogCloseEvent);
}(/*#__PURE__*/_wrapNativeSuper(CustomEvent));
_defineProperty(DialogCloseEvent, "eventName", 'dialog:close');
document.addEventListener('toggle', function (event) {
  if (event.target instanceof HTMLDetailsElement) {
    if (event.target.hasAttribute('scroll-lock')) {
      var open = event.target.open;
      if (open) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ZoomDialog: () => (/* binding */ ZoomDialog)
/* harmony export */ });
/* harmony import */ var _theme_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @theme/component */ "./src/scripts/component.js");
/* harmony import */ var _theme_utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @theme/utilities */ "./src/scripts/utilities.js");
...
/* harmony import */ var _theme_dialog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @theme/dialog */ "./src/scripts/dialog.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t.return || t.return(); } finally { if (u) throw o; } } }; }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
 ...
 * @extends Component<Refs>
 */
var _highResImagesLoaded = /*#__PURE__*/new WeakMap();
var _ZoomDialog_brand = /*#__PURE__*/new WeakSet();
var ZoomDialog = /*#__PURE__*/function (_Component) {
  function ZoomDialog() {
    var _this;
    _classCallCheck(this, ZoomDialog);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, ZoomDialog, [].concat(args));
    /**
     * Loads a high-resolution image for a specific media container
     * @param {HTMLElement} mediaContainer - The media container element
     */
    _classPrivateMethodInitSpec(_this, _ZoomDialog_brand);
    _defineProperty(_this, "requiredRefs", ['dialog', 'media', 'thumbnails']);
    _classPrivateFieldInitSpec(_this, _highResImagesLoaded, /** @type {Set<string>} */new Set());
    /**
     ...
     */
    _defineProperty(_this, "handleScroll", (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.debounce)(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      var _this$refs, media, thumbnails, mostVisibleElement, activeIndex, targetThumbnail;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            _this$refs = _this.refs, media = _this$refs.media, thumbnails = _this$refs.thumbnails;
            _context.n = 1;
            return getMostVisibleElement(media);
          case 1:
            mostVisibleElement = _context.v;
            activeIndex = media.indexOf(mostVisibleElement);
            targetThumbnail = thumbnails.children[activeIndex];
            if (!(!targetThumbnail || !(targetThumbnail instanceof HTMLElement))) {
              _context.n = 2;
              break;
            }
            return _context.a(2);
          case 2:
            Array.from(thumbnails.querySelectorAll('button')).forEach(function (button, i) {
              button.setAttribute('aria-selected', "".concat(i === activeIndex));
            });
            _assertClassBrand(_ZoomDialog_brand, _this, _loadHighResolutionImage).call(_this, mostVisibleElement);
            _this.dispatchEvent(new _theme_events__WEBPACK_IMPORTED_MODULE_3__.ZoomMediaSelectedEvent(activeIndex));
          case 3:
            return _context.a(2);
        }
      }, _callee);
  ...
  _inherits(ZoomDialog, _Component);
  return _createClass(ZoomDialog, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(ZoomDialog, "connectedCallback", this, 3)([]);
      this.refs.dialog.addEventListener('scroll', this.handleScroll);
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(ZoomDialog, "disconnectedCallback", this, 3)([]);
    ...
    key: "open",
    value: (function () {
      var _open = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(index, event) {
        var _this$refs2, dialog, media, thumbnails, targetImage, targetThumbnail, open, sourceImage, transitionName;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              event.preventDefault();
              _this$refs2 = this.refs, dialog = _this$refs2.dialog, media = _this$refs2.media, thumbnails = _this$refs2.thumbnails;
              targetImage = media[index];
              targetThumbnail = thumbnails.children[index];
              open = function open() {
                dialog.showModal();
                for (var _i = 0, _arr = [targetThumbnail, targetImage]; _i < _arr.length; _i++) {
                  var target = _arr[_i];
              ...
              sourceImage = event.target instanceof Element ? event.target.closest('li,slideshow-slide') : null;
              if (!(!(0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.supportsViewTransitions)() || (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.isLowPowerDevice)() || !sourceImage || !targetImage)) {
                _context2.n = 1;
                break;
              }
              return _context2.a(2, open());
            case 1:
              transitionName = "gallery-item";
              sourceImage.style.setProperty('view-transition-name', transitionName);
              _context2.n = 2;
              return (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.startViewTransition)(function () {
                open();
     ...
     */
    function () {
      var _close = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var _mediaGallery$slidesh,
          _mediaGallery$media,
          _this2 = this;
        var _this$refs3, dialog, media, mostVisibleElement, activeIndex, transitionName, mediaGallery, slideshowActive, slide;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              _this$refs3 = this.refs, dialog = _this$refs3.dialog, media = _this$refs3.media;
              if (!(!(0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.supportsViewTransitions)() || (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.isLowPowerDevice)())) {
                _context3.n = 1;
                break;
              }
              return _context3.a(2, this.closeDialog());
            case 1:
              _context3.n = 2;
              return getMostVisibleElement(media);
            case 2:
              mostVisibleElement = _context3.v;
              // Get the index and set up transition
              activeIndex = media.indexOf(mostVisibleElement);
              transitionName = "gallery-item";
              mediaGallery = /** @type {import('./media-gallery').MediaGallery | undefined} */
              this.closest('media-gallery');
              slideshowActive = (mediaGallery === null || mediaGallery === void 0 ? void 0 : mediaGallery.presentation) === 'carousel';
              slide = slideshowActive ? (_mediaGallery$slidesh = mediaGallery.slideshow) === null || _mediaGallery$slidesh === void 0 || (_mediaGallery$slidesh = _mediaGallery$slidesh.slides) === null || _mediaGallery$slidesh === void 0 ? void 0 : _mediaGallery$slidesh[activeIndex] : mediaGallery === null || mediaGallery === void 0 || (_mediaGallery$media = mediaGallery.media) === null || _mediaGallery$media === void 0 ? void 0 : _mediaGallery$media[activeIndex];
              if (slide) {
                _context3.n = 3;
                break;
              }
            ...
            case 3:
              ...
              _context3.n = 4;
              return (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.onAnimationEnd)(this.refs.thumbnails);
            case 4:
    ...
    value: function closeDialog() {
      var dialog = this.refs.dialog;
      dialog.close();
      window.dispatchEvent(new _theme_dialog__WEBPACK_IMPORTED_MODULE_4__.DialogCloseEvent());
    }
    ...
    value: (function () {
      var _handleThumbnailClick = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(index) {
        var behavior;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            case 0:
              behavior = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.prefersReducedMotion)() ? 'instant' : 'smooth';
              this.selectThumbnail(index, {
                behavior: behavior
              });
            case 1:
      ...
      function handleThumbnailClick(_x3) {
        return _handleThumbnailClick.apply(this, arguments);
      }
    ...
    key: "handleThumbnailPointerEnter",
    value: (function () {
      var _handleThumbnailPointerEnter = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(index) {
        var media;
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            case 0:
              media = this.refs.media;
              if (media[index]) {
                _context5.n = 1;
                break;
              }
            ...
            case 1:
              _assertClassBrand(_ZoomDialog_brand, this, _loadHighResolutionImage).call(this, media[index]);
            case 2:
              return _context5.a(2);
          }
        }, _callee5, this);
      }));
      function handleThumbnailPointerEnter(_x4) {
        return _handleThumbnailPointerEnter.apply(this, arguments);
      }
      return handleThumbnailPointerEnter;
    }()
    /**
    ...
    key: "selectThumbnail",
    value: (function () {
      var _selectThumbnail = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(index) {
        var options,
          _this$refs4,
          media,
          thumbnails,
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            case 0:
              ...
              if (!(!this.refs.thumbnails || !this.refs.thumbnails.children.length)) {
                _context6.n = 1;
                break;
              }
              return _context6.a(2);
            case 1:
              if (!(isNaN(index) || index < 0 || index >= this.refs.thumbnails.children.length)) {
                _context6.n = 2;
                break;
              }
              return _context6.a(2);
            case 2:
              _this$refs4 = this.refs, media = _this$refs4.media, thumbnails = _this$refs4.thumbnails;
              targetThumbnail = thumbnails.children[index];
              if (!(!targetThumbnail || !(targetThumbnail instanceof HTMLElement))) {
                _context6.n = 3;
                break;
            ...
            case 3:
              Array.from(thumbnails.querySelectorAll('button')).forEach(function (button, i) {
                button.setAttribute('aria-selected', "".concat(i === index));
              });
              (0,_theme_scrolling__WEBPACK_IMPORTED_MODULE_2__.scrollIntoView)(targetThumbnail, {
                ancestor: thumbnails,
              ...
              if (targetImage) {
                ...
                _assertClassBrand(_ZoomDialog_brand, this, _loadHighResolutionImage).call(this, targetImage);
              }
              this.dispatchEvent(new _theme_events__WEBPACK_IMPORTED_MODULE_3__.ZoomMediaSelectedEvent(index));
            case 4:
              return _context6.a(2);
          }
        }, _callee6, this);
      }));
      function selectThumbnail(_x5) {
        return _selectThumbnail.apply(this, arguments);
      }
      return selectThumbnail;
    }())
  }]);
}(_theme_component__WEBPACK_IMPORTED_MODULE_0__.Component);
function _loadHighResolutionImage(mediaContainer) {
  var _this3 = this;
  if (!mediaContainer.classList.contains('product-media-container--image')) return false;
  var image = mediaContainer.querySelector('img.product-media__image');
  if (!image || !(image instanceof HTMLImageElement)) return false;
  var highResolutionUrl = image.getAttribute('data_max_resolution');
  if (!highResolutionUrl || _classPrivateFieldGet(_highResImagesLoaded, this).has(highResolutionUrl)) return false;
  (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.preloadImage)(highResolutionUrl);
  ...
  newImage.onload = function () {
    ...
    _classPrivateFieldGet(_highResImagesLoaded, _this3).add(highResolutionUrl);
  };
...
function getMostVisibleElement(elements) {
  return new Promise(function (resolve) {
    var observer = new IntersectionObserver(function (entries) {
      var mostVisible = entries.reduce(function (prev, current) {
...
(() => {
/*!******************************************!*\
  !*** ./src/scripts/drag-zoom-wrapper.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DragZoomWrapper: () => (/* binding */ DragZoomWrapper)
/* harmony export */ });
/* harmony import */ var _utilities_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utilities.js */ "./src/scripts/utilities.js");
/* harmony import */ var _zoom_dialog_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./zoom-dialog.js */ "./src/scripts/zoom-dialog.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i.return) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } r ? i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n : (o("next", 0), o("throw", 1), o("return", 2)); }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
...
var DOUBLE_TAP_DISTANCE = 50;
var DRAG_THRESHOLD = 10;
var _controller = /*#__PURE__*/new WeakMap();
var _scale = /*#__PURE__*/new WeakMap();
var _initialDistance = /*#__PURE__*/new WeakMap();
var _startScale = /*#__PURE__*/new WeakMap();
var _translate = /*#__PURE__*/new WeakMap();
var _startPosition = /*#__PURE__*/new WeakMap();
var _startTranslate = /*#__PURE__*/new WeakMap();
var _isDragging = /*#__PURE__*/new WeakMap();
var _initialized = /*#__PURE__*/new WeakMap();
var _animationFrame = /*#__PURE__*/new WeakMap();
var _lastTapTime = /*#__PURE__*/new WeakMap();
var _lastTapPosition = /*#__PURE__*/new WeakMap();
var _hasDraggedBeyondThreshold = /*#__PURE__*/new WeakMap();
var _hasManualZoom = /*#__PURE__*/new WeakMap();
var _DragZoomWrapper_brand = /*#__PURE__*/new WeakSet();
var _handleResize = /*#__PURE__*/new WeakMap();
var _resizeObserver = /*#__PURE__*/new WeakMap();
...
var _requestUpdateTransform = /*#__PURE__*/new WeakMap();
var _updateTransform = /*#__PURE__*/new WeakMap();
var DragZoomWrapper = /*#__PURE__*/function (_HTMLElement) {
  function DragZoomWrapper() {
    var _this2;
    _classCallCheck(this, DragZoomWrapper);
    for (var _len = arguments.length, _args = new Array(_len), _key = 0; _key < _len; _key++) {
      _args[_key] = arguments[_key];
    }
    _this2 = _callSuper(this, DragZoomWrapper, [].concat(_args));
    _classPrivateMethodInitSpec(_this2, _DragZoomWrapper_brand);
    _classPrivateFieldInitSpec(_this2, _controller, new AbortController());
    /** @type {number} */
    _classPrivateFieldInitSpec(_this2, _scale, DEFAULT_ZOOM);
    /** @type {number} */
    _classPrivateFieldInitSpec(_this2, _initialDistance, 0);
    /** @type {number} */
    _classPrivateFieldInitSpec(_this2, _startScale, DEFAULT_ZOOM);
    /** @type {Point} */
    _classPrivateFieldInitSpec(_this2, _translate, {
      x: 0,
      y: 0
    });
    /** @type {Point} */
    _classPrivateFieldInitSpec(_this2, _startPosition, {
      x: 0,
      y: 0
    });
    /** @type {Point} */
    _classPrivateFieldInitSpec(_this2, _startTranslate, {
      x: 0,
      y: 0
    });
    /** @type {boolean} */
    _classPrivateFieldInitSpec(_this2, _isDragging, false);
    /** @type {boolean} */
    _classPrivateFieldInitSpec(_this2, _initialized, false);
    /** @type {number | null} */
    _classPrivateFieldInitSpec(_this2, _animationFrame, null);
    /** @type {number} */
    _classPrivateFieldInitSpec(_this2, _lastTapTime, 0);
    /** @type {Point | null} */
    _classPrivateFieldInitSpec(_this2, _lastTapPosition, null);
    /** @type {boolean} */
    _classPrivateFieldInitSpec(_this2, _hasDraggedBeyondThreshold, false);
    /** @type {boolean} */
    _classPrivateFieldInitSpec(_this2, _hasManualZoom, false);
    _classPrivateFieldInitSpec(_this2, _handleResize, function () {
      if (!_classPrivateFieldGet(_initialized, _this2) && (0,_utilities_js__WEBPACK_IMPORTED_MODULE_0__.isMobileBreakpoint)()) {
        _assertClassBrand(_DragZoomWrapper_brand, _this2, _initEventListeners).call(_this2);
      }
      if (_classPrivateFieldGet(_initialized, _this2)) {
        _classPrivateFieldGet(_requestUpdateTransform, _this2).call(_this2);
      }
    });
    _classPrivateFieldInitSpec(_this2, _resizeObserver, new ResizeObserver(_classPrivateFieldGet(_handleResize, _this2)));
    /**
     * @param {TouchEvent} event
     */
    _classPrivateFieldInitSpec(_this2, _handleTouchStart, function (event) {
      (0,_utilities_js__WEBPACK_IMPORTED_MODULE_0__.preventDefault)(event);
      ...
      if (touchCount === 2) {
        ...
        _assertClassBrand(_DragZoomWrapper_brand, _this2, _startZoomGestureFromTouches).call(_this2, touch1, touch2);
        ...
        var timeSinceLastTap = currentTime - _classPrivateFieldGet(_lastTapTime, _this2);

        // Early exit if too much time has passed
        if (timeSinceLastTap >= DOUBLE_TAP_DELAY) {
          _assertClassBrand(_DragZoomWrapper_brand, _this2, _storeTapInfo).call(_this2, currentTime, touch);
          _assertClassBrand(_DragZoomWrapper_brand, _this2, _startDragGestureFromTouch).call(_this2, touch);
          return;
        }

        // Only check distance if we have a previous tap within time window
        if (_classPrivateFieldGet(_lastTapPosition, _this2)) {
          // Distance calculation with early exit
          var distance = getDistance(touch, _classPrivateFieldGet(_lastTapPosition, _this2));
          if (distance < DOUBLE_TAP_DISTANCE) {
            // This is a double-tap, handle zoom toggle
            _assertClassBrand(_DragZoomWrapper_brand, _this2, _handleDoubleTapFromTouch).call(_this2, touch);
            _classPrivateFieldSet(_lastTapTime, _this2, 0); // Reset to prevent triple-tap
            _classPrivateFieldSet(_lastTapPosition, _this2, null);
            return;
          }
        }
     ...
     * @param {TouchEvent} event
     */
    _classPrivateFieldInitSpec(_this2, _handleTouchMove, function (event) {
      (0,_utilities_js__WEBPACK_IMPORTED_MODULE_0__.preventDefault)(event);
      var touchCount = event.touches.length;
      if (touchCount === 2) {
        var touch1 = event.touches[0];
        var touch2 = event.touches[1];
        if (touch1 && touch2) {
          _assertClassBrand(_DragZoomWrapper_brand, _this2, _processZoomGesture).call(_this2, touch1, touch2);
        }
      } else if (touchCount === 1 && _classPrivateFieldGet(_isDragging, _this2)) {
        var touch = event.touches[0];
        if (touch) {
          _assertClassBrand(_DragZoomWrapper_brand, _this2, _processDragGesture).call(_this2, touch);
        }
      }
    });
    /**
     * @param {TouchEvent} event
     */
    _classPrivateFieldInitSpec(_this2, _handleTouchEnd, function (event) {
      if (event.touches.length === 0) {
        _classPrivateFieldSet(_isDragging, _this2, false);
        _classPrivateFieldGet(_requestUpdateTransform, _this2).call(_this2);
        _classPrivateFieldSet(_hasDraggedBeyondThreshold, _this2, false);
      }
    });
    /**
     * Request an animation frame to update the transform
     */
    _classPrivateFieldInitSpec(_this2, _requestUpdateTransform, function () {
      if (!_classPrivateFieldGet(_animationFrame, _this2)) {
        _classPrivateFieldSet(_animationFrame, _this2, requestAnimationFrame(_classPrivateFieldGet(_updateTransform, _this2)));
      }
    });
    _classPrivateFieldInitSpec(_this2, _updateTransform, function () {
      _classPrivateFieldSet(_animationFrame, _this2, null);
      _assertClassBrand(_DragZoomWrapper_brand, _this2, _constrainTranslation).call(_this2);
      _this2.style.setProperty('--drag-zoom-scale', _classPrivateFieldGet(_scale, _this2).toString());
      _this2.style.setProperty('--drag-zoom-translate-x', "".concat(_classPrivateFieldGet(_translate, _this2).x, "px"));
      _this2.style.setProperty('--drag-zoom-translate-y', "".concat(_classPrivateFieldGet(_translate, _this2).y, "px"));
    });
    return _this2;
  }
  _inherits(DragZoomWrapper, _HTMLElement);
  return _createClass(DragZoomWrapper, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      if (!_classPrivateGetter(_DragZoomWrapper_brand, this, _get_image)) return;
      _assertClassBrand(_DragZoomWrapper_brand, this, _initResizeListener).call(this);
      _assertClassBrand(_DragZoomWrapper_brand, this, _setupDialogCloseListener).call(this);
      if (!(0,_utilities_js__WEBPACK_IMPORTED_MODULE_0__.isMobileBreakpoint)()) return;
      _assertClassBrand(_DragZoomWrapper_brand, this, _initEventListeners).call(this);
      _classPrivateFieldGet(_updateTransform, this).call(this);
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      ...
      _classPrivateFieldGet(_resizeObserver, this).disconnect();
      _assertClassBrand(_DragZoomWrapper_brand, this, _cancelAnimationFrame).call(this);
    }
  }, {
    key: "destroy",
    value: function destroy() {
 ...
 */
function _get_image(_this) {
  return _this.querySelector('img');
}
 ...
 */
function _setupDialogCloseListener() {
  var _this3 = this;
  // Find the parent zoom dialog component
  var zoomDialog = /** @type {ZoomDialog} */this.closest('zoom-dialog');
  if (!zoomDialog || typeof zoomDialog.close !== 'function') return;

  // Store reference to original close method
  var originalClose = zoomDialog.close.bind(zoomDialog);

  // Override the close method to include zoom reset
  zoomDialog.close = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var _args2 = arguments;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          // Reset zoom state before closing
          _assertClassBrand(_DragZoomWrapper_brand, _this3, _resetZoom).call(_this3);

          // Call original close method
          _context.n = 1;
          return originalClose.apply(void 0, _args2);
        case 1:
...
function _initEventListeners() {
  if (_classPrivateFieldGet(_initialized, this)) return;
  _classPrivateFieldSet(_initialized, this, true);
  var _classPrivateFieldGet2 = _classPrivateFieldGet(_controller, this),
    signal = _classPrivateFieldGet2.signal;
  var options = {
    passive: false,
    signal: signal
  };
  this.addEventListener('touchstart', _classPrivateFieldGet(_handleTouchStart, this), options);
  this.addEventListener('touchmove', _classPrivateFieldGet(_handleTouchMove, this), options);
  this.addEventListener('touchend', _classPrivateFieldGet(_handleTouchEnd, this), options);
 ...
 * @param {Touch} touch2
 */
function _startZoomGestureFromTouches(touch1, touch2) {
  // Calculate initial distance between touches
  _classPrivateFieldSet(_initialDistance, this, getDistance(touch1, touch2));
  _classPrivateFieldSet(_startScale, this, _classPrivateFieldGet(_scale, this));
 ...
 * @param {Touch} touch
 */
function _startDragGestureFromTouch(touch) {
  _classPrivateFieldSet(_startPosition, this, {
    x: touch.clientX,
    y: touch.clientY
  });
  _classPrivateFieldSet(_startTranslate, this, {
    x: _classPrivateFieldGet(_translate, this).x,
    y: _classPrivateFieldGet(_translate, this).y
  });
  _classPrivateFieldSet(_isDragging, this, true);
  _classPrivateFieldSet(_hasDraggedBeyondThreshold, this, false);
}
/**
 ...
 * @param {Touch} touch
 */
function _storeTapInfo(currentTime, touch) {
  _classPrivateFieldSet(_lastTapTime, this, currentTime);
  _classPrivateFieldSet(_lastTapPosition, this, {
    x: touch.clientX,
    y: touch.clientY
  });
}
 ...
 */
function _handleDoubleTapFromTouch(touch) {
  var containerCenter = {
  ...
  if (_classPrivateFieldGet(_hasManualZoom, this)) {
    targetZoom = MIN_ZOOM; // 1x
    _classPrivateFieldSet(_hasManualZoom, this, false); // Reset the flag
    _classPrivateFieldSet(_translate, this, {
      x: 0,
      y: 0
    }); // Center the image
  } else {
    // Toggle between zoom levels: 1x ↔ 1.5x
    var tolerance = 0.05; // Small tolerance for floating point comparison

    if (Math.abs(_classPrivateFieldGet(_scale, this) - MIN_ZOOM) < tolerance) {
  ...
  if (targetZoom !== MIN_ZOOM) {
    var oldScale = _classPrivateFieldGet(_scale, this);
    _classPrivateFieldSet(_scale, this, Math.min(MAX_ZOOM, targetZoom));
    ...
    var scaleDelta = _classPrivateFieldGet(_scale, this) / oldScale - 1.0;
    _classPrivateFieldGet(_translate, this).x -= distanceFromCenter.x * scaleDelta / _classPrivateFieldGet(_scale, this);
    _classPrivateFieldGet(_translate, this).y -= distanceFromCenter.y * scaleDelta / _classPrivateFieldGet(_scale, this);
  } else {
    // Going to 1x, set the scale and center the image
    _classPrivateFieldSet(_scale, this, targetZoom);
    _classPrivateFieldSet(_translate, this, {
      x: 0,
      y: 0
    }); // Center the image when going to 1x
  }
  _classPrivateFieldGet(_requestUpdateTransform, this).call(this);
}
/**
 ...
 * @param {Touch} touch2
 */
function _processZoomGesture(touch1, touch2) {
  // Calculate midpoint directly without object allocation
  var midX = (touch1.clientX + touch2.clientX) / 2;
  var midY = (touch1.clientY + touch2.clientY) / 2;
  ...
  var newScale = currentDistance / _classPrivateFieldGet(_initialDistance, this) * _classPrivateFieldGet(_startScale, this);
  _classPrivateFieldSet(_scale, this, (0,_utilities_js__WEBPACK_IMPORTED_MODULE_0__.clamp)(newScale, MIN_ZOOM, MAX_ZOOM));

  // Mark that manual zoom has been used
  _classPrivateFieldSet(_hasManualZoom, this, true);

  // Adjust translation to keep the pinch midpoint stationary
  var containerCenterX = this.clientWidth / 2;
  var containerCenterY = this.clientHeight / 2;
  var distanceFromCenterX = midX - containerCenterX;
  var distanceFromCenterY = midY - containerCenterY;
  ...
  _classPrivateFieldGet(_translate, this).x -= distanceFromCenterX * scaleDelta / _classPrivateFieldGet(_scale, this);
  _classPrivateFieldGet(_translate, this).y -= distanceFromCenterY * scaleDelta / _classPrivateFieldGet(_scale, this);
  _classPrivateFieldGet(_requestUpdateTransform, this).call(this);
  _classPrivateFieldSet(_isDragging, this, false);
}
/**
 ...
 * @param {Touch} touch
 */
function _processDragGesture(touch) {
  // Check if we've moved beyond the drag threshold
  var distance = getDistance(touch, _classPrivateFieldGet(_startPosition, this));
  if (!_classPrivateFieldGet(_hasDraggedBeyondThreshold, this) && distance < DRAG_THRESHOLD) {
    // Movement is too small, don't process as drag yet
    return;
  }
  _classPrivateFieldSet(_hasDraggedBeyondThreshold, this, true);

  // Calculate movement deltas for translation
  var dx = touch.clientX - _classPrivateFieldGet(_startPosition, this).x;
  var dy = touch.clientY - _classPrivateFieldGet(_startPosition, this).y;

  // Calculate new translation directly
  _classPrivateFieldGet(_translate, this).x = _classPrivateFieldGet(_startTranslate, this).x + dx / _classPrivateFieldGet(_scale, this);
  _classPrivateFieldGet(_translate, this).y = _classPrivateFieldGet(_startTranslate, this).y + dy / _classPrivateFieldGet(_scale, this);
  _classPrivateFieldGet(_requestUpdateTransform, this).call(this);
}
/**
 * Constrain image translation to keep it within the viewport
 */
function _constrainTranslation() {
  var containerWidth = this.clientWidth;
  var containerHeight = this.clientHeight;
  if (!containerWidth || !containerHeight || !_classPrivateGetter(_DragZoomWrapper_brand, this, _get_image)) return;

  // Keep scale between MIN_ZOOM (1) and MAX_ZOOM (5)
  _classPrivateFieldSet(_scale, this, (0,_utilities_js__WEBPACK_IMPORTED_MODULE_0__.clamp)(_classPrivateFieldGet(_scale, this), MIN_ZOOM, MAX_ZOOM));

  // At minimum zoom (1x), the full image should be visible with no dragging allowed
  if (_classPrivateFieldGet(_scale, this) <= MIN_ZOOM) {
    _classPrivateFieldGet(_translate, this).x = 0;
    _classPrivateFieldGet(_translate, this).y = 0;
    return;
  }

  // Get wrapper dimensions
  var wrapperRect = this.getBoundingClientRect();
  ...
  var imageElement = _classPrivateGetter(_DragZoomWrapper_brand, this, _get_image);
  ...
  var wrapperAspectRatio = wrapperRect.width / wrapperRect.height;
  var actualImageWidth, actualImageHeight;
  ...
  var scaledImageWidth = actualImageWidth * _classPrivateFieldGet(_scale, this);
  var scaledImageHeight = actualImageHeight * _classPrivateFieldGet(_scale, this);
  ...
  var horizontalOverflow = Math.max(0, scaledImageWidth - wrapperRect.width);
  var verticalOverflow = Math.max(0, scaledImageHeight - wrapperRect.height);

  // Max translation is half the overflow (since image starts centered)
  var maxTranslateX = horizontalOverflow / 2 / _classPrivateFieldGet(_scale, this);
  var maxTranslateY = verticalOverflow / 2 / _classPrivateFieldGet(_scale, this);

  // Apply symmetric constraints (object-fit: contain behavior)
  // Image starts centered, can move maxTranslate in each direction
  _classPrivateFieldGet(_translate, this).x = (0,_utilities_js__WEBPACK_IMPORTED_MODULE_0__.clamp)(_classPrivateFieldGet(_translate, this).x, -maxTranslateX, maxTranslateX);
  _classPrivateFieldGet(_translate, this).y = (0,_utilities_js__WEBPACK_IMPORTED_MODULE_0__.clamp)(_classPrivateFieldGet(_translate, this).y, -maxTranslateY, maxTranslateY);

  // Apply final transforms to CSS
  this.style.setProperty('--drag-zoom-scale', _classPrivateFieldGet(_scale, this).toString());
  this.style.setProperty('--drag-zoom-translate-x', "".concat(_classPrivateFieldGet(_translate, this).x, "px"));
  this.style.setProperty('--drag-zoom-translate-y', "".concat(_classPrivateFieldGet(_translate, this).y, "px"));
}
/**
 * Cancel any pending animation frame
 */
function _cancelAnimationFrame() {
  if (_classPrivateFieldGet(_animationFrame, this)) {
    cancelAnimationFrame(_classPrivateFieldGet(_animationFrame, this));
    _classPrivateFieldSet(_animationFrame, this, null);
  }
}
/**
...
function _resetZoom() {
  ...
  _classPrivateFieldSet(_scale, this, DEFAULT_ZOOM);
  _classPrivateFieldSet(_startScale, this, DEFAULT_ZOOM);
  _classPrivateFieldGet(_translate, this).x = 0;
  _classPrivateFieldGet(_translate, this).y = 0;
  ...
  _classPrivateFieldSet(_isDragging, this, false);
  _classPrivateFieldSet(_lastTapTime, this, 0);
  _classPrivateFieldSet(_lastTapPosition, this, null);
  _classPrivateFieldSet(_hasDraggedBeyondThreshold, this, false);
...
function getDistance(point1, point2) {
  var _point1$x, _point1$y, _point2$x, _point2$y;
  // Handle both Point objects (x, y) and Touch objects (clientX, clientY)
  var x1 = /** @type {Point} */(_point1$x = point1.x) !== null && _point1$x !== void 0 ? _point1$x : /** @type {Touch} */point1.clientX;
  var y1 = /** @type {Point} */(_point1$y = point1.y) !== null && _point1$y !== void 0 ? _point1$y : /** @type {Touch} */point1.clientY;
  var x2 = /** @type {Point} */(_point2$x = point2.x) !== null && _point2$x !== void 0 ? _point2$x : /** @type {Touch} */point2.clientX;
  var y2 = /** @type {Point} */(_point2$y = point2.y) !== null && _point2$y !== void 0 ? _point2$y : /** @type {Touch} */point2.clientY;
  var dx = x1 - x2;
  var dy = y1 - y2;
