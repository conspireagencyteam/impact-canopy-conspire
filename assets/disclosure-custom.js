...
(() => {
/*!******************************************!*\
  !*** ./src/scripts/disclosure-custom.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
 ...
 */
var DisclosureCustom = /*#__PURE__*/function (_Component) {
  function DisclosureCustom() {
    var _this;
    _classCallCheck(this, DisclosureCustom);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, DisclosureCustom, [].concat(args));
    _defineProperty(_this, "requiredRefs", ['disclosureTrigger', 'disclosureContent']);
    /**
     ...
     */
    _defineProperty(_this, "toggleDisclosure", function () {
      var _this$refs = _this.refs,
        trigger = _this$refs.disclosureTrigger,
        content = _this$refs.disclosureContent;
      var expanded = trigger.matches('[aria-expanded="true"]');
      trigger.setAttribute('aria-expanded', String(!expanded));
      trigger.setAttribute('aria-label', "".concat(expanded ? trigger.dataset.disclosureOpen : trigger.dataset.disclosureClose));
      content.inert = expanded;
    });
    return _this;
  }
  _inherits(DisclosureCustom, _Component);
  return _createClass(DisclosureCustom, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(DisclosureCustom, "connectedCallback", this, 3)([]);
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(DisclosureCustom, "disconnectedCallback", this, 3)([]);
    }
  }]);
