...
(() => {
/*!************************************************!*\
  !*** ./src/scripts/product-custom-property.js ***!
  \************************************************/
__webpack_require__.r(__webpack_exports__);
 ...
 */
var _ProductCustomProperty_brand = /*#__PURE__*/new WeakSet();
var ProductCustomProperty = /*#__PURE__*/function (_Component) {
  function ProductCustomProperty() {
    var _this;
    _classCallCheck(this, ProductCustomProperty);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, ProductCustomProperty, [].concat(args));
    _classPrivateMethodInitSpec(_this, _ProductCustomProperty_brand);
    return _this;
  }
  _inherits(ProductCustomProperty, _Component);
  return _createClass(ProductCustomProperty, [{
    key: "handleInput",
    value: function handleInput() {
      _assertClassBrand(_ProductCustomProperty_brand, this, _updateCharacterCount).call(this);
    }
  }]);
}(_theme_component__WEBPACK_IMPORTED_MODULE_0__.Component);
function _updateCharacterCount() {
  var _this$refs = this.refs,
    characterCount = _this$refs.characterCount,
    textInput = _this$refs.textInput;
  var currentLength = textInput.value.length;
  var maxLength = textInput.maxLength;
  var template = characterCount.getAttribute('data-template');
  if (!template) return;
