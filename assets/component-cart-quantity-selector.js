...
/***/ "./src/scripts/component-quantity-selector.js":
/*!****************************************************!*\
  !*** ./src/scripts/component-quantity-selector.js ***!
  \****************************************************/
 ...
 */
var QuantitySelectorComponent = /*#__PURE__*/function (_Component) {
  function QuantitySelectorComponent() {
    var _this;
    _classCallCheck(this, QuantitySelectorComponent);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, QuantitySelectorComponent, [].concat(args));
    _defineProperty(_this, "requiredRefs", ['quantityInput', 'minusButton', 'plusButton']);
    _defineProperty(_this, "serverDisabledMinus", false);
    _defineProperty(_this, "serverDisabledPlus", false);
    _defineProperty(_this, "initialized", false);
    return _this;
  }
  _inherits(QuantitySelectorComponent, _Component);
  return _createClass(QuantitySelectorComponent, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(QuantitySelectorComponent, "connectedCallback", this, 3)([]);

      // Capture server-disabled state on first load
      var _this$refs = this.refs,
        minusButton = _this$refs.minusButton,
        plusButton = _this$refs.plusButton;
    ...
    value: function disconnectedCallback() {
      _superPropGet(QuantitySelectorComponent, "disconnectedCallback", this, 3)([]);
    }
    ...
    key: "setCartQuantity",
    value: function setCartQuantity(cartQty) {
    ...
    key: "canAddToCart",
    value: function canAddToCart() {
      var _this$getCurrentValue = this.getCurrentValues(),
        max = _this$getCurrentValue.max,
        cartQuantity = _this$getCurrentValue.cartQuantity,
        value = _this$getCurrentValue.value;
      var quantityToAdd = value;
      var wouldExceedMax = max !== null && cartQuantity + quantityToAdd > max;
      return {
    ...
    value: function updateConstraints(min, max, step) {
      var quantityInput = this.refs.quantityInput;
      ...
      var newMin = parseInt(min) || 1;
      var newStep = parseInt(step) || 1;
      var effectiveMax = this.getEffectiveMax();
      ...
      newValue = Math.max(newMin, Math.min(effectiveMax !== null && effectiveMax !== void 0 ? effectiveMax : Infinity, newValue));
    ...
    key: "getEffectiveMax",
    value: function getEffectiveMax() {
      var _this$getCurrentValue2 = this.getCurrentValues(),
        max = _this$getCurrentValue2.max,
        cartQuantity = _this$getCurrentValue2.cartQuantity,
        min = _this$getCurrentValue2.min;
    ...
    value: function updateButtonStates() {
      var _this$refs2 = this.refs,
        minusButton = _this$refs2.minusButton,
        plusButton = _this$refs2.plusButton;
      var _this$getCurrentValue3 = this.getCurrentValues(),
        min = _this$getCurrentValue3.min,
        value = _this$getCurrentValue3.value;
      var effectiveMax = this.getEffectiveMax();
    ...
    key: "updateQuantity",
    value: function updateQuantity(stepMultiplier) {
      var quantityInput = this.refs.quantityInput;
      var _this$getCurrentValue4 = this.getCurrentValues(),
        min = _this$getCurrentValue4.min,
        step = _this$getCurrentValue4.step,
        value = _this$getCurrentValue4.value;
      var effectiveMax = this.getEffectiveMax();
      var newValue = Math.min(effectiveMax !== null && effectiveMax !== void 0 ? effectiveMax : Infinity, Math.max(min, value + step * stepMultiplier));
      quantityInput.value = newValue.toString();
    ...
    value: function selectInputValue(event) {
      var quantityInput = this.refs.quantityInput;
    ...
    value: function setQuantity(event) {
      ...
      event.preventDefault();
      var quantityInput = this.refs.quantityInput;
      var _this$getCurrentValue5 = this.getCurrentValues(),
        min = _this$getCurrentValue5.min,
        step = _this$getCurrentValue5.step;
      var effectiveMax = this.getEffectiveMax();

      // Snap to bounds
      var quantity = Math.min(effectiveMax !== null && effectiveMax !== void 0 ? effectiveMax : Infinity, Math.max(min, parseInt(event.target.value) || 0));
    ...
    value: function onQuantityChange() {
      ...
      quantityInput.dispatchEvent(new _theme_events__WEBPACK_IMPORTED_MODULE_1__.QuantitySelectorUpdateEvent(newValue, Number(quantityInput.dataset.cartLine)));
    }
    ...
    value: function updateCartQuantity() {
      var quantityInput = this.refs.quantityInput;
      var _this$getCurrentValue6 = this.getCurrentValues(),
        min = _this$getCurrentValue6.min,
        value = _this$getCurrentValue6.value;
      var effectiveMax = this.getEffectiveMax();

      // Clamp value to new effective max if necessary
      var clampedValue = Math.min(effectiveMax !== null && effectiveMax !== void 0 ? effectiveMax : Infinity, Math.max(min, value));
...
(() => {
/*!*********************************************************!*\
  !*** ./src/scripts/component-cart-quantity-selector.js ***!
  \*********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _theme_component_quantity_selector__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @theme/component-quantity-selector */ "./src/scripts/component-quantity-selector.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
function _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
 ...
 */
var CartQuantitySelectorComponent = /*#__PURE__*/function (_QuantitySelectorComp) {
  function CartQuantitySelectorComponent() {
    _classCallCheck(this, CartQuantitySelectorComponent);
    return _callSuper(this, CartQuantitySelectorComponent, arguments);
  }
  _inherits(CartQuantitySelectorComponent, _QuantitySelectorComp);
  return _createClass(CartQuantitySelectorComponent, [{
    key: "getEffectiveMax",
    value:
    /**
    ...
    value: function updateButtonStates() {
      ...
      var _this$getCurrentValue2 = this.getCurrentValues(),
        min = _this$getCurrentValue2.min,
        value = _this$getCurrentValue2.value;
      var effectiveMax = this.getEffectiveMax();
...
}(_theme_component_quantity_selector__WEBPACK_IMPORTED_MODULE_0__.QuantitySelectorComponent);
