...
(() => {
/*!******************************************!*\
  !*** ./src/scripts/product-inventory.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
...
var ProductInventory = /*#__PURE__*/function (_HTMLElement) {
  function ProductInventory() {
    var _this;
    _classCallCheck(this, ProductInventory);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, ProductInventory, [].concat(args));
    /**
     * Updates the inventory.
     * @param {VariantUpdateEvent} event - The variant update event.
     */
    _defineProperty(_this, "updateInventory", function (event) {
      ...
      var newInventory = event.detail.data.html.querySelector('product-inventory');
      if (!newInventory) return;
      (0,_theme_morph__WEBPACK_IMPORTED_MODULE_1__.morph)(_this, newInventory, {
        childrenOnly: true
      });
    });
    return _this;
  }
  _inherits(ProductInventory, _HTMLElement);
  return _createClass(ProductInventory, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      var closestSection = this.closest('.shopify-section, dialog');
      closestSection === null || closestSection === void 0 || closestSection.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_0__.ThemeEvents.variantUpdate, this.updateInventory);
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      var closestSection = this.closest('.shopify-section, dialog');
      closestSection === null || closestSection === void 0 || closestSection.removeEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_0__.ThemeEvents.variantUpdate, this.updateInventory);
    }
  }]);
}(/*#__PURE__*/_wrapNativeSuper(HTMLElement));
