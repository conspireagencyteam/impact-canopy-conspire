...
(() => {
/*!*****************************************!*\
  !*** ./src/scripts/accordion-custom.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
...
// Accordion
var _AccordionCustom_brand = /*#__PURE__*/new WeakSet();
var _controller = /*#__PURE__*/new WeakMap();
var _handleMediaQueryChange = /*#__PURE__*/new WeakMap();
var AccordionCustom = /*#__PURE__*/function (_HTMLElement) {
  function AccordionCustom() {
    ...
    _this4 = _callSuper(this, AccordionCustom, [].concat(args));
    _classPrivateMethodInitSpec(_this4, _AccordionCustom_brand);
    _classPrivateFieldInitSpec(_this4, _controller, new AbortController());
    /**
     * Handles the click event.
     * @param {Event} event - The event.
     */
    _defineProperty(_this4, "handleClick", function (event) {
      var isMobile = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_0__.isMobileBreakpoint)();
      var isDesktop = !isMobile;

      // Stop default behaviour from the browser
      if (isMobile && _classPrivateGetter(_AccordionCustom_brand, _this4, _get_disableOnMobile) || isDesktop && _classPrivateGetter(_AccordionCustom_brand, _this4, _get_disableOnDesktop)) {
        event.preventDefault();
        return;
      }
    });
     ...
     */
    _classPrivateFieldInitSpec(_this4, _handleMediaQueryChange, function () {
      _assertClassBrand(_AccordionCustom_brand, _this4, _setDefaultOpenState).call(_this4);
    });
    return _this4;
  }
  _inherits(AccordionCustom, _HTMLElement);
  return _createClass(AccordionCustom, [{
    key: "details",
    get: /** @type {HTMLDetailsElement} */
    function get() {
    ...
    value: function connectedCallback() {
      ...
      _assertClassBrand(_AccordionCustom_brand, this, _setDefaultOpenState).call(this);
      this.addEventListener('keydown', _assertClassBrand(_AccordionCustom_brand, this, _handleKeyDown), {
        signal: signal
      });
...
function _get_disableOnMobile(_this) {
  return _this.dataset.disableOnMobile === 'true';
}
function _get_disableOnDesktop(_this2) {
  return _this2.dataset.disableOnDesktop === 'true';
}
function _get_closeWithEscape(_this3) {
  return _this3.dataset.closeWithEscape === 'true';
}
/**
...
function _handleKeyDown(event) {
  ...
  if (event.key === 'Escape' && _classPrivateGetter(_AccordionCustom_brand, this, _get_closeWithEscape)) {
    event.preventDefault();
