...
(() => {
/*!******************************************!*\
  !*** ./src/scripts/search-page-input.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
 ...
 */
var _SearchPageInputComponent_brand = /*#__PURE__*/new WeakSet();
var _isEmptyState = /*#__PURE__*/new WeakMap();
var SearchPageInputComponent = /*#__PURE__*/function (_Component) {
  function SearchPageInputComponent() {
    var _this;
    _classCallCheck(this, SearchPageInputComponent);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, SearchPageInputComponent, [].concat(args));
    _classPrivateMethodInitSpec(_this, _SearchPageInputComponent_brand);
    _defineProperty(_this, "requiredRefs", ['searchPageInput']);
    /**
     ...
     */
    _defineProperty(_this, "handleKeyDown", (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.debounce)(function (event) {
      var value = _this.refs.searchPageInput.value.trim();
      if (event.key === 'Escape' && value === '') {
        _assertClassBrand(_SearchPageInputComponent_brand, _this, _submitEmptySearch).call(_this);
      }
    }, 100));
    _classPrivateFieldInitSpec(_this, _isEmptyState, function () {
      var _url$searchParams$get;
      var url = new URL(window.location.href);
      var queryParam = (_url$searchParams$get = url.searchParams.get('q')) !== null && _url$searchParams$get !== void 0 ? _url$searchParams$get : '';
      return queryParam.trim() === '';
    });
    return _this;
  }
  _inherits(SearchPageInputComponent, _Component);
  return _createClass(SearchPageInputComponent, [{
    ...
    function handleClearClick() {
      _assertClassBrand(_SearchPageInputComponent_brand, this, _submitEmptySearch).call(this);
    }
  }]);
}(_theme_component__WEBPACK_IMPORTED_MODULE_0__.Component);
function _submitEmptySearch() {
  var _searchInput$form;
  var searchInput = this.refs.searchPageInput;
  searchInput.focus();
  searchInput.value = '';
  if (_classPrivateFieldGet(_isEmptyState, this).call(this)) return;
  (_searchInput$form = searchInput.form) === null || _searchInput$form === void 0 || _searchInput$form.submit();
}
