...
/* harmony export */ });
/* harmony import */ var _theme_critical__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @theme/critical */ "./src/scripts/critical.js");
/* harmony import */ var _theme_variant_picker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @theme/variant-picker */ "./src/scripts/variant-picker.js");
/* harmony import */ var _theme_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @theme/component */ "./src/scripts/component.js");
/* harmony import */ var _theme_utilities__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @theme/utilities */ "./src/scripts/utilities.js");
/* harmony import */ var _theme_events__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @theme/events */ "./src/scripts/events.js");
/* harmony import */ var _theme_morph__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @theme/morph */ "./src/scripts/morph.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t.return || t.return(); } finally { if (u) throw o; } } }; }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
 ...
 */
var _fetchProductPageHandler = /*#__PURE__*/new WeakMap();
var _navigateToURL = /*#__PURE__*/new WeakMap();
var _ProductCard_brand = /*#__PURE__*/new WeakSet();
var _handleQuickAdd = /*#__PURE__*/new WeakMap();
var _handleVariantSelected = /*#__PURE__*/new WeakMap();
var _handleVariantUpdate = /*#__PURE__*/new WeakMap();
var _previousSlideIndex = /*#__PURE__*/new WeakMap();
var _handleSlideshowSelect = /*#__PURE__*/new WeakMap();
var _resetVariant = /*#__PURE__*/new WeakMap();
var ProductCard = /*#__PURE__*/function (_Component) {
  function ProductCard() {
    ...
    _classPrivateMethodInitSpec(_this, _ProductCard_brand);
    _defineProperty(_this, "requiredRefs", ['productCardLink']);
    _classPrivateFieldInitSpec(_this, _fetchProductPageHandler, function () {
      var quickAdd = _this.refs.quickAdd;
      if (quickAdd && typeof quickAdd.fetchProductPage === 'function') {
        quickAdd.fetchProductPage(_this.productPageUrl);
      }
    });
    /**
     ...
     */
    _classPrivateFieldInitSpec(_this, _navigateToURL, function (event, url) {
      // Check for modifier keys that should open in new tab/window (only for mouse events)
      var shouldOpenInNewTab = event instanceof MouseEvent && (event.metaKey || event.ctrlKey || event.shiftKey || event.button === 1);
     ...
     */
    _classPrivateFieldInitSpec(_this, _handleQuickAdd, function () {
      _this.removeEventListener('pointerenter', _classPrivateFieldGet(_fetchProductPageHandler, _this));
      _this.removeEventListener('focusin', _classPrivateFieldGet(_fetchProductPageHandler, _this));
      if ((0,_theme_utilities__WEBPACK_IMPORTED_MODULE_3__.isDesktopBreakpoint)()) {
        _this.addEventListener('pointerenter', _classPrivateFieldGet(_fetchProductPageHandler, _this));
        _this.addEventListener('focusin', _classPrivateFieldGet(_fetchProductPageHandler, _this));
      }
    });
    /**
     ...
     */
    _classPrivateFieldInitSpec(_this, _handleVariantSelected, function (event) {
      if (event.target !== _this.variantPicker) {
        var _this$variantPicker;
        (_this$variantPicker = _this.variantPicker) === null || _this$variantPicker === void 0 || _this$variantPicker.updateSelectedOption(event.detail.resource.id);
      }
    });
    /**
     ...
     */
    _classPrivateFieldInitSpec(_this, _handleVariantUpdate, function (event) {
      ...
      _assertClassBrand(_ProductCard_brand, _this, _isUnavailableVariantSelected).call(_this, event);
      _assertClassBrand(_ProductCard_brand, _this, _updateProductUrl).call(_this, event);
      var quickAdd = _this.refs.quickAdd;
      if (quickAdd && typeof quickAdd.fetchProductPage === 'function') {
        quickAdd.fetchProductPage(_this.productPageUrl);
      }
      if (event.target !== _this.variantPicker) {
        var _this$variantPicker2;
        (_this$variantPicker2 = _this.variantPicker) === null || _this$variantPicker2 === void 0 || _this$variantPicker2.updateVariantPicker(event.detail.data.html);
      }
      _assertClassBrand(_ProductCard_brand, _this, _updateVariantImages).call(_this);
      _classPrivateFieldSet(_previousSlideIndex, _this, null);

      // Remove attribute after re-rendering since a variant selection has been made
      _this.removeAttribute('data-no-swatch-selected');
      ...
      _assertClassBrand(_ProductCard_brand, _this, _updateOverflowList).call(_this);
    });
    /** @type {number | null} */
    _classPrivateFieldInitSpec(_this, _previousSlideIndex, null);
    /**
     * Handles the slideshow select event.
     * @param {SlideshowSelectEvent} event - The slideshow select event.
     */
    _classPrivateFieldInitSpec(_this, _handleSlideshowSelect, function (event) {
      if (event.detail.userInitiated) {
        _classPrivateFieldSet(_previousSlideIndex, _this, event.detail.index);
      }
    });
    /**
     * Resets the image to the variant image.
     */
    _classPrivateFieldInitSpec(_this, _resetVariant, function () {
      var _this$variantPicker3, _slideshow$slides;
      var slideshow = _this.refs.slideshow;
      if (!slideshow) return;

      // If we have a selected variant, always use its image
      if ((_this$variantPicker3 = _this.variantPicker) !== null && _this$variantPicker3 !== void 0 && _this$variantPicker3.selectedOption) {
        var id = _this.variantPicker.selectedOption.dataset.optionMediaId;
        if (id) {
          slideshow.select({
            id: id
          }, undefined, {
      ...
      var initialSlide = slideshow.initialSlide;
      var slideId = initialSlide === null || initialSlide === void 0 ? void 0 : initialSlide.getAttribute('slide-id');
      if (initialSlide && (_slideshow$slides = slideshow.slides) !== null && _slideshow$slides !== void 0 && _slideshow$slides.includes(initialSlide) && slideId) {
        slideshow.select({
          id: slideId
        }, undefined, {
          animate: false
     ...
     * @param {Event} event
     */
    _defineProperty(_this, "navigateToProduct", function (event) {
      if (!(event.target instanceof Element)) return;

      // Don't navigate if this product card is marked as no-navigation (e.g., in theme editor)
      if (_this.hasAttribute('data-no-navigation')) return;
      ...
      var link = _this.refs.productCardLink;
      if (!link.href) return;
      var linkURL = new URL(link.href);
      var productCardAnchor = link.getAttribute('id');
      ...
      if (!targetLink) {
        _classPrivateFieldGet(_navigateToURL, _this).call(_this, event, linkURL);
      }
    });
    /**
     * Resets the variant.
     */
    _defineProperty(_this, "resetVariant", (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_3__.debounce)(_classPrivateFieldGet(_resetVariant, _this), 100));
    return _this;
  }
  ...
  return _createClass(ProductCard, [{
    ...
    value: function getSelectedVariantId() {
      var checkedInput = /** @type {HTMLInputElement | null} */
      this.querySelector('input[type="radio"]:checked[data-variant-id]');
      return (checkedInput === null || checkedInput === void 0 ? void 0 : checkedInput.dataset.variantId) || null;
    }
    ...
    key: "getProductCardLink",
    value: function getProductCardLink() {
    ...
    value: function connectedCallback() {
      var _this2 = this;
      _superPropGet(ProductCard, "connectedCallback", this, 3)([]);
      var link = this.refs.productCardLink;
      if (!(link instanceof HTMLAnchorElement)) throw new Error('Product card link not found');
      _classPrivateFieldGet(_handleQuickAdd, this).call(this);
      this.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_4__.ThemeEvents.variantUpdate, _classPrivateFieldGet(_handleVariantUpdate, this));
      this.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_4__.ThemeEvents.variantSelected, _classPrivateFieldGet(_handleVariantSelected, this));
      this.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_4__.SlideshowSelectEvent.eventName, _classPrivateFieldGet(_handleSlideshowSelect, this));
      _theme_utilities__WEBPACK_IMPORTED_MODULE_3__.mediaQueryLarge.addEventListener('change', _classPrivateFieldGet(_handleQuickAdd, this));
      ...
      setTimeout(function () {
        var _this2$refs$slideshow;
        if ((_this2$refs$slideshow = _this2.refs.slideshow) !== null && _this2$refs$slideshow !== void 0 && _this2$refs$slideshow.isNested) {
          _assertClassBrand(_ProductCard_brand, _this2, _preloadNextPreviewImage).call(_this2);
        }
      });
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(ProductCard, "disconnectedCallback", this, 3)([]);
    ...
    function updatePrice(event) {
      var priceContainer = this.querySelectorAll("product-price [ref='priceContainer']")[1];
      var newPriceElement = event.detail.data.html.querySelector("product-price [ref='priceContainer']");
      if (newPriceElement && priceContainer) {
        (0,_theme_morph__WEBPACK_IMPORTED_MODULE_5__.morph)(priceContainer, newPriceElement);
      }
    }
    ...
    function previewVariant(id) {
      var slideshow = this.refs.slideshow;
      if (!slideshow) return;
    ...
    value: function previewImage(event) {
      ...
      var _this$refs = this.refs,
        cardGallery = _this$refs.cardGallery,
        slideshow = _this$refs.slideshow;
      var isMobile = window.innerWidth < 750;
      var hasDesktopHover = (cardGallery === null || cardGallery === void 0 ? void 0 : cardGallery.dataset.hoverDesktop) === 'true';
      var hasMobileHover = (cardGallery === null || cardGallery === void 0 ? void 0 : cardGallery.dataset.hoverMobile) === 'true';

      // Check if hover should be active based on device and settings
      if (isMobile && !hasMobileHover) return;
      if (!isMobile && !hasDesktopHover) return;

      // On desktop, only allow mouse events
      // On mobile with mobile hover enabled, allow touch events
      if (!isMobile && event.pointerType !== 'mouse') return;
      if (!slideshow) return;
      this.resetVariant.cancel();
      if (_classPrivateFieldGet(_previousSlideIndex, this) != null && _classPrivateFieldGet(_previousSlideIndex, this) > 0) {
        slideshow.select(_classPrivateFieldGet(_previousSlideIndex, this), undefined, {
          animate: false
        });
      } else {
        ...
        setTimeout(function () {
          return _assertClassBrand(_ProductCard_brand, _this3, _preloadNextPreviewImage).call(_this3);
        });
      }
    }
    ...
    key: "resetImage",
    value: function resetImage(event) {
      var _this$refs2 = this.refs,
        cardGallery = _this$refs2.cardGallery,
        slideshow = _this$refs2.slideshow;
      var isMobile = window.innerWidth < 750;
      var hasDesktopHover = (cardGallery === null || cardGallery === void 0 ? void 0 : cardGallery.dataset.hoverDesktop) === 'true';
      var hasMobileHover = (cardGallery === null || cardGallery === void 0 ? void 0 : cardGallery.dataset.hoverMobile) === 'true';
      ...
      if (!this.variantPicker) {
        ...
        _classPrivateFieldGet(_resetVariant, this).call(this);
      }
    }
  }]);
}(_theme_component__WEBPACK_IMPORTED_MODULE_2__.Component);
function _preloadNextPreviewImage() {
  var _this$refs$slideshow, _this$refs$slideshow2, _currentSlide$nextEle;
  var currentSlide = (_this$refs$slideshow = this.refs.slideshow) === null || _this$refs$slideshow === void 0 || (_this$refs$slideshow = _this$refs$slideshow.slides) === null || _this$refs$slideshow === void 0 ? void 0 : _this$refs$slideshow[(_this$refs$slideshow2 = this.refs.slideshow) === null || _this$refs$slideshow2 === void 0 ? void 0 : _this$refs$slideshow2.current];
  currentSlide === null || currentSlide === void 0 || (_currentSlide$nextEle = currentSlide.nextElementSibling) === null || _currentSlide$nextEle === void 0 || (_currentSlide$nextEle = _currentSlide$nextEle.querySelector('img[loading="lazy"]')) === null || _currentSlide$nextEle === void 0 || _currentSlide$nextEle.removeAttribute('loading');
}
/**
 ...
 */
function _updateOverflowList() {
  // Find the overflow list in the variant picker
  var overflowList = this.querySelector('swatches-variant-picker-component overflow-list');
  var isActiveOverflowList = overflowList !== null && overflowList !== void 0 && overflowList.querySelector('[slot="overflow"]') ? true : false;
  if (!overflowList || !isActiveOverflowList) return;

  // Use requestAnimationFrame to ensure DOM has been updated
  requestAnimationFrame(function () {
    // Dispatch a reflow event to trigger recalculation
    overflowList.dispatchEvent(new CustomEvent('reflow', {
      bubbles: true,
      detail: {}
    }));
  });
}
function _updateProductUrl(event) {
  var _event$detail$data$ht, _event$detail$data$ht2, _this$closest;
  var anchorElement = (_event$detail$data$ht = event.detail.data.html) === null || _event$detail$data$ht === void 0 ? void 0 : _event$detail$data$ht.querySelector('product-card a');
  var featuredMediaUrl = (_event$detail$data$ht2 = event.detail.data.html) === null || _event$detail$data$ht2 === void 0 || (_event$detail$data$ht2 = _event$detail$data$ht2.querySelector('product-card-link')) === null || _event$detail$data$ht2 === void 0 ? void 0 : _event$detail$data$ht2.getAttribute('data-featured-media-url');

  // If the product card is inside a product link, update the product link's featured media URL
  if (featuredMediaUrl && this.closest('product-card-link')) (_this$closest = this.closest('product-card-link')) === null || _this$closest === void 0 || _this$closest.setAttribute('data-featured-media-url', featuredMediaUrl);
  if (anchorElement instanceof HTMLAnchorElement) {
    var _anchorElement$getAtt;
    // If the href is empty, don't update the product URL eg: unavailable variant
    if (((_anchorElement$getAtt = anchorElement.getAttribute('href')) === null || _anchorElement$getAtt === void 0 ? void 0 : _anchorElement$getAtt.trim()) === '') return;
    var productUrl = anchorElement.href;
    var _this$refs3 = this.refs,
      productCardLink = _this$refs3.productCardLink,
      productTitleLink = _this$refs3.productTitleLink,
      cardGalleryLink = _this$refs3.cardGalleryLink;
 ...
 * @param {VariantUpdateEvent} event - The variant update event.
 */
function _isUnavailableVariantSelected(event) {
  var allVariants = /** @type {NodeListOf<HTMLInputElement>} */
  event.detail.data.html.querySelectorAll('input:checked');
  var _iterator = _createForOfIteratorHelper(allVariants),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var variant = _step.value;
      _assertClassBrand(_ProductCard_brand, this, _toggleAddToCartButton).call(this, variant.dataset.optionAvailable === 'true');
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
 ...
 */
function _toggleAddToCartButton(enable) {
  var addToCartButton = this.querySelector('.add-to-cart__button button');
 ...
 */
function _updateVariantImages() {
  var _this$variantPicker4, _this$variantPicker5;
  var slideshow = this.refs.slideshow;
  if (!((_this$variantPicker4 = this.variantPicker) !== null && _this$variantPicker4 !== void 0 && _this$variantPicker4.selectedOption)) {
    return;
  }
  var selectedImageId = (_this$variantPicker5 = this.variantPicker) === null || _this$variantPicker5 === void 0 ? void 0 : _this$variantPicker5.selectedOption.dataset.optionMediaId;
  if (slideshow && selectedImageId) {
    var _slideshow$refs$slide = slideshow.refs.slides,
      slides = _slideshow$refs$slide === void 0 ? [] : _slideshow$refs$slide;
 ...
 */
var _SwatchesVariantPickerComponent_brand = /*#__PURE__*/new WeakSet();
var SwatchesVariantPickerComponent = /*#__PURE__*/function (_VariantPicker) {
  function SwatchesVariantPickerComponent() {
    var _this4;
    _classCallCheck(this, SwatchesVariantPickerComponent);
    for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
      args[_key2] = arguments[_key2];
    }
    _this4 = _callSuper(this, SwatchesVariantPickerComponent, [].concat(args));
    /**
     * Updates the card URL when a variant is selected.
     */
    _classPrivateMethodInitSpec(_this4, _SwatchesVariantPickerComponent_brand);
    return _this4;
  }
  _inherits(SwatchesVariantPickerComponent, _VariantPicker);
  return _createClass(SwatchesVariantPickerComponent, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(SwatchesVariantPickerComponent, "connectedCallback", this, 3)([]);
      ...
      this.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_4__.ThemeEvents.variantUpdate, _assertClassBrand(_SwatchesVariantPickerComponent_brand, this, _handleCardVariantUrlUpdate).bind(this));
    }
  }, {
    key: "variantChanged",
    value:
    ...
    function variantChanged(event) {
      var _event$target$name;
      if (!(event.target instanceof HTMLElement)) return;

      // Check if this is a swatch input
      var isSwatchInput = event.target instanceof HTMLInputElement && ((_event$target$name = event.target.name) === null || _event$target$name === void 0 ? void 0 : _event$target$name.includes('-swatch'));
      var clickedSwatch = event.target;
      var availableCount = parseInt(clickedSwatch.dataset.availableCount || '0');
      var firstAvailableVariantId = clickedSwatch.dataset.firstAvailableOrFirstVariantId;

      // For swatch inputs, check if we need special handling
      if (isSwatchInput && availableCount > 0 && firstAvailableVariantId) {
        var _this$dataset$product;
        ...
        var productUrl = (_this$dataset$product = this.dataset.productUrl) === null || _this$dataset$product === void 0 ? void 0 : _this$dataset$product.split('?')[0];
      ...
      _superPropGet(SwatchesVariantPickerComponent, "variantChanged", this, 3)([event]);
    }
    ...
    key: "showAllSwatches",
    value: function showAllSwatches(event) {
      event === null || event === void 0 || event.preventDefault();
      var overflowList = this.refs.overflowList;
      if (overflowList instanceof _theme_critical__WEBPACK_IMPORTED_MODULE_0__.OverflowList) {
        overflowList.showAll();
      }
    }
  }]);
}(_theme_variant_picker__WEBPACK_IMPORTED_MODULE_1__["default"]);
function _handleCardVariantUrlUpdate() {
  if (this.pendingVariantId && this.parentProductCard instanceof ProductCard) {
    var currentUrl = new URL(this.parentProductCard.refs.productCardLink.href);
