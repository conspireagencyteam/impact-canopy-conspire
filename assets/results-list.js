...
/* harmony export */ });
/* harmony import */ var _theme_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @theme/component */ "./src/scripts/component.js");
/* harmony import */ var _theme_section_renderer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @theme/section-renderer */ "./src/scripts/section-renderer.js");
/* harmony import */ var _theme_utilities__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @theme/utilities */ "./src/scripts/utilities.js");
/* harmony import */ var _theme_events__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @theme/events */ "./src/scripts/events.js");
/* harmony import */ var _theme_paginated_list_aspect_ratio__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @theme/paginated-list-aspect-ratio */ "./src/scripts/paginated-list-aspect-ratio.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _toConsumableArray(r) { return _arrayWithoutHoles(r) || _iterableToArray(r) || _unsupportedIterableToArray(r) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _iterableToArray(r) { if ("undefined" != typeof Symbol && null != r[Symbol.iterator] || null != r["@@iterator"]) return Array.from(r); }
 ...
 */
var _resolveNextPagePromise = /*#__PURE__*/new WeakMap();
var _resolvePreviousPagePromise = /*#__PURE__*/new WeakMap();
var _aspectRatioHelper = /*#__PURE__*/new WeakMap();
var _PaginatedList_brand = /*#__PURE__*/new WeakSet();
var _handleFilterUpdate = /*#__PURE__*/new WeakMap();
var PaginatedList = /*#__PURE__*/function (_Component) {
  function PaginatedList() {
    ...
    _this = _callSuper(this, PaginatedList, [].concat(args));
    _classPrivateMethodInitSpec(_this, _PaginatedList_brand);
    /**
     * @type {Map<number, string>}
     */
    _defineProperty(_this, "pages", new Map());
    /** @type {IntersectionObserver | undefined} */
    _defineProperty(_this, "infinityScrollObserver", void 0);
    /** @type {((value: void) => void) | null} */
    _classPrivateFieldInitSpec(_this, _resolveNextPagePromise, null);
    /** @type {((value: void) => void) | null} */
    _classPrivateFieldInitSpec(_this, _resolvePreviousPagePromise, null);
    /** @type {PaginatedListAspectRatioHelper} */
    _classPrivateFieldInitSpec(_this, _aspectRatioHelper, void 0);
    /**
     * Handle filter updates by clearing cached pages
     */
    _classPrivateFieldInitSpec(_this, _handleFilterUpdate, function () {
      var _classPrivateFieldGet2, _classPrivateFieldGet3, _this$refs$grid;
      _this.pages.clear();

      // Resolve any pending promises to unblock waiting renders
      (_classPrivateFieldGet2 = _classPrivateFieldGet(_resolveNextPagePromise, _this)) === null || _classPrivateFieldGet2 === void 0 || _classPrivateFieldGet2.call(_this);
      (_classPrivateFieldGet3 = _classPrivateFieldGet(_resolvePreviousPagePromise, _this)) === null || _classPrivateFieldGet3 === void 0 || _classPrivateFieldGet3.call(_this);
      _classPrivateFieldSet(_resolveNextPagePromise, _this, null);
      _classPrivateFieldSet(_resolvePreviousPagePromise, _this, null);

      // Store the current lastPage value to detect when it changes
      var currentLastPage = (_this$refs$grid = _this.refs.grid) === null || _this$refs$grid === void 0 ? void 0 : _this$refs$grid.dataset.lastPage;
      ...
      var observer = new MutationObserver(function () {
        var _this$refs$grid2;
        // Check if data-last-page changed
        var newLastPage = (_this$refs$grid2 = _this.refs.grid) === null || _this$refs$grid2 === void 0 ? void 0 : _this$refs$grid2.dataset.lastPage;
        if (newLastPage !== currentLastPage) {
          ...
          _assertClassBrand(_PaginatedList_brand, _this, _observeViewMore).call(_this);

          // Fetch the next page
          _assertClassBrand(_PaginatedList_brand, _this, _fetchPage).call(_this, 'next');
        }
      });

      // Observe the grid for changes
      var grid = _this.refs.grid;
      if (grid) {
  ...
  _inherits(PaginatedList, _Component);
  return _createClass(PaginatedList, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(PaginatedList, "connectedCallback", this, 3)([]);

      /** @type {HTMLElement | null} */
      var templateCard = this.querySelector('[ref="cardGallery"]');
      if (templateCard) {
        _classPrivateFieldSet(_aspectRatioHelper, this, new _theme_paginated_list_aspect_ratio__WEBPACK_IMPORTED_MODULE_4__.PaginatedListAspectRatioHelper({
          templateCard: templateCard
        }));
      }
      _assertClassBrand(_PaginatedList_brand, this, _fetchPage).call(this, 'next');
      _assertClassBrand(_PaginatedList_brand, this, _fetchPage).call(this, 'previous');
      _assertClassBrand(_PaginatedList_brand, this, _observeViewMore).call(this);

      // Listen for filter updates to clear cached pages
      document.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_3__.ThemeEvents.FilterUpdate, _classPrivateFieldGet(_handleFilterUpdate, this));
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(PaginatedList, "disconnectedCallback", this, 3)([]);
      if (this.infinityScrollObserver) {
        this.infinityScrollObserver.disconnect();
      }
      // Remove the filter update listener
      document.removeEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_3__.ThemeEvents.FilterUpdate, _classPrivateFieldGet(_handleFilterUpdate, this));
    }
  }, {
    key: "sectionId",
    get: function get() {
...
function _observeViewMore() {
  var _this2 = this;
  var _this$refs = this.refs,
    viewMorePrevious = _this$refs.viewMorePrevious,
    viewMoreNext = _this$refs.viewMoreNext;
  ...
  if (!this.infinityScrollObserver) {
    this.infinityScrollObserver = new IntersectionObserver(/*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(entries) {
        var _iterator, _step, entry, _this2$refs, _viewMorePrevious, _viewMoreNext;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              if (!_theme_utilities__WEBPACK_IMPORTED_MODULE_2__.viewTransition.current) {
                _context.n = 1;
                break;
              }
              _context.n = 1;
              return _theme_utilities__WEBPACK_IMPORTED_MODULE_2__.viewTransition.current;
            case 1:
              ...
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done;) {
                  ...
                  if (entry.isIntersecting) {
                    ...
                    _this2$refs = _this2.refs, _viewMorePrevious = _this2$refs.viewMorePrevious, _viewMoreNext = _this2$refs.viewMoreNext;
                    if (entry.target === _viewMorePrevious) {
                      _assertClassBrand(_PaginatedList_brand, _this2, _renderPreviousPage).call(_this2);
                    } else if (entry.target === _viewMoreNext) {
                      _assertClassBrand(_PaginatedList_brand, _this2, _renderNextPage).call(_this2);
                    }
                  }
                }
              } catch (err) {
 ...
 */
function _shouldUsePage(pageInfo) {
  if (!pageInfo) return false;
  var grid = this.refs.grid;
  var lastPage = grid === null || grid === void 0 ? void 0 : grid.dataset.lastPage;
 ...
 */
function _fetchPage(_x2) {
  return _fetchPage2.apply(this, arguments);
}
function _fetchPage2() {
  _fetchPage2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(type) {
    var _this3 = this;
    var page, resolvePromise;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          page = _assertClassBrand(_PaginatedList_brand, this, _getPage).call(this, type); // Always resolve the promise, even if we can't fetch the page
          resolvePromise = function resolvePromise() {
            if (type === 'next') {
              var _classPrivateFieldGet4;
              (_classPrivateFieldGet4 = _classPrivateFieldGet(_resolveNextPagePromise, _this3)) === null || _classPrivateFieldGet4 === void 0 || _classPrivateFieldGet4.call(_this3);
              _classPrivateFieldSet(_resolveNextPagePromise, _this3, null);
            } else {
              var _classPrivateFieldGet5;
              (_classPrivateFieldGet5 = _classPrivateFieldGet(_resolvePreviousPagePromise, _this3)) === null || _classPrivateFieldGet5 === void 0 || _classPrivateFieldGet5.call(_this3);
              _classPrivateFieldSet(_resolvePreviousPagePromise, _this3, null);
            }
          };
          if (!(!page || !_assertClassBrand(_PaginatedList_brand, this, _shouldUsePage).call(this, page))) {
            _context2.n = 1;
            break;
          }
        ...
        case 1:
          _context2.n = 2;
          return _assertClassBrand(_PaginatedList_brand, this, _fetchSpecificPage).call(this, page.page, page.url);
        case 2:
          resolvePromise();
        case 3:
          return _context2.a(2);
 ...
 */
function _fetchSpecificPage(_x3) {
  return _fetchSpecificPage2.apply(this, arguments);
}
function _fetchSpecificPage2() {
  _fetchSpecificPage2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(pageNumber) {
    var url,
      pageInfo,
      newUrl,
      pageContent,
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          url = _args3.length > 1 && _args3[1] !== undefined ? _args3[1] : undefined;
          pageInfo = {
            page: pageNumber,
            url: url
          };
          ...
          if (_assertClassBrand(_PaginatedList_brand, this, _shouldUsePage).call(this, pageInfo)) {
            _context3.n = 1;
            break;
          }
        ...
        case 1:
          _context3.n = 2;
          return _theme_section_renderer__WEBPACK_IMPORTED_MODULE_1__.sectionRenderer.getSectionHTML(this.sectionId, true, pageInfo.url);
        case 2:
          pageContent = _context3.v;
...
function _renderNextPage() {
  return _renderNextPage2.apply(this, arguments);
}
function _renderNextPage2() {
  _renderNextPage2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
    var _this4 = this;
    var grid, nextPage, nextPageItemElements, promise;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        ...
        case 1:
          nextPage = _assertClassBrand(_PaginatedList_brand, this, _getPage).call(this, 'next');
          if (!(!nextPage || !_assertClassBrand(_PaginatedList_brand, this, _shouldUsePage).call(this, nextPage))) {
            _context4.n = 2;
            break;
          }
          return _context4.a(2);
        case 2:
          nextPageItemElements = _assertClassBrand(_PaginatedList_brand, this, _getGridForPage).call(this, nextPage.page);
          if (nextPageItemElements) {
            _context4.n = 4;
            break;
          }
          promise = new Promise(function (res) {
            _classPrivateFieldSet(_resolveNextPagePromise, _this4, res);
        ...
        case 3:
          ...
          return _context4.a(2);
        case 4:
          grid.append.apply(grid, _toConsumableArray(nextPageItemElements));
          _classPrivateFieldGet(_aspectRatioHelper, this).processNewElements();
          history.pushState('', '', nextPage.url.toString());
          (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_2__.requestIdleCallback)(function () {
            _assertClassBrand(_PaginatedList_brand, _this4, _fetchPage).call(_this4, 'next');
          });
        case 5:
          return _context4.a(2);
      }
...
function _renderPreviousPage() {
  return _renderPreviousPage2.apply(this, arguments);
}
function _renderPreviousPage2() {
  _renderPreviousPage2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
    var _this5 = this;
    var grid, previousPage, previousPageItemElements, promise, scrollTop, firstElement, oldHeight, newHeight, heightDiff;
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.n) {
        ...
        case 1:
          previousPage = _assertClassBrand(_PaginatedList_brand, this, _getPage).call(this, 'previous');
          if (!(!previousPage || !_assertClassBrand(_PaginatedList_brand, this, _shouldUsePage).call(this, previousPage))) {
            _context5.n = 2;
            break;
          }
          return _context5.a(2);
        case 2:
          previousPageItemElements = _assertClassBrand(_PaginatedList_brand, this, _getGridForPage).call(this, previousPage.page);
          if (previousPageItemElements) {
            _context5.n = 4;
            break;
          }
          promise = new Promise(function (res) {
            _classPrivateFieldSet(_resolvePreviousPagePromise, _this5, res);
          }); // Trigger the fetch for this page
          _assertClassBrand(_PaginatedList_brand, this, _fetchPage).call(this, 'previous');
          _context5.n = 3;
          return promise;
        ...
        case 4:
          ...
          oldHeight = firstElement ? firstElement.getBoundingClientRect().top + window.scrollY : 0; // Prepend the new elements
          grid.prepend.apply(grid, _toConsumableArray(previousPageItemElements));
          _classPrivateFieldGet(_aspectRatioHelper, this).processNewElements();
          history.pushState('', '', previousPage.url.toString());

          // Calculate and adjust scroll position to maintain the same view
          if (firstElement) {
            newHeight = firstElement.getBoundingClientRect().top + window.scrollY;
          ...
          (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_2__.requestIdleCallback)(function () {
            _assertClassBrand(_PaginatedList_brand, _this5, _fetchPage).call(_this5, 'previous');
          });
        case 5:
          return _context5.a(2);
      }
 ...
 */
function _getPage(type) {
  var cards = this.refs.cards;
  var isPrevious = type === 'previous';
  if (!Array.isArray(cards)) return;
  var targetCard = cards[isPrevious ? 0 : cards.length - 1];
  if (!targetCard) return;
  var currentCardPage = Number(targetCard.dataset.page);
  var page = isPrevious ? currentCardPage - 1 : currentCardPage + 1;
 ...
 */
function _getGridForPage(page) {
  var pageHTML = this.pages.get(page);
  if (!pageHTML) return;
  var parsedPage = new DOMParser().parseFromString(pageHTML, 'text/html');
  var gridElement = parsedPage.querySelector('[ref="grid"]');
...
/* harmony import */ var _theme_paginated_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @theme/paginated-list */ "./src/scripts/paginated-list.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i.return) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } r ? i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n : (o("next", 0), o("throw", 1), o("return", 2)); }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
 ...
 */
var _animateLayoutChange = /*#__PURE__*/new WeakMap();
var _ResultsList_brand = /*#__PURE__*/new WeakSet();
var _handleMediaQueryChange = /*#__PURE__*/new WeakMap();
var ResultsList = /*#__PURE__*/function (_PaginatedList) {
  function ResultsList() {
    ...
    _this = _callSuper(this, ResultsList, [].concat(args));
    /**
     * Animates the layout change.
     *
     * @param {string} value
     */
    _classPrivateMethodInitSpec(_this, _ResultsList_brand);
    /**
     * Sets the layout.
     *
     * @param {string} value
     */
    _classPrivateFieldInitSpec(_this, _animateLayoutChange, /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(value) {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 1:
              _context.n = 2;
              return (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_0__.startViewTransition)(function () {
                return _assertClassBrand(_ResultsList_brand, _this, _setLayout).call(_this, value);
              }, ['product-grid']);
            case 2:
              (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_0__.requestIdleCallback)(function () {
                var viewport = _theme_utilities__WEBPACK_IMPORTED_MODULE_0__.mediaQueryLarge.matches ? 'desktop' : 'mobile';
                sessionStorage.setItem("product-grid-view-".concat(viewport), value);
              });
            case 3:
              return _context.a(2);
          }
     ...
     */
    _classPrivateFieldInitSpec(_this, _handleMediaQueryChange, function (event) {
      var targetElement = event.matches ? _this.querySelector('[data-grid-layout="desktop-default-option"]') : _this.querySelector('[data-grid-layout="mobile-option"]');
      if (!(targetElement instanceof HTMLInputElement)) return;
      targetElement.checked = true;
      _assertClassBrand(_ResultsList_brand, _this, _setLayout).call(_this, 'default');
    });
    return _this;
  }
  _inherits(ResultsList, _PaginatedList);
  return _createClass(ResultsList, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(ResultsList, "connectedCallback", this, 3)([]);
      _theme_utilities__WEBPACK_IMPORTED_MODULE_0__.mediaQueryLarge.addEventListener('change', _classPrivateFieldGet(_handleMediaQueryChange, this));
      this.setAttribute('initialized', '');
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _theme_utilities__WEBPACK_IMPORTED_MODULE_0__.mediaQueryLarge.removeEventListener('change', _classPrivateFieldGet(_handleMediaQueryChange, this));
    }
    ...
    key: "updateLayout",
    value: function updateLayout(_ref2) {
      var target = _ref2.target;
      if (!(target instanceof HTMLInputElement)) return;
      _classPrivateFieldGet(_animateLayoutChange, this).call(this, target.value);
    }
  }]);
}(_theme_paginated_list__WEBPACK_IMPORTED_MODULE_1__["default"]);
