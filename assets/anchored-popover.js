...
(() => {
/*!*****************************************!*\
  !*** ./src/scripts/anchored-popover.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AnchoredPopoverComponent: () => (/* binding */ AnchoredPopoverComponent)
/* harmony export */ });
 ...
 */
var _popoverTrigger = /*#__PURE__*/new WeakMap();
var _onTriggerEnter = /*#__PURE__*/new WeakMap();
var _onTriggerLeave = /*#__PURE__*/new WeakMap();
var _onPopoverEnter = /*#__PURE__*/new WeakMap();
var _onPopoverLeave = /*#__PURE__*/new WeakMap();
var _updatePosition = /*#__PURE__*/new WeakMap();
var _resizeListener = /*#__PURE__*/new WeakMap();
var AnchoredPopoverComponent = /*#__PURE__*/function (_Component) {
  function AnchoredPopoverComponent() {
    var _this;
    _classCallCheck(this, AnchoredPopoverComponent);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, AnchoredPopoverComponent, [].concat(args));
    _defineProperty(_this, "requiredRefs", ['popover', 'trigger']);
    _defineProperty(_this, "interaction_delay", 200);
    _classPrivateFieldInitSpec(_this, _popoverTrigger, /** @type {number | null} */null);
    _classPrivateFieldInitSpec(_this, _onTriggerEnter, function () {
      var _this$refs = _this.refs,
        trigger = _this$refs.trigger,
        popover = _this$refs.popover;
      trigger.dataset.hoverActive = 'true';
      if (!popover.matches(':popover-open')) {
        _classPrivateFieldSet(_popoverTrigger, _this, setTimeout(function () {
          if (trigger.matches('[data-hover-active]')) popover.showPopover();
        }, _this.interaction_delay));
      }
    });
    _classPrivateFieldInitSpec(_this, _onTriggerLeave, function () {
      var _this$refs2 = _this.refs,
        trigger = _this$refs2.trigger,
        popover = _this$refs2.popover;
      delete trigger.dataset.hoverActive;
      if (_classPrivateFieldGet(_popoverTrigger, _this)) clearTimeout(_classPrivateFieldGet(_popoverTrigger, _this));
      if (popover.matches(':popover-open')) {
        _classPrivateFieldSet(_popoverTrigger, _this, setTimeout(function () {
          popover.hidePopover();
        }, _this.interaction_delay));
    ...
    _classPrivateFieldInitSpec(_this, _onPopoverEnter, function () {
      if (_classPrivateFieldGet(_popoverTrigger, _this)) clearTimeout(_classPrivateFieldGet(_popoverTrigger, _this));
    });
    _classPrivateFieldInitSpec(_this, _onPopoverLeave, function () {
    ...
    _classPrivateFieldInitSpec(_this, _updatePosition, /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      var _this$refs3, popover, trigger, positions;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            _this$refs3 = _this.refs, popover = _this$refs3.popover, trigger = _this$refs3.trigger;
            if (!(!popover || !trigger)) {
              _context.n = 1;
              break;
            }
            return _context.a(2);
          case 1:
            positions = trigger.getBoundingClientRect();
            popover.style.setProperty('--anchor-top', "".concat(positions.top));
            popover.style.setProperty('--anchor-right', "".concat(window.innerWidth - positions.right));
            popover.style.setProperty('--anchor-bottom', "".concat(window.innerHeight - positions.bottom));
            popover.style.setProperty('--anchor-left', "".concat(positions.left));
            popover.style.setProperty('--anchor-height', "".concat(positions.height));
            popover.style.setProperty('--anchor-width', "".concat(positions.width));
          case 2:
            return _context.a(2);
        }
      }, _callee);
     ...
     */
    _classPrivateFieldInitSpec(_this, _resizeListener, (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.debounce)(function () {
      var popover = /** @type {HTMLElement} */_this.refs.popover;
  ...
  _inherits(AnchoredPopoverComponent, _Component);
  return _createClass(AnchoredPopoverComponent, [{
    key: "connectedCallback",
    value:
    /**
    ...
    function connectedCallback() {
      var _this2 = this;
      _superPropGet(AnchoredPopoverComponent, "connectedCallback", this, 3)([]);
      var _this$refs4 = this.refs,
        popover = _this$refs4.popover,
        trigger = _this$refs4.trigger;
      if (this.dataset.closeOnResize) {
        popover.addEventListener('beforetoggle', function (event) {
          var evt = /** @type {ToggleEvent} */event;
          window[evt.newState === 'open' ? 'addEventListener' : 'removeEventListener']('resize', _classPrivateFieldGet(_resizeListener, _this2));
        });
      }
      if (this.dataset.hoverTriggered) {
        trigger.addEventListener('pointerenter', _classPrivateFieldGet(_onTriggerEnter, this));
        trigger.addEventListener('pointerleave', _classPrivateFieldGet(_onTriggerLeave, this));
        popover.addEventListener('pointerenter', _classPrivateFieldGet(_onPopoverEnter, this));
        popover.addEventListener('pointerleave', _classPrivateFieldGet(_onPopoverLeave, this));
      }
    ...
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(AnchoredPopoverComponent, "disconnectedCallback", this, 3)([]);
