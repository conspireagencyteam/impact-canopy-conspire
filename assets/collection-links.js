...
(() => {
/*!*****************************************!*\
  !*** ./src/scripts/collection-links.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _theme_scrolling__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @theme/scrolling */ "./src/scripts/scrolling.js");
/* harmony import */ var _theme_focus__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @theme/focus */ "./src/scripts/focus.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _slicedToArray(r, e) { return _arrayWithHoles(r) || _iterableToArrayLimit(r, e) || _unsupportedIterableToArray(r, e) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t.return && (u = t.return(), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
...
var _CollectionLinks_brand = /*#__PURE__*/new WeakSet();
var _handleSlideshowSelect = /*#__PURE__*/new WeakMap();
var _handleScroll = /*#__PURE__*/new WeakMap();
var CollectionLinks = /*#__PURE__*/function (_Component) {
  function CollectionLinks() {
    ...
    _this = _callSuper(this, CollectionLinks, [].concat(args));
    /**
     * Update the selected link
     *
     * @param {number} index
     */
    _classPrivateMethodInitSpec(_this, _CollectionLinks_brand);
    _defineProperty(_this, "requiredRefs", ['container']);
    /** @type {Scroller} */
     ...
     */
    _classPrivateFieldInitSpec(_this, _handleSlideshowSelect, /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(event) {
        var index, selectedLink;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
            ...
            case 1:
              ...
              return _context.a(2);
            case 2:
              selectedLink = _this.links[index];
              if (selectedLink) {
                _context.n = 3;
                break;
              }
              return _context.a(2);
            case 3:
              _assertClassBrand(_CollectionLinks_brand, _this, _updateSelectedLink).call(_this, index);
              _classPrivateFieldGet(_scroll, _this).to(selectedLink);
            case 4:
              return _context.a(2);
          }
        }, _callee);
    ...
    _classPrivateFieldInitSpec(_this, _handleScroll, function () {
      ...
      var visibleLinks = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.getVisibleElements)(_this, links, 0.1);
      if (visibleLinks.length === 0) return;
      var centers = visibleLinks.map(function (link) {
        return (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.center)(link, 'x');
      });
      var referencePoint = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.center)(container, 'x');
      var closestCenter = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.closest)(centers, referencePoint);
      var closestVisibleLink = visibleLinks[centers.indexOf(closestCenter)];
      if (!closestVisibleLink) return;
      var index = links.indexOf(closestVisibleLink);
      _this.select(index);
    });
    return _this;
  }
  _inherits(CollectionLinks, _Component);
  return _createClass(CollectionLinks, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(CollectionLinks, "connectedCallback", this, 3)([]);
      this.addEventListener('keydown', _assertClassBrand(_CollectionLinks_brand, this, _handleKeydown));
      this.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_2__.SlideshowSelectEvent.eventName, _classPrivateFieldGet(_handleSlideshowSelect, this));
      _classPrivateFieldSet(_scroll, this, new _theme_scrolling__WEBPACK_IMPORTED_MODULE_3__.Scroller(this.refs.container, {
    ...
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(CollectionLinks, "disconnectedCallback", this, 3)([]);
    ...
    key: "select",
    value: function select(targetIndex, event) {
      var _this$refs$slideshow;
      _assertClassBrand(_CollectionLinks_brand, this, _updateSelectedLink).call(this, targetIndex);
      (_this$refs$slideshow = this.refs.slideshow) === null || _this$refs$slideshow === void 0 || _this$refs$slideshow.select(targetIndex, undefined, {
        animate: false
      });
      if (event) _assertClassBrand(_CollectionLinks_brand, this, _revealImage).call(this, event);
    }
  }]);
}(_theme_component__WEBPACK_IMPORTED_MODULE_0__.Component);
function _updateSelectedLink(index) {
  var links = this.links;
  var selectedIndex = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.clamp)(index, 0, links.length - 1);
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var _step$value = _slicedToArray(_step.value, 2),
        ...
        link = _step$value[1];
      link.setAttribute('aria-current', Boolean(_index === selectedIndex).toString());
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
function _handleKeydown(event) {
  ...
  if (!modifier) return;
  event.preventDefault();
  (0,_theme_focus__WEBPACK_IMPORTED_MODULE_4__.cycleFocus)(this.links, modifier);
}
/**
 * Reveal an image
 *
 * @param {Event} event
 */
function _revealImage(event) {
  if (!(event instanceof PointerEvent)) return;
  if (event.pointerType === 'touch') return;
  var target = event.target;
  if (!(target instanceof HTMLElement)) return;
  var images = this.refs.images;
  var index = this.links.indexOf(target);
  var selectedImage = images === null || images === void 0 ? void 0 : images[index];
  if (!selectedImage) return;

  /** @param {PointerEvent} event */
  var updateImagePosition = function updateImagePosition(event) {
    var imageHeight = selectedImage.offsetHeight;
    var imageWidth = selectedImage.offsetWidth;
    var viewportHeight = window.innerHeight;
    var viewportWidth = window.innerWidth;
    var offset = 15;
    var wouldBeCutOff = event.clientY + imageHeight + offset > viewportHeight;
    var yPos = wouldBeCutOff ? event.clientY - imageHeight - offset : event.clientY + offset;
    var xPos = Math.min(Math.max(offset, event.clientX + offset), viewportWidth - imageWidth - offset);
    selectedImage.style.setProperty('--x', "".concat(xPos, "px"));
    selectedImage.style.setProperty('--y', "".concat(yPos, "px"));
  };
