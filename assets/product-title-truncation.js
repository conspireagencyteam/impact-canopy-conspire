...
(() => {
/*!*************************************************!*\
  !*** ./src/scripts/product-title-truncation.js ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
 ...
 */
var _ProductTitle_brand = /*#__PURE__*/new WeakSet();
var ProductTitle = /*#__PURE__*/function (_Component) {
  function ProductTitle() {
    var _this;
    _classCallCheck(this, ProductTitle);
    _this = _callSuper(this, ProductTitle);
    /**
     * Initialize the title truncation
     */
    _classPrivateMethodInitSpec(_this, _ProductTitle_brand);
    return _this;
  }
  _inherits(ProductTitle, _Component);
  return _createClass(ProductTitle, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(ProductTitle, "connectedCallback", this, 3)([]);
      _assertClassBrand(_ProductTitle_brand, this, _initializeTruncation).call(this);
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(ProductTitle, "disconnectedCallback", this, 3)([]);
      if (this.resizeObserver) {
        this.resizeObserver.disconnect();
      }
      window.removeEventListener('resize', _assertClassBrand(_ProductTitle_brand, this, _handleResize));
    }
  }]);
}(_theme_component__WEBPACK_IMPORTED_MODULE_0__.Component);
function _initializeTruncation() {
  var _this2 = this;
  if ('ResizeObserver' in window) {
    this.resizeObserver = new ResizeObserver(function () {
      _assertClassBrand(_ProductTitle_brand, _this2, _calculateTruncation).call(_this2);
    });
    this.resizeObserver.observe(this);
    _assertClassBrand(_ProductTitle_brand, this, _calculateTruncation).call(this);
  } else {
    /** @type {Window} */
    window.addEventListener('resize', _assertClassBrand(_ProductTitle_brand, this, _handleResize).bind(this));
    _assertClassBrand(_ProductTitle_brand, this, _calculateTruncation).call(this);
  }
}
/**
 ...
 */
function _calculateTruncation() {
  /** @type {HTMLElement} */
  var textElement = this.refs.text || this.querySelector('.title-text') || this;
