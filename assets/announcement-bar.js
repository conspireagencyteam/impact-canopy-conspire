...
(() => {
/*!*****************************************!*\
  !*** ./src/scripts/announcement-bar.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AnnouncementBar: () => (/* binding */ AnnouncementBar)
/* harmony export */ });
...
var AnnouncementBar = /*#__PURE__*/function (_Component) {
  function AnnouncementBar() {
    ...
    _this = _callSuper(this, AnnouncementBar, [].concat(args));
  ...
  return _createClass(AnnouncementBar, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(AnnouncementBar, "connectedCallback", this, 3)([]);
    ...
    value: function play() {
      ...
      _classPrivateFieldSet(_interval, this, setInterval(function () {
        if (_this2.matches(':hover') || document.hidden) return;
        _this2.next();
      }, interval));
    }
    ...
    set: function set(current) {
      var _this$refs$slides, _this$refs$slides3;
      _classPrivateFieldSet(_current, this, current);
      var relativeIndex = current % ((_this$refs$slides = this.refs.slides) !== null && _this$refs$slides !== void 0 ? _this$refs$slides : []).length;
      if (relativeIndex < 0) {
        var _this$refs$slides2;
        relativeIndex += ((_this$refs$slides2 = this.refs.slides) !== null && _this$refs$slides2 !== void 0 ? _this$refs$slides2 : []).length;
      }
      (_this$refs$slides3 = this.refs.slides) === null || _this$refs$slides3 === void 0 || _this$refs$slides3.forEach(function (slide, index) {
        slide.setAttribute('aria-hidden', "".concat(index !== relativeIndex));
      });
    }
  }]);
