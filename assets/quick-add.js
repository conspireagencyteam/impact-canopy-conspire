...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ VariantPicker)
/* harmony export */ });
/* harmony import */ var _theme_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @theme/component */ "./src/scripts/component.js");
/* harmony import */ var _theme_events__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @theme/events */ "./src/scripts/events.js");
/* harmony import */ var _theme_morph__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @theme/morph */ "./src/scripts/morph.js");
 ...
 */
var _pendingRequestUrl = /*#__PURE__*/new WeakMap();
var _abortController = /*#__PURE__*/new WeakMap();
var _checkedIndices = /*#__PURE__*/new WeakMap();
var _radios = /*#__PURE__*/new WeakMap();
var VariantPicker = /*#__PURE__*/function (_Component) {
  function VariantPicker() {
    ...
    _this = _callSuper(this, VariantPicker, [].concat(args));
    /** @type {string | undefined} */
    _classPrivateFieldInitSpec(_this, _pendingRequestUrl, void 0);
    /** @type {AbortController | undefined} */
    _classPrivateFieldInitSpec(_this, _abortController, void 0);
    /** @type {number[][]} */
    _classPrivateFieldInitSpec(_this, _checkedIndices, []);
    /** @type {HTMLInputElement[][]} */
    _classPrivateFieldInitSpec(_this, _radios, []);
    return _this;
  }
  ...
  return _createClass(VariantPicker, [{
    ...
    value: function connectedCallback() {
      var _this2 = this;
      _superPropGet(VariantPicker, "connectedCallback", this, 3)([]);
      var fieldsets = /** @type {HTMLFieldSetElement[]} */this.refs.fieldsets || [];
      fieldsets.forEach(function (fieldset) {
        var _fieldset$querySelect;
        var radios = Array.from((_fieldset$querySelect = fieldset === null || fieldset === void 0 ? void 0 : fieldset.querySelectorAll('input')) !== null && _fieldset$querySelect !== void 0 ? _fieldset$querySelect : []);
        _classPrivateFieldGet(_radios, _this2).push(radios);
        var initialCheckedIndex = radios.findIndex(function (radio) {
          return radio.dataset.currentChecked === 'true';
        });
        if (initialCheckedIndex !== -1) {
          _classPrivateFieldGet(_checkedIndices, _this2).push([initialCheckedIndex]);
        }
      });
    ...
    key: "variantChanged",
    value: function variantChanged(event) {
      var _selectedOption$datas, _this$dataset$product;
      if (!(event.target instanceof HTMLElement)) return;
      var selectedOption = event.target instanceof HTMLSelectElement ? event.target.options[event.target.selectedIndex] : event.target;
      if (!selectedOption) return;
      this.updateSelectedOption(event.target);
      this.dispatchEvent(new _theme_events__WEBPACK_IMPORTED_MODULE_1__.VariantSelectedEvent({
        id: (_selectedOption$datas = selectedOption.dataset.optionValueId) !== null && _selectedOption$datas !== void 0 ? _selectedOption$datas : ''
      }));
      var isOnProductPage = this.dataset.templateProductMatch === 'true' && !event.target.closest('product-card') && !event.target.closest('quick-add-dialog');
      ...
      var currentUrl = (_this$dataset$product = this.dataset.productUrl) === null || _this$dataset$product === void 0 ? void 0 : _this$dataset$product.split('?')[0];
      var newUrl = selectedOption.dataset.connectedProductUrl;
      var loadsNewProduct = isOnProductPage && !!newUrl && newUrl !== currentUrl;
      this.fetchUpdatedSection(this.buildRequestUrl(selectedOption), loadsNewProduct);
      var url = new URL(window.location.href);
      var variantId = selectedOption.dataset.variantId || null;
      if (isOnProductPage) {
        if (variantId) {
      ...
      if (url.href !== window.location.href) {
        (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_3__.requestYieldCallback)(function () {
    ...
    value: function updateSelectedOption(target) {
      if (typeof target === 'string') {
        var targetElement = this.querySelector("[data-option-value-id=\"".concat(target, "\"]"));
        if (!targetElement) throw new Error('Target element not found');
        target = targetElement;
      }
      if (target instanceof HTMLInputElement) {
        var fieldsetIndex = Number.parseInt(target.dataset.fieldsetIndex || '');
        var inputIndex = Number.parseInt(target.dataset.inputIndex || '');
        if (!Number.isNaN(fieldsetIndex) && !Number.isNaN(inputIndex)) {
          var fieldsets = /** @type {HTMLFieldSetElement[]} */this.refs.fieldsets || [];
          var fieldset = fieldsets[fieldsetIndex];
          var checkedIndices = _classPrivateFieldGet(_checkedIndices, this)[fieldsetIndex];
          var radios = _classPrivateFieldGet(_radios, this)[fieldsetIndex];
          if (radios && checkedIndices && fieldset) {
            // Clear previous checked states
            var _checkedIndices2 = _slicedToArray(checkedIndices, 2),
              currentIndex = _checkedIndices2[0],
              previousIndex = _checkedIndices2[1];
            ...
            var newCurrentIndex = checkedIndices[0]; // This is always inputIndex
            var newPreviousIndex = checkedIndices[1]; // This might be undefined
            ...
            if (newCurrentIndex !== undefined && radios[newCurrentIndex]) {
              ...
              fieldset.style.setProperty('--pill-width-current', "".concat(((_radios$newCurrentInd = radios[newCurrentIndex].parentElement) === null || _radios$newCurrentInd === void 0 ? void 0 : _radios$newCurrentInd.offsetWidth) || 0, "px"));
            }
            if (newPreviousIndex !== undefined && radios[newPreviousIndex]) {
              ...
              fieldset.style.setProperty('--pill-width-previous', "".concat(((_radios$newPreviousIn = radios[newPreviousIndex].parentElement) === null || _radios$newPreviousIn === void 0 ? void 0 : _radios$newPreviousIn.offsetWidth) || 0, "px"));
            }
          }
        }
        target.checked = true;
      ...
      if (target instanceof HTMLSelectElement) {
        ...
        var newSelectedOption = Array.from(target.options).find(function (option) {
          return option.value === newValue;
        });
        if (!newSelectedOption) throw new Error('Option not found');
        var _iterator = _createForOfIteratorHelper(target.options),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
    ...
    key: "buildRequestUrl",
    value: function buildRequestUrl(selectedOption) {
      var source = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var sourceSelectedOptionsValues = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
      ...
      var productUrl = selectedOption.dataset.connectedProductUrl || _classPrivateFieldGet(_pendingRequestUrl, this) || this.dataset.productUrl;
      _classPrivateFieldSet(_pendingRequestUrl, this, productUrl);
      var params = [];
      var viewParamValue = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_3__.getViewParameterValue)();

      // preserve view parameter, if it exists, for alternative product view testing
      if (viewParamValue) params.push("view=".concat(viewParamValue));
      if (this.selectedOptionsValues.length && !source) {
        params.push("option_values=".concat(this.selectedOptionsValues.join(',')));
      } else if (source === 'product-card') {
        if (this.selectedOptionsValues.length) {
          params.push("option_values=".concat(sourceSelectedOptionsValues.join(',')));
        } else {
          params.push("option_values=".concat(selectedOption.dataset.optionValueId));
        }
      }
      ...
      if (this.closest('quick-add-component') || this.closest('swatches-variant-picker-component')) {
        var _productUrl;
        if ((_productUrl = productUrl) !== null && _productUrl !== void 0 && _productUrl.includes('?')) {
          productUrl = productUrl.split('?')[0];
        }
        return "".concat(productUrl, "?section_id=section-rendering-product-card&").concat(params.join('&'));
      }
      return "".concat(productUrl, "?").concat(params.join('&'));
    }
    ...
    key: "fetchUpdatedSection",
    value: function fetchUpdatedSection(requestUrl) {
      var _classPrivateFieldGet2,
        _this3 = this;
      var shouldMorphMain = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      // We use this to abort the previous fetch request if it's still pending.
      (_classPrivateFieldGet2 = _classPrivateFieldGet(_abortController, this)) === null || _classPrivateFieldGet2 === void 0 || _classPrivateFieldGet2.abort();
      _classPrivateFieldSet(_abortController, this, new AbortController());
      fetch(requestUrl, {
        signal: _classPrivateFieldGet(_abortController, this).signal
      }).then(function (response) {
        return response.text();
      }).then(function (responseText) {
        var _html$querySelector, _html$querySelector2;
        _classPrivateFieldSet(_pendingRequestUrl, _this3, undefined);
        var html = new DOMParser().parseFromString(responseText, 'text/html');
        // Defer is only useful for the initial rendering of the page. Remove it here.
        (_html$querySelector = html.querySelector('overflow-list[defer]')) === null || _html$querySelector === void 0 || _html$querySelector.removeAttribute('defer');
        var textContent = (_html$querySelector2 = html.querySelector("variant-picker script[type=\"application/json\"]")) === null || _html$querySelector2 === void 0 ? void 0 : _html$querySelector2.textContent;
        if (!textContent) return;
        if (shouldMorphMain) {
          _this3.updateMain(html);
        } else {
          var newProduct = _this3.updateVariantPicker(html);

          // We grab the variant object from the response and dispatch an event with it.
          if (_this3.selectedOptionId) {
            var _this3$dataset$produc;
            _this3.dispatchEvent(new _theme_events__WEBPACK_IMPORTED_MODULE_1__.VariantUpdateEvent(JSON.parse(textContent), _this3.selectedOptionId, {
              html: html,
              productId: (_this3$dataset$produc = _this3.dataset.productId) !== null && _this3$dataset$produc !== void 0 ? _this3$dataset$produc : '',
    ...
    key: "updateVariantPicker",
    value: function updateVariantPicker(newHtml) {
      /** @type {NewProduct | undefined} */
      var newProduct;
      var newVariantPickerSource = newHtml.querySelector(this.tagName.toLowerCase());
      ...
      if (newVariantPickerSource instanceof HTMLElement) {
        var newProductId = newVariantPickerSource.dataset.productId;
        var newProductUrl = newVariantPickerSource.dataset.productUrl;
      ...
      (0,_theme_morph__WEBPACK_IMPORTED_MODULE_2__.morph)(this, newVariantPickerSource);
      return newProduct;
    }
    ...
    key: "updateMain",
    value: function updateMain(newHtml) {
      var main = document.querySelector('main');
      var newMain = newHtml.querySelector('main');
      if (!main || !newMain) {
        throw new Error('No new main source found');
      }
      (0,_theme_morph__WEBPACK_IMPORTED_MODULE_2__.morph)(main, newMain);
    }
    ...
    key: "selectedOption",
    get: function get() {
      var selectedOption = this.querySelector('select option[selected], fieldset input:checked');
    ...
    get: function get() {
      ...
      var optionValueId = selectedOption.dataset.optionValueId;
      if (!optionValueId) {
    ...
    get: function get() {
      /** @type HTMLElement[] */
      var selectedOptions = Array.from(this.querySelectorAll('select option[selected], fieldset input:checked'));
      return selectedOptions.map(function (option) {
        var optionValueId = option.dataset.optionValueId;
...
(() => {
/*!**********************************!*\
  !*** ./src/scripts/quick-add.js ***!
  \**********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   QuickAddComponent: () => (/* binding */ QuickAddComponent)
/* harmony export */ });
...
/* harmony import */ var _theme_dialog__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @theme/dialog */ "./src/scripts/dialog.js");
/* harmony import */ var _theme_utilities__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @theme/utilities */ "./src/scripts/utilities.js");
/* harmony import */ var _theme_variant_picker__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @theme/variant-picker */ "./src/scripts/variant-picker.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t.return || t.return(); } finally { if (u) throw o; } } }; }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
...
var _abortController = /*#__PURE__*/new WeakMap();
var _cachedContent = /*#__PURE__*/new WeakMap();
var _cartUpdateAbortController = /*#__PURE__*/new WeakMap();
var _QuickAddComponent_brand = /*#__PURE__*/new WeakSet();
var _handleCartUpdate = /*#__PURE__*/new WeakMap();
var _openQuickAddModal = /*#__PURE__*/new WeakMap();
var _closeQuickAddModal = /*#__PURE__*/new WeakMap();
var QuickAddComponent = /*#__PURE__*/function (_Component) {
  function QuickAddComponent() {
    var _this;
    _classCallCheck(this, QuickAddComponent);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, QuickAddComponent, [].concat(args));
    /**
     * Gets the currently selected variant ID from the product card
     * @returns {string | null} The variant ID or null
     */
    _classPrivateMethodInitSpec(_this, _QuickAddComponent_brand);
    /** @type {AbortController | null} */
    _classPrivateFieldInitSpec(_this, _abortController, null);
    /** @type {Map<string, Element>} */
    _classPrivateFieldInitSpec(_this, _cachedContent, new Map());
    /** @type {AbortController} */
    _classPrivateFieldInitSpec(_this, _cartUpdateAbortController, new AbortController());
    /**
     * Clears the cached content when cart is updated
     */
    _classPrivateFieldInitSpec(_this, _handleCartUpdate, function () {
      _classPrivateFieldGet(_cachedContent, _this).clear();
    });
    /**
    ...
    _defineProperty(_this, "handleClick", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(event) {
        var currentUrl, productGrid, html, gridElement, freshContent;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              event.preventDefault();
              currentUrl = _this.productPageUrl; // Check if we have cached content for this URL
              productGrid = _classPrivateFieldGet(_cachedContent, _this).get(currentUrl);
              if (productGrid) {
                _context.n = 2;
                break;
              }
              _context.n = 1;
              return _this.fetchProductPage(currentUrl);
            case 1:
              html = _context.v;
              if (html) {
                gridElement = html.querySelector('[data-product-grid-content]');
                if (gridElement) {
                  // Cache the cloned element to avoid modifying the original
                  productGrid = /** @type {Element} */gridElement.cloneNode(true);
                  _classPrivateFieldGet(_cachedContent, _this).set(currentUrl, productGrid);
                }
              }
            case 2:
              if (!productGrid) {
              ...
              freshContent = /** @type {Element} */productGrid.cloneNode(true);
              _context.n = 3;
              return _this.updateQuickAddModal(freshContent);
            case 3:
              _assertClassBrand(_QuickAddComponent_brand, _this, _updateVariantPicker).call(_this, productGrid);
            case 4:
              _classPrivateFieldGet(_openQuickAddModal, _this).call(_this);
            case 5:
              return _context.a(2);
          }
        }, _callee);
    ...
    _classPrivateFieldInitSpec(_this, _openQuickAddModal, function () {
      var dialogComponent = document.getElementById('quick-add-dialog');
      if (!(dialogComponent instanceof QuickAddDialog)) {
        return;
      }
      _assertClassBrand(_QuickAddComponent_brand, _this, _stayVisibleUntilDialogCloses).call(_this, dialogComponent);
      dialogComponent.showDialog();
    });
    _classPrivateFieldInitSpec(_this, _closeQuickAddModal, function () {
      var dialogComponent = document.getElementById('quick-add-dialog');
  ...
  _inherits(QuickAddComponent, _Component);
  return _createClass(QuickAddComponent, [{
    key: "productPageUrl",
    get: function get() {
      var productCard = /** @type {import('./product-card').ProductCard | null} */this.closest('product-card');
      var productLink = productCard === null || productCard === void 0 ? void 0 : productCard.getProductCardLink();
      if (!(productLink !== null && productLink !== void 0 && productLink.href)) return '';
      var url = new URL(productLink.href);
      if (url.searchParams.has('variant')) {
        return url.toString();
      }
      var selectedVariantId = _assertClassBrand(_QuickAddComponent_brand, this, _getSelectedVariantId).call(this);
    ...
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(QuickAddComponent, "connectedCallback", this, 3)([]);
      _theme_utilities__WEBPACK_IMPORTED_MODULE_4__.mediaQueryLarge.addEventListener('change', _classPrivateFieldGet(_closeQuickAddModal, this));
      document.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_2__.ThemeEvents.cartUpdate, _classPrivateFieldGet(_handleCartUpdate, this), {
        signal: _classPrivateFieldGet(_cartUpdateAbortController, this).signal
      });
      document.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_2__.ThemeEvents.variantSelected, _assertClassBrand(_QuickAddComponent_brand, this, _updateQuickAddButtonState).bind(this));
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      var _classPrivateFieldGet2;
      _superPropGet(QuickAddComponent, "disconnectedCallback", this, 3)([]);
      _theme_utilities__WEBPACK_IMPORTED_MODULE_4__.mediaQueryLarge.removeEventListener('change', _classPrivateFieldGet(_closeQuickAddModal, this));
      (_classPrivateFieldGet2 = _classPrivateFieldGet(_abortController, this)) === null || _classPrivateFieldGet2 === void 0 || _classPrivateFieldGet2.abort();
      _classPrivateFieldGet(_cartUpdateAbortController, this).abort();
      document.removeEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_2__.ThemeEvents.variantSelected, _assertClassBrand(_QuickAddComponent_brand, this, _updateQuickAddButtonState).bind(this));
    }
  }, {
    key: "fetchProductPage",
    value: (
    /**
     ...
     */
    function () {
      var _fetchProductPage = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(productPageUrl) {
        var _classPrivateFieldGet3;
        var response, responseText, html, _t;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              if (productPageUrl) {
            ...
            case 1:
              // We use this to abort the previous fetch request if it's still pending.
              (_classPrivateFieldGet3 = _classPrivateFieldGet(_abortController, this)) === null || _classPrivateFieldGet3 === void 0 || _classPrivateFieldGet3.abort();
              _classPrivateFieldSet(_abortController, this, new AbortController());
              _context2.p = 2;
              _context2.n = 3;
              return fetch(productPageUrl, {
                signal: _classPrivateFieldGet(_abortController, this).signal
              });
            case 3:
              ...
              throw new Error("Failed to fetch product page: HTTP error ".concat(response.status));
            case 4:
              _context2.n = 5;
              return response.text();
            case 5:
            ...
            case 8:
              _context2.p = 8;
              _classPrivateFieldSet(_abortController, this, null);
              return _context2.f(8);
            case 9:
              return _context2.a(2);
          }
        }, _callee2, this, [[2, 6, 8, 9]]);
      }));
      function fetchProductPage(_x2) {
        return _fetchProductPage.apply(this, arguments);
      }
    ...
    key: "updateQuickAddModal",
    value: (function () {
      var _updateQuickAddModal = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(productGrid) {
        var modalContent, zoomDialog, standaloneDialogs, conflictingRefs, productDetails, productFormComponent, variantPicker, productPrice, productTitle, productHeader, closeButton;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              modalContent = document.getElementById('quick-add-modal-content');
              ...
              return _context3.a(2);
            case 1:
              // Remove zoom-dialog to prevent it from auto-opening
              zoomDialog = productGrid.querySelector('zoom-dialog');
              if (zoomDialog) {
                zoomDialog.remove();
              }

              // Remove any standalone dialog elements that might auto-open
              standaloneDialogs = productGrid.querySelectorAll('dialog[open]');
              standaloneDialogs.forEach(function (dialog) {
                dialog.remove();
              });

              // Remove elements with ref names that conflict with quick-add-dialog's refs
              // This prevents the Component's refs system from picking up wrong elements after morph
              conflictingRefs = productGrid.querySelectorAll('[ref="dialog"], [ref="closeButton"]');
              conflictingRefs.forEach(function (element) {
                element.removeAttribute('ref');
              });
              if ((0,_theme_utilities__WEBPACK_IMPORTED_MODULE_4__.isMobileBreakpoint)()) {
                productDetails = productGrid.querySelector('.product-details');
                productFormComponent = productGrid.querySelector('product-form-component');
                ...
                productDetails === null || productDetails === void 0 || productDetails.remove();
              }

              // Mark close button to be preserved during morph
              closeButton = document.querySelector('#quick-add-dialog button[ref="closeButton"]');
              if (closeButton) {
                closeButton.setAttribute('data-morph-persist', '');
              }
              (0,_theme_morph__WEBPACK_IMPORTED_MODULE_0__.morph)(modalContent, productGrid);
              _assertClassBrand(_QuickAddComponent_brand, this, _syncVariantSelection).call(this, modalContent);
            case 2:
              return _context3.a(2);
          }
        }, _callee3, this);
      }));
      function updateQuickAddModal(_x3) {
        return _updateQuickAddModal.apply(this, arguments);
      }
      return updateQuickAddModal;
    }()
    /**
...
function _getSelectedVariantId() {
  var productCard = /** @type {import('./product-card').ProductCard | null} */this.closest('product-card');
  return (productCard === null || productCard === void 0 ? void 0 : productCard.getSelectedVariantId()) || null;
}
/**
 * Re-renders the variant picker in the quick-add modal.
 * @param {Element} newHtml - The element to re-render.
 */
function _updateVariantPicker(newHtml) {
  var modalContent = document.getElementById('quick-add-modal-content');
  if (!modalContent) return;
  var variantPicker = /** @type {VariantPicker} */modalContent.querySelector('variant-picker');
  if (variantPicker && typeof variantPicker.updateVariantPicker === 'function') {
    variantPicker.updateVariantPicker(newHtml);
  }
}
/** @param {QuickAddDialog} dialogComponent */
function _stayVisibleUntilDialogCloses(dialogComponent) {
  var _this5 = this;
  this.toggleAttribute('stay-visible', true);
  dialogComponent.addEventListener(_theme_dialog__WEBPACK_IMPORTED_MODULE_3__.DialogCloseEvent.eventName, function () {
    return _this5.toggleAttribute('stay-visible', false);
  }, {
    once: true
  });
}
function _updateQuickAddButtonState(event) {
  if (!(event.target instanceof HTMLElement)) return;
  if (event.target.closest('product-card') !== this.closest('product-card')) return;
  var productOptionsCount = this.dataset.productOptionsCount;
  var quickAddButton = productOptionsCount === '1' ? 'add' : 'choose';
 ...
 */
function _syncVariantSelection(modalContent) {
  var selectedVariantId = _assertClassBrand(_QuickAddComponent_brand, this, _getSelectedVariantId).call(this);
  if (!selectedVariantId) return;

  // Find and check the corresponding input in the modal
  var modalInputs = modalContent.querySelectorAll('input[type="radio"][data-variant-id]');
  var _iterator = _createForOfIteratorHelper(modalInputs),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
...
var _abortController2 = /*#__PURE__*/new WeakMap();
var _updateProductTitleLink = /*#__PURE__*/new WeakMap();
var _handleDialogClose = /*#__PURE__*/new WeakMap();
var QuickAddDialog = /*#__PURE__*/function (_DialogComponent) {
  function QuickAddDialog() {
    var _this2;
    _classCallCheck(this, QuickAddDialog);
    for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
      args[_key2] = arguments[_key2];
    }
    _this2 = _callSuper(this, QuickAddDialog, [].concat(args));
    _classPrivateFieldInitSpec(_this2, _abortController2, new AbortController());
    /**
     * Closes the dialog - override parent's arrow function with arrow function
     * @returns {Promise<void>}
     */
    _defineProperty(_this2, "closeDialog", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
      var dialog;
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.n) {
          case 0:
            // Directly query for the correct dialog element instead of using refs
            dialog = _this2.querySelector('dialog.quick-add-modal');
          ...
          case 1:
            // Close immediately without animation to prevent conflicts
            dialog.classList.remove('dialog-closing');
            ...
            _this2.dispatchEvent(new _theme_dialog__WEBPACK_IMPORTED_MODULE_3__.DialogCloseEvent());
          case 2:
            return _context4.a(2);
        }
      }, _callee4);
    ...
    /**
     * Handles cart update event and closes dialog on success
     * @param {CartUpdateEvent} event - The cart update event
     */
    _defineProperty(_this2, "handleCartUpdate", function (event) {
      if (event.detail.data.didError) return;
      _this2.closeDialog();
    });
    _classPrivateFieldInitSpec(_this2, _updateProductTitleLink, function (/** @type {CustomEvent} */event) {
      var _event$detail$data$ht;
      var anchorElement = /** @type {HTMLAnchorElement} */(_event$detail$data$ht = event.detail.data.html) === null || _event$detail$data$ht === void 0 ? void 0 : _event$detail$data$ht.querySelector('.view-product-title a');
      var viewMoreDetailsLink = /** @type {HTMLAnchorElement} */_this2.querySelector('.view-product-title a');
      var mobileProductTitle = /** @type {HTMLAnchorElement} */_this2.querySelector('.product-header a');
      if (!anchorElement) {
        return;
      }
    ...
    _classPrivateFieldInitSpec(_this2, _handleDialogClose, function () {
      var iosVersion = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_4__.getIOSVersion)();
      /**
      ...
      requestAnimationFrame(function () {
        ...
        var grid = document.querySelector('#ResultsList [product-grid-view]');
        if (grid) {
          var currentWidth = grid.getBoundingClientRect().width;
          grid.style.width = "".concat(currentWidth - 1, "px");
          requestAnimationFrame(function () {
            grid.style.width = '';
          });
        }
  ...
  _inherits(QuickAddDialog, _DialogComponent);
  return _createClass(QuickAddDialog, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      var _this$refs,
        _this3 = this;
      _superPropGet(QuickAddDialog, "connectedCallback", this, 3)([]);
      this.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_2__.ThemeEvents.cartUpdate, this.handleCartUpdate, {
        signal: _classPrivateFieldGet(_abortController2, this).signal
      });
      this.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_2__.ThemeEvents.variantUpdate, _classPrivateFieldGet(_updateProductTitleLink, this));
      this.addEventListener(_theme_dialog__WEBPACK_IMPORTED_MODULE_3__.DialogCloseEvent.eventName, _classPrivateFieldGet(_handleDialogClose, this));

      // Add manual close button listener to ensure it always works
      var closeButton = (_this$refs = this.refs) === null || _this$refs === void 0 ? void 0 : _this$refs.closeButton;
      if (closeButton) {
    ...
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(QuickAddDialog, "disconnectedCallback", this, 3)([]);
      _classPrivateFieldGet(_abortController2, this).abort();
      this.removeEventListener(_theme_dialog__WEBPACK_IMPORTED_MODULE_3__.DialogCloseEvent.eventName, _classPrivateFieldGet(_handleDialogClose, this));
    }

    /**
     * Shows the dialog - override to disable click-outside and escape key
     */
  }, {
    key: "showDialog",
    value: function showDialog() {
      var _this4 = this;
      var dialog = this.querySelector('dialog.quick-add-modal');
      ...
      requestAnimationFrame(function () {
        ...
        document.body.style.top = "-".concat(scrollY, "px");
        dialog.showModal();
        _this4.dispatchEvent(new _theme_dialog__WEBPACK_IMPORTED_MODULE_3__.DialogOpenEvent());

        // Do NOT add click or keydown listeners - we only want to close on X button or ATC
      });
    }
  }]);
}(_theme_dialog__WEBPACK_IMPORTED_MODULE_3__.DialogComponent);
