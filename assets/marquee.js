...
var _slowDown = /*#__PURE__*/new WeakMap();
var _MarqueeComponent_brand = /*#__PURE__*/new WeakSet();
var _handleResize = /*#__PURE__*/new WeakMap();
var MarqueeComponent = /*#__PURE__*/function (_Component) {
  function MarqueeComponent() {
    ...
    _this = _callSuper(this, MarqueeComponent, [].concat(args));
    _classPrivateMethodInitSpec(_this, _MarqueeComponent_brand);
    _defineProperty(_this, "requiredRefs", ['wrapper', 'content', 'marqueeItems']);
    /**
     * @type {{ cancel: () => void, current: number } | null}
     */
    _classPrivateFieldInitSpec(_this, _animation, null);
    _classPrivateFieldInitSpec(_this, _slowDown, (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.debounce)(function () {
      if (_classPrivateFieldGet(_animation, _this)) return;
      var animation = _this.refs.wrapper.getAnimations()[0];
      if (!animation) return;
      _classPrivateFieldSet(_animation, _this, animateValue(_objectSpread(_objectSpread({}, ANIMATION_OPTIONS), {}, {
        from: 1,
        to: 0,
        onUpdate: function onUpdate(value) {
          return animation.updatePlaybackRate(value);
        },
        onComplete: function onComplete() {
          _classPrivateFieldSet(_animation, _this, null);
        }
      })));
    ...
    _classPrivateFieldInitSpec(_this, _handleResize, (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.debounce)(function () {
      var marqueeItems = _this.refs.marqueeItems;
      var newNumberOfCopies = _assertClassBrand(_MarqueeComponent_brand, _this, _calculateNumberOfCopies).call(_this);
      var currentNumberOfCopies = marqueeItems.length;
      if (newNumberOfCopies > currentNumberOfCopies) {
        _assertClassBrand(_MarqueeComponent_brand, _this, _addRepeatedItems).call(_this, newNumberOfCopies - currentNumberOfCopies);
      } else if (newNumberOfCopies < currentNumberOfCopies) {
        _assertClassBrand(_MarqueeComponent_brand, _this, _removeRepeatedItems).call(_this, currentNumberOfCopies - newNumberOfCopies);
      }
      _assertClassBrand(_MarqueeComponent_brand, _this, _duplicateContent).call(_this);
      _assertClassBrand(_MarqueeComponent_brand, _this, _setSpeed).call(_this);
      _assertClassBrand(_MarqueeComponent_brand, _this, _restartAnimation).call(_this);
    }, 250));
    return _this;
  }
  _inherits(MarqueeComponent, _Component);
  return _createClass(MarqueeComponent, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(MarqueeComponent, "connectedCallback", this, 3)([]);
      var marqueeItems = this.refs.marqueeItems;
      if (marqueeItems.length === 0) return;
      _assertClassBrand(_MarqueeComponent_brand, this, _addRepeatedItems).call(this);
      _assertClassBrand(_MarqueeComponent_brand, this, _duplicateContent).call(this);
      _assertClassBrand(_MarqueeComponent_brand, this, _setSpeed).call(this);
      window.addEventListener('resize', _classPrivateFieldGet(_handleResize, this));
      this.addEventListener('pointerenter', _classPrivateFieldGet(_slowDown, this));
      this.addEventListener('pointerleave', _assertClassBrand(_MarqueeComponent_brand, this, _speedUp));
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(MarqueeComponent, "disconnectedCallback", this, 3)([]);
      window.removeEventListener('resize', _classPrivateFieldGet(_handleResize, this));
      this.removeEventListener('pointerenter', _classPrivateFieldGet(_slowDown, this));
      this.removeEventListener('pointerleave', _assertClassBrand(_MarqueeComponent_brand, this, _speedUp));
    }
  }, {
    key: "clonedContent",
    get: function get() {
...
}(_theme_component__WEBPACK_IMPORTED_MODULE_0__.Component); // Define the animateValue function
/**
...
function _speedUp() {
  var _classPrivateFieldGet2,
    ...
    _this2 = this;
  _classPrivateFieldGet(_slowDown, this).cancel();
  var animation = this.refs.wrapper.getAnimations()[0];
  if (!animation || animation.playbackRate === 1) return;
  var from = (_classPrivateFieldGet2 = (_classPrivateFieldGet3 = _classPrivateFieldGet(_animation, this)) === null || _classPrivateFieldGet3 === void 0 ? void 0 : _classPrivateFieldGet3.current) !== null && _classPrivateFieldGet2 !== void 0 ? _classPrivateFieldGet2 : 0;
  (_classPrivateFieldGet4 = _classPrivateFieldGet(_animation, this)) === null || _classPrivateFieldGet4 === void 0 || _classPrivateFieldGet4.cancel();
  _classPrivateFieldSet(_animation, this, animateValue(_objectSpread(_objectSpread({}, ANIMATION_OPTIONS), {}, {
    from: from,
    to: 1,
    onUpdate: function onUpdate(value) {
      return animation.updatePlaybackRate(value);
    ...
    onComplete: function onComplete() {
      _classPrivateFieldSet(_animation, _this2, null);
    }
  })));
}
function _setSpeed() {
  var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _assertClassBrand(_MarqueeComponent_brand, this, _calculateSpeed).call(this);
  this.style.setProperty('--marquee-speed', "".concat(value, "s"));
}
function _calculateSpeed() {
  var _marqueeItems$0$offse, _marqueeItems$;
  var speedFactor = Number(this.getAttribute('data-speed-factor'));
  var marqueeItems = this.refs.marqueeItems;
  var marqueeWidth = this.offsetWidth;
  var marqueeRepeatedItemWidth = (_marqueeItems$0$offse = (_marqueeItems$ = marqueeItems[0]) === null || _marqueeItems$ === void 0 ? void 0 : _marqueeItems$.offsetWidth) !== null && _marqueeItems$0$offse !== void 0 ? _marqueeItems$0$offse : 1;
  var count = marqueeRepeatedItemWidth === 0 ? 1 : Math.ceil(marqueeWidth / marqueeRepeatedItemWidth);
  var speed = Math.sqrt(count) * speedFactor;
  return speed;
}
function _restartAnimation() {
  var animations = this.refs.wrapper.getAnimations();
  requestAnimationFrame(function () {
...
function _duplicateContent() {
  var _this$clonedContent;
  (_this$clonedContent = this.clonedContent) === null || _this$clonedContent === void 0 || _this$clonedContent.remove();
  var clone = /** @type {HTMLElement} */this.refs.content.cloneNode(true);
  clone.setAttribute('aria-hidden', 'true');
  clone.removeAttribute('ref');
  this.refs.wrapper.appendChild(clone);
}
function _addRepeatedItems() {
  var numberOfCopies = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _assertClassBrand(_MarqueeComponent_brand, this, _calculateNumberOfCopies).call(this);
  var _this$refs2 = this.refs,
    content = _this$refs2.content,
    marqueeItems = _this$refs2.marqueeItems;
  if (!marqueeItems[0]) return;
  for (var i = 0; i < numberOfCopies - 1; i++) {
    var clone = marqueeItems[0].cloneNode(true);
    content.appendChild(clone);
  }
}
function _removeRepeatedItems() {
  var numberOfCopies = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _assertClassBrand(_MarqueeComponent_brand, this, _calculateNumberOfCopies).call(this);
  var content = this.refs.content;
  var children = Array.from(content.children);
  var itemsToRemove = Math.min(numberOfCopies, children.length - 1);
  for (var i = 0; i < itemsToRemove; i++) {
    var _content$lastElementC;
    (_content$lastElementC = content.lastElementChild) === null || _content$lastElementC === void 0 || _content$lastElementC.remove();
  }
}
function _calculateNumberOfCopies() {
  var _marqueeItems$0$offse2, _marqueeItems$2;
  var marqueeItems = this.refs.marqueeItems;
  var marqueeWidth = this.offsetWidth;
  var marqueeRepeatedItemWidth = (_marqueeItems$0$offse2 = (_marqueeItems$2 = marqueeItems[0]) === null || _marqueeItems$2 === void 0 ? void 0 : _marqueeItems$2.offsetWidth) !== null && _marqueeItems$0$offse2 !== void 0 ? _marqueeItems$0$offse2 : 1;
