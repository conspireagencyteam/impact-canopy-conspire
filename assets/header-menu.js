...
var ACTIVATE_DELAY = 0;
var DEACTIVATE_DELAY = 350;
...
var _activateHandler = /*#__PURE__*/new WeakMap();
var _debouncedActivateHandler = /*#__PURE__*/new WeakMap();
var _deactivate = /*#__PURE__*/new WeakMap();
var _debouncedDeactivate = /*#__PURE__*/new WeakMap();
var _preloadImages = /*#__PURE__*/new WeakMap();
var HeaderMenu = /*#__PURE__*/function (_Component) {
  function HeaderMenu() {
    ...
    _this = _callSuper(this, HeaderMenu, [].concat(args));
    _defineProperty(_this, "requiredRefs", ['overflowMenu']);
     ...
     */
    _defineProperty(_this, "activate", function (event) {
      _classPrivateFieldGet(_debouncedDeactivate, _this).cancel();
      _classPrivateFieldGet(_debouncedActivateHandler, _this).cancel();
      _classPrivateFieldGet(_debouncedActivateHandler, _this).call(_this, event);
    });
    /**
     * Activate the selected menu item with a delay
     * @param {PointerEvent | FocusEvent} event
     */
    _classPrivateFieldInitSpec(_this, _activateHandler, function (event) {
      var _this$overflowMenu$of, _this$overflowMenu;
      _classPrivateFieldGet(_debouncedDeactivate, _this).cancel();
      _this.dispatchEvent(new _theme_events__WEBPACK_IMPORTED_MODULE_2__.MegaMenuHoverEvent());
      _this.removeAttribute('data-animating');
      if (!(event.target instanceof Element)) return;
      var item = findMenuItem(event.target);
      if (!item || item == _classPrivateFieldGet(_state, _this).activeItem) return;
      var isDefaultSlot = event.target.slot === '';
      _this.dataset.overflowExpanded = (!isDefaultSlot).toString();
      var previouslyActiveItem = _classPrivateFieldGet(_state, _this).activeItem;
      if (previouslyActiveItem) {
        previouslyActiveItem.ariaExpanded = 'false';
      }
      _classPrivateFieldGet(_state, _this).activeItem = item;
      _this.ariaExpanded = 'true';
      item.ariaExpanded = 'true';
      var submenu = findSubmenu(item);
      var overflowMenuHeight = (_this$overflowMenu$of = (_this$overflowMenu = _this.overflowMenu) === null || _this$overflowMenu === void 0 ? void 0 : _this$overflowMenu.offsetHeight) !== null && _this$overflowMenu$of !== void 0 ? _this$overflowMenu$of : 0;
      if (!submenu && !isDefaultSlot) {
        submenu = _this.overflowMenu;
      }
      var submenuHeight = submenu ? Math.max(submenu.offsetHeight, overflowMenuHeight) : 0;
      _this.style.setProperty('--submenu-height', "".concat(submenuHeight, "px"));
      _this.style.setProperty('--submenu-opacity', '1');
    });
    _classPrivateFieldInitSpec(_this, _debouncedActivateHandler, (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.debounce)(_classPrivateFieldGet(_activateHandler, _this), ACTIVATE_DELAY));
    /**
     * Deactivate the active item immediately
     * @param {HTMLElement | null} [item]
     */
    _classPrivateFieldInitSpec(_this, _deactivate, function () {
      var item = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _classPrivateFieldGet(_state, _this).activeItem;
      if (!item || item != _classPrivateFieldGet(_state, _this).activeItem) return;
      if (_this.overflowHovered) return;
      _this.style.setProperty('--submenu-height', '0px');
      _this.style.setProperty('--submenu-opacity', '0');
      _this.dataset.overflowExpanded = 'false';
      _classPrivateFieldGet(_state, _this).activeItem = null;
      _this.ariaExpanded = 'false';
      item.ariaExpanded = 'false';
      item.setAttribute('data-animating', '');
      setTimeout(function () {
        item.removeAttribute('data-animating');
      }, Math.max(0, _this.animationDelay - 150)); // Start header transition 150ms before submenu finishes
    });
    /**
     * Deactivate the active item after a delay
     * @param {PointerEvent | FocusEvent} event
     */
    _classPrivateFieldInitSpec(_this, _debouncedDeactivate, (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.debounce)(_classPrivateFieldGet(_deactivate, _this), DEACTIVATE_DELAY));
    /**
     * Preload images that are set to load lazily.
     */
    _classPrivateFieldInitSpec(_this, _preloadImages, function () {
      var images = _this.querySelectorAll('img[loading="lazy"]');
      images === null || images === void 0 || images.forEach(function (image) {
        return image.removeAttribute('loading');
      });
    });
    return _this;
  }
  ...
  return _createClass(HeaderMenu, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      var _this$overflowMenu2,
        _this2 = this;
      _superPropGet(HeaderMenu, "connectedCallback", this, 3)([]);
      (_this$overflowMenu2 = this.overflowMenu) === null || _this$overflowMenu2 === void 0 || _this$overflowMenu2.addEventListener('pointerleave', function () {
        return _classPrivateFieldGet(_debouncedDeactivate, _this2).call(_this2);
      }, {
        signal: _classPrivateFieldGet(_abortController, this).signal
      });
      (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.onDocumentLoaded)(_classPrivateFieldGet(_preloadImages, this));
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(HeaderMenu, "disconnectedCallback", this, 3)([]);
     ...
     */
    function get() {
      var value = this.dataset.animationDelay;
    ...
    key: "overflowMenu",
    get: function get() {
      var _this$refs$overflowMe;
      return /** @type {HTMLElement | null} */(_this$refs$overflowMe = this.refs.overflowMenu) === null || _this$refs$overflowMe === void 0 || (_this$refs$overflowMe = _this$refs$overflowMe.shadowRoot) === null || _this$refs$overflowMe === void 0 ? void 0 : _this$refs$overflowMe.querySelector('[part="overflow"]');
    }
    ...
    key: "overflowHovered",
    get: function get() {
      var _this$refs$overflowMe2, _this$refs$overflowMe3;
      return (_this$refs$overflowMe2 = (_this$refs$overflowMe3 = this.refs.overflowMenu) === null || _this$refs$overflowMe3 === void 0 ? void 0 : _this$refs$overflowMe3.matches(':hover')) !== null && _this$refs$overflowMe2 !== void 0 ? _this$refs$overflowMe2 : false;
    }
  }, {
    key: "deactivate",
    value:
    ...
    function deactivate(event) {
      _classPrivateFieldGet(_debouncedActivateHandler, this).cancel();
      if (!(event.target instanceof Element)) return;
      var item = findMenuItem(event.target);
      ...
      if (item === _classPrivateFieldGet(_state, this).activeItem) {
        _classPrivateFieldGet(_debouncedDeactivate, this).call(this);
      }
    }
  }]);
...
function findMenuItem(element) {
  ...
  if (element !== null && element !== void 0 && element.matches('[slot="more"')) {
    var _element$parentElemen;
    // Select the first overflowing menu item when hovering over the "More" item
    return findMenuItem((_element$parentElemen = element.parentElement) === null || _element$parentElemen === void 0 ? void 0 : _element$parentElemen.querySelector('[slot="overflow"]'));
  }
  return element === null || element === void 0 ? void 0 : element.querySelector('[ref="menuitem"]');
}
...
function findSubmenu(element) {
  ...
  var submenu = element === null || element === void 0 || (_element$parentElemen2 = element.parentElement) === null || _element$parentElemen2 === void 0 ? void 0 : _element$parentElemen2.querySelector('[ref="submenu[]"]');
