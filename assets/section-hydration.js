...
(() => {
/*!******************************************!*\
  !*** ./src/scripts/section-hydration.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
 ...
 */
function hydrateSection(_x, _x2) {
  return _hydrateSection.apply(this, arguments);
}
/**
 ...
 * @param {URL} [url] - The URL to render the section from
 */
function _hydrateSection() {
  _hydrateSection = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(sectionId, url) {
    var normalizedId, section;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          normalizedId = (0,_theme_section_renderer__WEBPACK_IMPORTED_MODULE_0__.normalizeSectionId)(sectionId);
          section = document.getElementById((0,_theme_section_renderer__WEBPACK_IMPORTED_MODULE_0__.buildSectionSelector)(normalizedId));
        ...
        case 1:
          _context.n = 2;
          return _theme_section_renderer__WEBPACK_IMPORTED_MODULE_0__.sectionRenderer.renderSection(normalizedId, {
            cache: false,
            url: url
          });
        case 2:
...
function _hydrate() {
  _hydrate = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(sectionId, url) {
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.onDocumentReady)(function () {
            (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.requestIdleCallback)(function () {
              return hydrateSection(sectionId, url);
            });
          });
        case 1:
          return _context2.a(2);
