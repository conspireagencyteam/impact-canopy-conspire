...
(() => {
/*!*********************************************!*\
  !*** ./src/scripts/component-cart-items.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _theme_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @theme/component */ "./src/scripts/component.js");
/* harmony import */ var _theme_utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @theme/utilities */ "./src/scripts/utilities.js");
...
/* harmony import */ var _theme_performance__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @theme/performance */ "./src/scripts/performance.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t.return || t.return(); } finally { if (u) throw o; } } }; }
function _toConsumableArray(r) { return _arrayWithoutHoles(r) || _iterableToArray(r) || _unsupportedIterableToArray(r) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
 ...
 */
var _debouncedOnChange = /*#__PURE__*/new WeakMap();
var _CartItemsComponent_brand = /*#__PURE__*/new WeakSet();
var _handleCartError = /*#__PURE__*/new WeakMap();
var _handleCartUpdate = /*#__PURE__*/new WeakMap();
var CartItemsComponent = /*#__PURE__*/function (_Component) {
  function CartItemsComponent() {
    ...
    _this = _callSuper(this, CartItemsComponent, [].concat(args));
    /**
     * Handles QuantitySelectorUpdateEvent change event.
     * @param {QuantitySelectorUpdateEvent} event - The event.
     */
    _classPrivateMethodInitSpec(_this, _CartItemsComponent_brand);
    _classPrivateFieldInitSpec(_this, _debouncedOnChange, (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.debounce)(_assertClassBrand(_CartItemsComponent_brand, _this, _onQuantityChange), 300).bind(_this));
    /**
     * Handles the discount update.
     * @param {DiscountUpdateEvent} event - The event.
     */
    _defineProperty(_this, "handleDiscountUpdate", function (event) {
      _classPrivateFieldGet(_handleCartUpdate, _this).call(_this, event);
    });
    /**
     ...
     */
    _classPrivateFieldInitSpec(_this, _handleCartError, function (line, parsedResponseText) {
      var quantitySelector = _this.refs.quantitySelectors[line - 1];
      var quantityInput = quantitySelector === null || quantitySelector === void 0 ? void 0 : quantitySelector.querySelector('input');
      if (!quantityInput) throw new Error('Quantity input not found');
      quantityInput.value = quantityInput.defaultValue;
      var cartItemError = _this.refs["cartItemError-".concat(line)];
      var cartItemErrorContainer = _this.refs["cartItemErrorContainer-".concat(line)];
     ...
     */
    _classPrivateFieldInitSpec(_this, _handleCartUpdate, function (event) {
      var _event$detail$data$se;
      if (event instanceof _theme_events__WEBPACK_IMPORTED_MODULE_3__.DiscountUpdateEvent) {
        _theme_section_renderer__WEBPACK_IMPORTED_MODULE_2__.sectionRenderer.renderSection(_this.sectionId, {
          cache: false
        });
        return;
      }
      if (event.target === _this) return;
      var cartItemsHtml = (_event$detail$data$se = event.detail.data.sections) === null || _event$detail$data$se === void 0 ? void 0 : _event$detail$data$se[_this.sectionId];
      if (cartItemsHtml) {
        (0,_theme_section_renderer__WEBPACK_IMPORTED_MODULE_2__.morphSection)(_this.sectionId, cartItemsHtml);

        // Update button states for all cart quantity selectors after morph
        _assertClassBrand(_CartItemsComponent_brand, _this, _updateCartQuantitySelectorButtonStates).call(_this);
      } else {
        _theme_section_renderer__WEBPACK_IMPORTED_MODULE_2__.sectionRenderer.renderSection(_this.sectionId, {
          cache: false
        });
  ...
  _inherits(CartItemsComponent, _Component);
  return _createClass(CartItemsComponent, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(CartItemsComponent, "connectedCallback", this, 3)([]);
      document.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_3__.ThemeEvents.cartUpdate, _classPrivateFieldGet(_handleCartUpdate, this));
      document.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_3__.ThemeEvents.discountUpdate, this.handleDiscountUpdate);
      document.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_3__.ThemeEvents.quantitySelectorUpdate, _classPrivateFieldGet(_debouncedOnChange, this));
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(CartItemsComponent, "disconnectedCallback", this, 3)([]);
      document.removeEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_3__.ThemeEvents.cartUpdate, _classPrivateFieldGet(_handleCartUpdate, this));
      document.removeEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_3__.ThemeEvents.quantitySelectorUpdate, _classPrivateFieldGet(_debouncedOnChange, this));
    }
  }, {
    key: "onLineItemRemove",
    value:
    /**
     * Handles the line item removal.
     * @param {number} line - The line item index.
     */
    function onLineItemRemove(line) {
      this.updateQuantity({
        line: line,
        quantity: 0,
        action: 'clear'
      });
      var cartItemRowToRemove = this.refs.cartItemRows[line - 1];
      if (!cartItemRowToRemove) return;
      var rowsToRemove = [cartItemRowToRemove].concat(_toConsumableArray(this.refs.cartItemRows.filter(function (row) {
        return row.dataset.parentKey === cartItemRowToRemove.dataset.key;
      })));
      ...
      rowsToRemove.forEach(function (row) {
        ...
        if ((0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.prefersReducedMotion)()) return remove();
        row.style.setProperty('--row-height', "".concat(row.clientHeight, "px"));
        row.classList.add('removing');

        // Remove the row after the animation ends
        (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.onAnimationEnd)(row, remove);
      });
    }
    ...
    key: "updateQuantity",
    value: function updateQuantity(config) {
      var _this2 = this;
      var cartPerformaceUpdateMarker = _theme_performance__WEBPACK_IMPORTED_MODULE_4__.cartPerformance.createStartingMarker("".concat(config.action, ":user-action"));
      _assertClassBrand(_CartItemsComponent_brand, this, _disableCartItems).call(this);
      var line = config.line,
        quantity = config.quantity;
      var cartTotal = this.refs.cartTotal;
      var cartItemsComponents = document.querySelectorAll('cart-items-component');
      var sectionsToUpdate = new Set([this.sectionId]);
      ...
      cartTotal === null || cartTotal === void 0 || cartTotal.shimmer();
      fetch("".concat(Theme.routes.cart_change_url), (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.fetchConfig)('json', {
        body: body
      })).then(function (response) {
        return response.text();
      }).then(function (responseText) {
        var _newSectionHTML$query;
        var parsedResponseText = JSON.parse(responseText);
        (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.resetShimmer)(_this2);
        if (parsedResponseText.errors) {
          _classPrivateFieldGet(_handleCartError, _this2).call(_this2, line, parsedResponseText);
          return;
        }
        var newSectionHTML = new DOMParser().parseFromString(parsedResponseText.sections[_this2.sectionId], 'text/html');

        // Grab the new cart item count from a hidden element
        var newCartHiddenItemCount = (_newSectionHTML$query = newSectionHTML.querySelector('[ref="cartItemCount"]')) === null || _newSectionHTML$query === void 0 ? void 0 : _newSectionHTML$query.textContent;
        var newCartItemCount = newCartHiddenItemCount ? parseInt(newCartHiddenItemCount, 10) : 0;

        // Update data-cart-quantity for all matching variants
        _assertClassBrand(_CartItemsComponent_brand, _this2, _updateQuantitySelectors).call(_this2, parsedResponseText);
        _this2.dispatchEvent(new _theme_events__WEBPACK_IMPORTED_MODULE_3__.CartUpdateEvent({}, _this2.sectionId, {
          itemCount: newCartItemCount,
          source: 'cart-items-component',
          sections: parsedResponseText.sections
        }));
        (0,_theme_section_renderer__WEBPACK_IMPORTED_MODULE_2__.morphSection)(_this2.sectionId, parsedResponseText.sections[_this2.sectionId]);
        _assertClassBrand(_CartItemsComponent_brand, _this2, _updateCartQuantitySelectorButtonStates).call(_this2);
      }).catch(function (error) {
        console.error(error);
      }).finally(function () {
        _assertClassBrand(_CartItemsComponent_brand, _this2, _enableCartItems).call(_this2);
        _theme_performance__WEBPACK_IMPORTED_MODULE_4__.cartPerformance.measureFromMarker(cartPerformaceUpdateMarker);
      });
    }
  }, {
    key: "sectionId",
...
function _onQuantityChange(event) {
  var _event$detail = event.detail,
    quantity = _event$detail.quantity,
    line = _event$detail.cartLine;
  if (!line) return;
  if (quantity === 0) {
  ...
  var lineItemRow = this.refs.cartItemRows[line - 1];
  if (!lineItemRow) return;
  var textComponent = /** @type {TextComponent | undefined} */lineItemRow.querySelector('text-component');
  textComponent === null || textComponent === void 0 || textComponent.shimmer();
}
/**
 * Disables the cart items.
 */
function _disableCartItems() {
  this.classList.add('cart-items-disabled');
}
/**
 * Enables the cart items.
 */
function _enableCartItems() {
 ...
 */
function _updateQuantitySelectors(updatedCart) {
  if (!updatedCart.items) return;
  var _iterator = _createForOfIteratorHelper(updatedCart.items),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var item = _step.value;
      var variantId = item.variant_id.toString();
      var selectors = document.querySelectorAll("quantity-selector-component[data-variant-id=\"".concat(variantId, "\"], cart-quantity-selector-component[data-variant-id=\"").concat(variantId, "\"]"));
      var _iterator2 = _createForOfIteratorHelper(selectors),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var selector = _step2.value;
          var input = selector.querySelector('input[data-cart-quantity]');
          if (!input) continue;
 ...
 */
function _updateCartQuantitySelectorButtonStates() {
  var cartQuantitySelectors = document.querySelectorAll('cart-quantity-selector-component');
  var _iterator3 = _createForOfIteratorHelper(cartQuantitySelectors),
    _step3;
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
