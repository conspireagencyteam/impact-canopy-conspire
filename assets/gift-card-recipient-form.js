...
(() => {
/*!*************************************************!*\
  !*** ./src/scripts/gift-card-recipient-form.js ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
...
var _updateCharacterCountBound = /*#__PURE__*/new WeakMap();
var _displayCartErrorBound = /*#__PURE__*/new WeakMap();
var _cartAddEventBound = /*#__PURE__*/new WeakMap();
var _GiftCardRecipientForm_brand = /*#__PURE__*/new WeakSet();
var GiftCardRecipientForm = /*#__PURE__*/function (_Component) {
  function GiftCardRecipientForm() {
    var _this2;
    _classCallCheck(this, GiftCardRecipientForm);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this2 = _callSuper(this, GiftCardRecipientForm, [].concat(args));
    /**
     * Get all recipient input fields
     * @returns {(HTMLInputElement | HTMLTextAreaElement)[]} Array of input fields
     */
    _classPrivateMethodInitSpec(_this2, _GiftCardRecipientForm_brand);
    _classPrivateFieldInitSpec(_this2, _currentMode, GiftCardRecipientForm.DeliveryMode.SELF);
    // Store bound event handlers for cleanup
    /** @type {(() => void) | null} */
    _classPrivateFieldInitSpec(_this2, _updateCharacterCountBound, null);
    /** @type {((event: Event) => void) | null} */
    _classPrivateFieldInitSpec(_this2, _displayCartErrorBound, null);
    /** @type {(() => void) | null} */
    _classPrivateFieldInitSpec(_this2, _cartAddEventBound, null);
    _defineProperty(_this2, "requiredRefs", ['myEmailButton', 'recipientEmailButton', 'recipientFields', 'recipientEmail', 'recipientName', 'recipientMessage', 'recipientSendOn']);
    return _this2;
  }
  _inherits(GiftCardRecipientForm, _Component);
  return _createClass(GiftCardRecipientForm, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      var _this3 = this;
      _superPropGet(GiftCardRecipientForm, "connectedCallback", this, 3)([]);
      _assertClassBrand(_GiftCardRecipientForm_brand, this, _initializeForm).call(this);
      _classPrivateFieldSet(_updateCharacterCountBound, this, function () {
        return _assertClassBrand(_GiftCardRecipientForm_brand, _this3, _updateCharacterCount).call(_this3);
      });
      this.refs.recipientMessage.addEventListener('input', _classPrivateFieldGet(_updateCharacterCountBound, this));
      _classPrivateFieldSet(_displayCartErrorBound, this, _assertClassBrand(_GiftCardRecipientForm_brand, this, _displayCartError).bind(this));
      // @ts-ignore - #displayCartErrorBound is guaranteed to be non-null here
      document.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_1__.ThemeEvents.cartError, _classPrivateFieldGet(_displayCartErrorBound, this));
      _classPrivateFieldSet(_cartAddEventBound, this, function () {
        return _assertClassBrand(_GiftCardRecipientForm_brand, _this3, _handleCartAdd).call(_this3);
      });
      document.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_1__.ThemeEvents.cartUpdate, _classPrivateFieldGet(_cartAddEventBound, this));
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(GiftCardRecipientForm, "disconnectedCallback", this, 3)([]);
      if (_classPrivateFieldGet(_updateCharacterCountBound, this)) {
        this.refs.recipientMessage.removeEventListener('input', _classPrivateFieldGet(_updateCharacterCountBound, this));
        _classPrivateFieldSet(_updateCharacterCountBound, this, null);
      }
      if (_classPrivateFieldGet(_displayCartErrorBound, this)) {
        document.removeEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_1__.ThemeEvents.cartError, _classPrivateFieldGet(_displayCartErrorBound, this));
        _classPrivateFieldSet(_displayCartErrorBound, this, null);
      }
      if (_classPrivateFieldGet(_cartAddEventBound, this)) {
        document.removeEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_1__.ThemeEvents.cartUpdate, _classPrivateFieldGet(_cartAddEventBound, this));
        _classPrivateFieldSet(_cartAddEventBound, this, null);
      }
    }
     ...
     */
    function toggleRecipientForm(mode, _event) {
      // Validate mode
      if (!Object.values(GiftCardRecipientForm.DeliveryMode).includes(mode)) {
        throw new Error("Invalid delivery mode: ".concat(mode, ". Must be one of: ").concat(Object.values(GiftCardRecipientForm.DeliveryMode).join(', ')));
      }
      if (_classPrivateFieldGet(_currentMode, this) === mode) return;
      _classPrivateFieldSet(_currentMode, this, mode);
      _assertClassBrand(_GiftCardRecipientForm_brand, this, _updateFormState).call(this);
    }
...
}(_theme_component__WEBPACK_IMPORTED_MODULE_0__.Component); // Register the custom element
_GiftCardRecipientForm = GiftCardRecipientForm;
function _get_inputFields(_this) {
  return [_this.refs.recipientEmail, _this.refs.recipientName, _this.refs.recipientMessage, _this.refs.recipientSendOn];
}
function _initializeForm() {
  _assertClassBrand(_GiftCardRecipientForm_brand, this, _updateButtonStates).call(this, _GiftCardRecipientForm.DeliveryMode.SELF);
  this.refs.recipientFields.hidden = true;
  _assertClassBrand(_GiftCardRecipientForm_brand, this, _clearRecipientFields).call(this);
  _assertClassBrand(_GiftCardRecipientForm_brand, this, _disableRecipientFields).call(this);
  _assertClassBrand(_GiftCardRecipientForm_brand, this, _setDateConstraints).call(this);
}
function _updateFormState() {
  var DeliveryMode = _GiftCardRecipientForm.DeliveryMode;
  var isRecipientMode = _classPrivateFieldGet(_currentMode, this) === DeliveryMode.RECIPIENT;
  _assertClassBrand(_GiftCardRecipientForm_brand, this, _updateButtonStates).call(this, _classPrivateFieldGet(_currentMode, this));
  this.refs.recipientFields.hidden = !isRecipientMode;
  if (isRecipientMode) {
    _assertClassBrand(_GiftCardRecipientForm_brand, this, _enableRecipientFields).call(this);
    _assertClassBrand(_GiftCardRecipientForm_brand, this, _updateCharacterCount).call(this);

    // Announce to screen readers
    if (this.refs.liveRegion) {
      var _Theme$translations;
      this.refs.liveRegion.textContent = ((_Theme$translations = Theme.translations) === null || _Theme$translations === void 0 ? void 0 : _Theme$translations.recipient_form_fields_visible) || 'Recipient form fields are now visible';
    }
    ...
    // Announce to screen readers
    if (this.refs.liveRegion) {
      var _Theme$translations2;
      this.refs.liveRegion.textContent = ((_Theme$translations2 = Theme.translations) === null || _Theme$translations2 === void 0 ? void 0 : _Theme$translations2.recipient_form_fields_hidden) || 'Recipient form fields are now hidden';
    }
  }
  this.dispatchEvent(new CustomEvent('recipient:toggle', {
    detail: {
      mode: _classPrivateFieldGet(_currentMode, this),
 ...
 */
function _updateButtonStates(mode) {
  var DeliveryMode = _GiftCardRecipientForm.DeliveryMode;
  switch (mode) {
    ...
    case DeliveryMode.RECIPIENT:
      ...
      break;
    default:
      console.warn("Unknown delivery mode: ".concat(mode));
 ...
 */
function _clearRecipientFields() {
  var _iterator = _createForOfIteratorHelper(_classPrivateGetter(_GiftCardRecipientForm_brand, this, _get_inputFields)),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
  ...
  _assertClassBrand(_GiftCardRecipientForm_brand, this, _updateCharacterCount).call(this);
  _assertClassBrand(_GiftCardRecipientForm_brand, this, _clearErrorMessages).call(this);
}
/**
 * Disable recipient form fields when sending to self
 */
function _disableRecipientFields() {
  var _iterator2 = _createForOfIteratorHelper(_classPrivateGetter(_GiftCardRecipientForm_brand, this, _get_inputFields)),
    _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
  ...
  var controlFlag = this.querySelector('input[name="properties[__shopify_send_gift_card_to_recipient]"]');
  if (controlFlag) {
    controlFlag.remove();
  }
 ...
 */
function _enableRecipientFields() {
  var _iterator3 = _createForOfIteratorHelper(_classPrivateGetter(_GiftCardRecipientForm_brand, this, _get_inputFields)),
    _step3;
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
 ...
 */
function _updateCharacterCount() {
  if (!this.refs.characterCount) return;
  var currentLength = this.refs.recipientMessage.value.length;
  var maxLength = this.refs.recipientMessage.maxLength;
  var template = this.refs.characterCount.getAttribute('data-template');
  if (!template) return;
  var updatedText = template.replace('[current]', currentLength.toString()).replace('[max]', maxLength.toString());
 ...
 */
function _displayCartError(event) {
  var _event$detail;
  if ((_event$detail = event.detail) !== null && _event$detail !== void 0 && _event$detail.data) {
    var _event$detail$data = event.detail.data,
      message = _event$detail$data.message,
      errors = _event$detail$data.errors,
      description = _event$detail$data.description;

    // Display the error message
    if (errors && _typeof(errors) === 'object') {
      _assertClassBrand(_GiftCardRecipientForm_brand, this, _displayErrorMessage).call(this, message || 'There was an error', errors);
    } else if (message) {
      _assertClassBrand(_GiftCardRecipientForm_brand, this, _displayErrorMessage).call(this, message, description);
    }
  }
}
/**
 ...
 */
function _displayErrorMessage(title, body) {
  _assertClassBrand(_GiftCardRecipientForm_brand, this, _clearErrorMessages).call(this);
  if (_typeof(body) === 'object' && body !== null) {
    /** @type {Record<string, {inputRef: string, errorRef: string}>} */
    var fieldMap = {
      email: {
        inputRef: 'recipientEmail',
        errorRef: 'emailError'
      },
      name: {
        inputRef: 'recipientName',
        errorRef: 'nameError'
      },
      message: {
        inputRef: 'recipientMessage',
        errorRef: 'messageError'
      },
      send_on: {
        inputRef: 'recipientSendOn',
        errorRef: 'sendOnError'
      }
    };
    for (var _i = 0, _Object$entries = Object.entries(body); _i < _Object$entries.length; _i++) {
      var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
        field = _Object$entries$_i[0],
        errorMessages = _Object$entries$_i[1];
      var fieldConfig = fieldMap[field];
      if (!fieldConfig) continue;
      var inputRef = fieldConfig.inputRef,
        errorRef = fieldConfig.errorRef;
      var errorContainer = this.refs[errorRef];
      var inputElement = this.refs[inputRef];
      if (errorContainer && errorContainer instanceof HTMLElement) {
        var errorTextElement = errorContainer.querySelector('span');
        if (errorTextElement) {
          var message = Array.isArray(errorMessages) ? errorMessages.join(', ') : errorMessages;
          errorTextElement.textContent = "".concat(message, ".");
        }
      ...
      if (inputElement && inputElement instanceof HTMLElement) {
        ...
        var errorId = "RecipientForm-".concat(field, "-error-").concat(this.dataset.sectionId || 'default');
  ...
  if (this.refs.liveRegion) {
    var _Theme$translations3;
    this.refs.liveRegion.textContent = title || ((_Theme$translations3 = Theme.translations) === null || _Theme$translations3 === void 0 ? void 0 : _Theme$translations3.recipient_form_error) || 'There was an error with the form submission';
  }
}
/**
...
function _clearErrorMessages() {
  ...
  var errorRefs = ['emailError', 'nameError', 'messageError', 'sendOnError'];
  for (var _i2 = 0, _errorRefs = errorRefs; _i2 < _errorRefs.length; _i2++) {
    var errorRef = _errorRefs[_i2];
    var errorContainer = this.refs[errorRef];
    if (errorContainer && errorContainer instanceof HTMLElement) {
  ...
  var _iterator4 = _createForOfIteratorHelper(_classPrivateGetter(_GiftCardRecipientForm_brand, this, _get_inputFields)),
    _step4;
  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
...
_defineProperty(GiftCardRecipientForm, "DeliveryMode", {
  SELF: 'self',
  // Send to my email
