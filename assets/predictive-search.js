...
(() => {
/*!******************************************!*\
  !*** ./src/scripts/predictive-search.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _theme_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @theme/component */ "./src/scripts/component.js");
/* harmony import */ var _theme_utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @theme/utilities */ "./src/scripts/utilities.js");
/* harmony import */ var _theme_section_renderer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @theme/section-renderer */ "./src/scripts/section-renderer.js");
/* harmony import */ var _theme_morph__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @theme/morph */ "./src/scripts/morph.js");
/* harmony import */ var _theme_recently_viewed_products__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @theme/recently-viewed-products */ "./src/scripts/recently-viewed-products.js");
/* harmony import */ var _theme_dialog__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @theme/dialog */ "./src/scripts/dialog.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _slicedToArray(r, e) { return _arrayWithHoles(r) || _iterableToArrayLimit(r, e) || _unsupportedIterableToArray(r, e) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t.return && (u = t.return(), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
...
var _handleModalClick = /*#__PURE__*/new WeakMap();
var _handleKeyboardShortcut = /*#__PURE__*/new WeakMap();
var _handleDialogClose = /*#__PURE__*/new WeakMap();
var _PredictiveSearchComponent_brand = /*#__PURE__*/new WeakSet();
var _isKeyboardNavigation = /*#__PURE__*/new WeakMap();
var _resetSearch = /*#__PURE__*/new WeakMap();
var PredictiveSearchComponent = /*#__PURE__*/function (_Component) {
  function PredictiveSearchComponent() {
    var _this5;
    _classCallCheck(this, PredictiveSearchComponent);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this5 = _callSuper(this, PredictiveSearchComponent, [].concat(args));
    _classPrivateMethodInitSpec(_this5, _PredictiveSearchComponent_brand);
    _defineProperty(_this5, "requiredRefs", ['searchInput', 'predictiveSearchResults', 'resetButton']);
    _classPrivateFieldInitSpec(_this5, _controller, new AbortController());
    /**
     * @type {AbortController | null}
     */
    _classPrivateFieldInitSpec(_this5, _activeFetch, null);
    /**
     * Handles clicks within the predictive search modal to maintain focus on the input
     * @param {MouseEvent} event - The mouse event
     */
    _classPrivateFieldInitSpec(_this5, _handleModalClick, function (event) {
      var target = /** @type {HTMLElement} */event.target;
      var isInteractiveElement = target instanceof HTMLButtonElement || target instanceof HTMLAnchorElement || target instanceof HTMLInputElement || target.closest('button') || target.closest('a') || target.closest('input');
      if (!isInteractiveElement && _this5.refs.searchInput) {
     ...
     * @param {KeyboardEvent} event - The keyboard event.
     */
    _classPrivateFieldInitSpec(_this5, _handleKeyboardShortcut, function (event) {
      if (event.metaKey && event.key === 'k') {
        var _this5$dialog;
        (_this5$dialog = _this5.dialog) === null || _this5$dialog === void 0 || _this5$dialog.toggleDialog();
      }
    });
    /**
     * Handles the dialog close event.
     */
    _classPrivateFieldInitSpec(_this5, _handleDialogClose, function () {
      _classPrivateFieldGet(_resetSearch, _this5).call(_this5);
    });
    /**
     * Track whether the last interaction was keyboard-based
     * @type {boolean}
     */
    _classPrivateFieldInitSpec(_this5, _isKeyboardNavigation, false);
    /**
     * Navigate through the predictive search results using arrow keys or close them with the Escape key.
     * @param {KeyboardEvent} event - The keyboard event.
     */
    _defineProperty(_this5, "onSearchKeyDown", function (event) {
      var _classPrivateGetter2;
      if (event.key === 'Escape') {
        _classPrivateFieldGet(_resetSearch, _this5).call(_this5);
        return;
      }
      if (!((_classPrivateGetter2 = _classPrivateGetter(_PredictiveSearchComponent_brand, _this5, _get_allResultsItems)) !== null && _classPrivateGetter2 !== void 0 && _classPrivateGetter2.length) || event.key === 'ArrowLeft' || event.key === 'ArrowRight') {
        return;
      }
      var currentIndex = _classPrivateGetter(_PredictiveSearchComponent_brand, _this5, _get_currentIndex);
      var totalItems = _classPrivateGetter(_PredictiveSearchComponent_brand, _this5, _get_allResultsItems).length;
      switch (event.key) {
        case 'ArrowDown':
          _classPrivateFieldSet(_isKeyboardNavigation, _this5, true);
          event.preventDefault();
          _classPrivateSetter(_PredictiveSearchComponent_brand, _set_currentIndex, _this5, currentIndex < totalItems - 1 ? currentIndex + 1 : 0);
          break;
        case 'Tab':
          if (event.shiftKey) {
            _classPrivateFieldSet(_isKeyboardNavigation, _this5, true);
            event.preventDefault();
            _classPrivateSetter(_PredictiveSearchComponent_brand, _set_currentIndex, _this5, currentIndex > 0 ? currentIndex - 1 : totalItems - 1);
          } else {
            _classPrivateFieldSet(_isKeyboardNavigation, _this5, true);
            event.preventDefault();
            _classPrivateSetter(_PredictiveSearchComponent_brand, _set_currentIndex, _this5, currentIndex < totalItems - 1 ? currentIndex + 1 : 0);
        ...
        case 'Enter':
          {
            var singleResultContainer = _this5.refs.predictiveSearchResults.querySelector('[data-single-result-url]');
            ...
            if (_classPrivateGetter(_PredictiveSearchComponent_brand, _this5, _get_currentIndex) >= 0) {
              var _classPrivateGetter3;
              event.preventDefault();
              (_classPrivateGetter3 = _classPrivateGetter(_PredictiveSearchComponent_brand, _this5, _get_currentItem)) === null || _classPrivateGetter3 === void 0 || (_classPrivateGetter3 = _classPrivateGetter3.querySelector('a')) === null || _classPrivateGetter3 === void 0 || _classPrivateGetter3.click();
            } else {
              var searchUrl = new URL(Theme.routes.search_url, location.origin);
              searchUrl.searchParams.set('q', _this5.refs.searchInput.value);
     ...
     */
    _defineProperty(_this5, "resetSearch", (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.debounce)(function () {
     ...
     */
    _defineProperty(_this5, "search", (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.debounce)(function (event) {
      // If the input is not a text input (like using the Escape key), don't search
      if (!event.inputType) return;
      var searchTerm = _this5.refs.searchInput.value.trim();
      _classPrivateSetter(_PredictiveSearchComponent_brand, _set_currentIndex, _this5, -1);
      if (!searchTerm.length) {
        _classPrivateFieldGet(_resetSearch, _this5).call(_this5);
        return;
      }
      _assertClassBrand(_PredictiveSearchComponent_brand, _this5, _showResetButton).call(_this5);
      _assertClassBrand(_PredictiveSearchComponent_brand, _this5, _getSearchResults).call(_this5, searchTerm);
    }, 200));
    _classPrivateFieldInitSpec(_this5, _resetSearch, /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      var _this5$refs, predictiveSearchResults, searchInput, emptySectionId, abortController, url, emptySectionMarkup, parsedEmptySectionMarkup, viewedProducts, recentlyViewedMarkup, parsedRecentlyViewedMarkup, recentlyViewedProductsHtml, _iterator, _step, child, collectionElement;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            _this5$refs = _this5.refs, predictiveSearchResults = _this5$refs.predictiveSearchResults, searchInput = _this5$refs.searchInput;
            emptySectionId = 'predictive-search-empty';
            _classPrivateSetter(_PredictiveSearchComponent_brand, _set_currentIndex, _this5, -1);
            searchInput.value = '';
            _assertClassBrand(_PredictiveSearchComponent_brand, _this5, _hideResetButton).call(_this5);
            abortController = _assertClassBrand(_PredictiveSearchComponent_brand, _this5, _createAbortController).call(_this5);
            url = new URL(window.location.href);
            url.searchParams.delete('page');
            _context.n = 1;
            return _theme_section_renderer__WEBPACK_IMPORTED_MODULE_2__.sectionRenderer.getSectionHTML(emptySectionId, false, url);
          case 1:
            emptySectionMarkup = _context.v;
            parsedEmptySectionMarkup = new DOMParser().parseFromString(emptySectionMarkup, 'text/html').querySelector('.predictive-search-empty-section');
          ...
          case 2:
            ...
            viewedProducts = _theme_recently_viewed_products__WEBPACK_IMPORTED_MODULE_4__.RecentlyViewed.getProducts();
            if (!(viewedProducts.length > 0)) {
              _context.n = 7;
              break;
            }
            _context.n = 3;
            return _assertClassBrand(_PredictiveSearchComponent_brand, _this5, _getRecentlyViewedProductsMarkup).call(_this5);
          case 3:
            recentlyViewedMarkup = _context.v;
            ...
            return _context.a(2);
          case 4:
            parsedRecentlyViewedMarkup = new DOMParser().parseFromString(recentlyViewedMarkup, 'text/html');
            recentlyViewedProductsHtml = parsedRecentlyViewedMarkup.getElementById('predictive-search-products');
            ...
            return _context.a(2);
          case 5:
            _iterator = _createForOfIteratorHelper(recentlyViewedProductsHtml.children);
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                child = _step.value;
            ...
            collectionElement = parsedEmptySectionMarkup.querySelector('#predictive-search-products');
            ...
            return _context.a(2);
          case 6:
            collectionElement.prepend.apply(collectionElement, _toConsumableArray(recentlyViewedProductsHtml.children));
          case 7:
            if (!abortController.signal.aborted) {
              _context.n = 8;
              break;
            ...
            return _context.a(2);
          case 8:
            (0,_theme_morph__WEBPACK_IMPORTED_MODULE_3__.morph)(predictiveSearchResults, parsedEmptySectionMarkup);
            _assertClassBrand(_PredictiveSearchComponent_brand, _this5, _resetScrollPositions).call(_this5);
          case 9:
            return _context.a(2);
        }
      }, _callee);
  ...
  _inherits(PredictiveSearchComponent, _Component);
  return _createClass(PredictiveSearchComponent, [{
    key: "dialog",
    get:
    /**
    ...
    value: function connectedCallback() {
      var _this6 = this;
      _superPropGet(PredictiveSearchComponent, "connectedCallback", this, 3)([]);
      var dialog = this.dialog;
      var _classPrivateFieldGet2 = _classPrivateFieldGet(_controller, this),
        signal = _classPrivateFieldGet2.signal;
      if (this.refs.searchInput.value.length > 0) {
        _assertClassBrand(_PredictiveSearchComponent_brand, this, _showResetButton).call(this);
      }
      if (dialog) {
        document.addEventListener('keydown', _classPrivateFieldGet(_handleKeyboardShortcut, this), {
          signal: signal
        });
        dialog.addEventListener(_theme_dialog__WEBPACK_IMPORTED_MODULE_5__.DialogCloseEvent.eventName, _classPrivateFieldGet(_handleDialogClose, this), {
          signal: signal
        });
        this.addEventListener('click', _classPrivateFieldGet(_handleModalClick, this), {
          signal: signal
        });
      }
      (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.onDocumentLoaded)(function () {
        _this6.resetSearch(false); // Pass false to avoid focusing the input
      });
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(PredictiveSearchComponent, "disconnectedCallback", this, 3)([]);
      _classPrivateFieldGet(_controller, this).abort();
    }
  }, {
    key: "clearRecentlyViewedProducts",
    value:
    /**
     * Clears the recently viewed products.
     * @param {Event} event - The event.
     */
    function clearRecentlyViewedProducts(event) {
      event.stopPropagation();
      _theme_recently_viewed_products__WEBPACK_IMPORTED_MODULE_4__.RecentlyViewed.clearProducts();
      var _this$refs = this.refs,
        recentlyViewedItems = _this$refs.recentlyViewedItems,
        recentlyViewedTitle = _this$refs.recentlyViewedTitle,
        recentlyViewedWrapper = _this$refs.recentlyViewedWrapper;
      var allRecentlyViewedElements = [].concat(_toConsumableArray(recentlyViewedItems || []), _toConsumableArray(recentlyViewedTitle || []));
      if (allRecentlyViewedElements.length === 0) {
        return;
      }
      if (recentlyViewedWrapper) {
        recentlyViewedWrapper.classList.add('removing');
        (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.onAnimationEnd)(recentlyViewedWrapper, function () {
...
function _get_allResultsItems(_this) {
  var containers = Array.from(_this.querySelectorAll('.predictive-search-results__wrapper-queries, ' + '.predictive-search-results__wrapper-products, ' + '.predictive-search-results__list'));
  var allItems = containers.flatMap(function (container) {
...
function _get_currentIndex(_this2) {
  var _classPrivateGetter$f, _classPrivateGetter4;
  return (_classPrivateGetter$f = (_classPrivateGetter4 = _classPrivateGetter(_PredictiveSearchComponent_brand, _this2, _get_allResultsItems)) === null || _classPrivateGetter4 === void 0 ? void 0 : _classPrivateGetter4.findIndex(function (item) {
    return item.getAttribute('aria-selected') === 'true';
  })) !== null && _classPrivateGetter$f !== void 0 ? _classPrivateGetter$f : -1;
}
function _set_currentIndex(_this3, index) {
  var _classPrivateGetter5;
  if (!((_classPrivateGetter5 = _classPrivateGetter(_PredictiveSearchComponent_brand, _this3, _get_allResultsItems)) !== null && _classPrivateGetter5 !== void 0 && _classPrivateGetter5.length)) return;
  _classPrivateGetter(_PredictiveSearchComponent_brand, _this3, _get_allResultsItems).forEach(function (item) {
    item.classList.remove('keyboard-focus');
  });
  var _iterator2 = _createForOfIteratorHelper(_classPrivateGetter(_PredictiveSearchComponent_brand, _this3, _get_allResultsItems).entries()),
    _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var _step2$value = _slicedToArray(_step2.value, 2),
        itemIndex = _step2$value[0],
        item = _step2$value[1];
      if (itemIndex === index) {
        item.setAttribute('aria-selected', 'true');
        if (_classPrivateFieldGet(_isKeyboardNavigation, _this3)) {
...
function _get_currentItem(_this4) {
  var _classPrivateGetter6;
  return (_classPrivateGetter6 = _classPrivateGetter(_PredictiveSearchComponent_brand, _this4, _get_allResultsItems)) === null || _classPrivateGetter6 === void 0 ? void 0 : _classPrivateGetter6[_classPrivateGetter(_PredictiveSearchComponent_brand, _this4, _get_currentIndex)];
}
/**
 * Resets scroll positions for search results containers
 */
function _resetScrollPositions() {
  var _this7 = this;
  requestAnimationFrame(function () {
    var resultsInner = _this7.refs.predictiveSearchResults.querySelector('.predictive-search-results__inner');
    if (resultsInner instanceof HTMLElement) {
      resultsInner.scrollTop = 0;
    }
    var formContent = _this7.querySelector('.predictive-search-form__content');
 ...
 */
function _getSearchResults(_x) {
  return _getSearchResults2.apply(this, arguments);
}
function _getSearchResults2() {
  _getSearchResults2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(searchTerm) {
    var _this8 = this;
    var url, predictiveSearchResults, abortController;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          ...
          return _context2.a(2);
        case 1:
          url = new URL(Theme.routes.predictive_search_url, location.origin);
          url.searchParams.set('q', searchTerm);
          url.searchParams.set('resources[limit_scope]', 'each');
          predictiveSearchResults = this.refs.predictiveSearchResults;
          abortController = _assertClassBrand(_PredictiveSearchComponent_brand, this, _createAbortController).call(this);
          _theme_section_renderer__WEBPACK_IMPORTED_MODULE_2__.sectionRenderer.getSectionHTML(this.dataset.sectionId, false, url).then(function (resultsMarkup) {
            if (!resultsMarkup) return;
            if (abortController.signal.aborted) return;
            (0,_theme_morph__WEBPACK_IMPORTED_MODULE_3__.morph)(predictiveSearchResults, resultsMarkup);
            _assertClassBrand(_PredictiveSearchComponent_brand, _this8, _resetScrollPositions).call(_this8);
 ...
 */
function _getRecentlyViewedProductsMarkup() {
  return _getRecentlyViewedProductsMarkup2.apply(this, arguments);
}
function _getRecentlyViewedProductsMarkup2() {
  _getRecentlyViewedProductsMarkup2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
    var viewedProducts, url;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          if (this.dataset.sectionId) {
        ...
        case 1:
          ...
          return _context3.a(2, null);
        case 2:
          url = new URL(Theme.routes.search_url, location.origin);
          url.searchParams.set('q', viewedProducts.map(/** @param {string} id */function (id) {
            return "id:".concat(id);
          }).join(' OR '));
          url.searchParams.set('resources[type]', 'product');
          return _context3.a(2, _theme_section_renderer__WEBPACK_IMPORTED_MODULE_2__.sectionRenderer.getSectionHTML(this.dataset.sectionId, false, url));
      }
    }, _callee3, this);
  }));
  return _getRecentlyViewedProductsMarkup2.apply(this, arguments);
...
function _hideResetButton() {
  var resetButton = this.refs.resetButton;
...
function _createAbortController() {
  ...
  if (_classPrivateFieldGet(_activeFetch, this)) {
    _classPrivateFieldGet(_activeFetch, this).abort();
  }
  _classPrivateFieldSet(_activeFetch, this, abortController);
