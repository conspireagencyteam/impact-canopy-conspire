...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MediaGallery: () => (/* binding */ MediaGallery)
/* harmony export */ });
...
var _handleZoomMediaSelected = /*#__PURE__*/new WeakMap();
var MediaGallery = /*#__PURE__*/function (_Component) {
  function MediaGallery() {
    ...
    _this = _callSuper(this, MediaGallery, [].concat(args));
    _classPrivateFieldInitSpec(_this, _controller, new AbortController());
    /**
    ...
    _classPrivateFieldInitSpec(_this, _handleVariantUpdate, function (event) {
      var source = event.detail.data.html;
      if (!source) return;
      var newMediaGallery = source.querySelector('media-gallery');
      if (!newMediaGallery) return;
      _this.replaceWith(newMediaGallery);
    });
    /**
     * Handles the 'zoom-media:selected' event.
     * @param {ZoomMediaSelectedEvent} event - The zoom-media:selected event.
     */
    _classPrivateFieldInitSpec(_this, _handleZoomMediaSelected, /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(event) {
        var _this$slideshow;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              (_this$slideshow = _this.slideshow) === null || _this$slideshow === void 0 || _this$slideshow.select(event.detail.index, undefined, {
                animate: false
              });
            case 1:
              return _context.a(2);
  ...
  return _createClass(MediaGallery, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      var _this$refs$zoomDialog;
      _superPropGet(MediaGallery, "connectedCallback", this, 3)([]);
      var _classPrivateFieldGet2 = _classPrivateFieldGet(_controller, this),
        signal = _classPrivateFieldGet2.signal;
      var target = this.closest('.shopify-section, dialog');
      target === null || target === void 0 || target.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_1__.ThemeEvents.variantUpdate, _classPrivateFieldGet(_handleVariantUpdate, this), {
        signal: signal
      });
      (_this$refs$zoomDialog = this.refs.zoomDialogComponent) === null || _this$refs$zoomDialog === void 0 || _this$refs$zoomDialog.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_1__.ThemeEvents.zoomMediaSelected, _classPrivateFieldGet(_handleZoomMediaSelected, this), {
        signal: signal
      });
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(MediaGallery, "disconnectedCallback", this, 3)([]);
     ...
     */
    function zoom(index, event) {
      var _this$refs$zoomDialog2;
      (_this$refs$zoomDialog2 = this.refs.zoomDialogComponent) === null || _this$refs$zoomDialog2 === void 0 || _this$refs$zoomDialog2.open(index, event);
    }
  }, {
    key: "slideshow",
    get: function get() {
