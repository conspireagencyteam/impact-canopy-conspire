...
/***/ "./src/scripts/qr-code-generator.js":
/*!******************************************!*\
  !*** ./src/scripts/qr-code-generator.js ***!
  \******************************************/
...
QRCodeModel.prototype = {
  ...
  isDark: function isDark(row, col) {
    var _this$modules$row$col, _this$modules$row;
    ...
    return (_this$modules$row$col = (_this$modules$row = this.modules[row]) === null || _this$modules$row === void 0 ? void 0 : _this$modules$row[col]) !== null && _this$modules$row$col !== void 0 ? _this$modules$row$col : false;
  },
  ...
  setupPositionAdjustPattern: function setupPositionAdjustPattern() {
    ...
    for (var i = 0; i < pos.length; i++) {
      for (var j = 0; j < pos.length; j++) {
        var _this$modules$row2;
        var row = pos[i];
        var col = pos[j];
        if (row === undefined || col === undefined) continue;
        if (((_this$modules$row2 = this.modules[row]) === null || _this$modules$row2 === void 0 ? void 0 : _this$modules$row2[col]) != null) {
          continue;
        }
        for (var r = -2; r <= 2; r++) {
          var rowR = this.modules[row + r];
  ...
  mapData: function mapData(data, maskPattern) {
    ...
    for (var col = this.moduleCount - 1; col > 0; col -= 2) {
      ...
      while (true) {
        for (var c = 0; c < 2; c++) {
          var _this$modules$row3;
          if (((_this$modules$row3 = this.modules[row]) === null || _this$modules$row3 === void 0 ? void 0 : _this$modules$row3[col - c]) == null) {
            var dark = false;
...
var QRUtil = {
  ...
  getPatternPosition: function getPatternPosition(typeNumber) {
    var _QRUtil$PATTERN_POSIT;
    return (_QRUtil$PATTERN_POSIT = QRUtil.PATTERN_POSITION_TABLE[typeNumber - 1]) !== null && _QRUtil$PATTERN_POSIT !== void 0 ? _QRUtil$PATTERN_POSIT : [];
  },
  /**
   * @param {number} maskPattern
   * @param {number} i
...
QRBitBuffer.prototype = {
  ...
  get: function get(index) {
    ...
    var bufferAtIndex = this.buffer[bufIndex];
...
var Drawing = useSVG ? svgDrawer : !isSupportCanvas() ? function () {
  /**
   * @param {Element} el
   * @param {QRCodeOptions} htOption
   */
...
function getTypeNumber(sText, nCorrectLevel) {
  ...
  for (var i = 0, len = QRCodeLimitLength.length; i <= len; i++) {
    var QRCodeLimitLengthAtIndex = QRCodeLimitLength[i];
...
function getUTF8Length(sText) {
  ...
  var bomLength = replacedText.length !== sText.length ? 3 : 0;
...
function QRCode(el, vOption) {
   ...
   * @type {QRCodeOptions}
   */
  this._htOption = _objectSpread(_objectSpread({}, defaultOptions), typeof vOption === 'string' ? {
    text: vOption
  } : vOption);
  if (typeof el == 'string') {
    var element = document.getElementById(el);
    if (!element) {
      throw new Error("Element with id ".concat(el, " not found"));
    }
    el = element;
  }
...
(() => {
/*!**************************************!*\
  !*** ./src/scripts/qr-code-image.js ***!
  \**************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _theme_qr_code_generator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @theme/qr-code-generator */ "./src/scripts/qr-code-generator.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var _alt = /*#__PURE__*/new WeakMap();
var QRCodeImage = /*#__PURE__*/function (_HTMLElement) {
  function QRCodeImage() {
    ...
    _this = _callSuper(this, QRCodeImage, [].concat(args));
    /** @type {number} */
    _classPrivateFieldInitSpec(_this, _width, 72);
    /** @type {number} */
    _classPrivateFieldInitSpec(_this, _height, 72);
    /** @type {string} */
    _classPrivateFieldInitSpec(_this, _alt, '');
    return _this;
  }
  _inherits(QRCodeImage, _HTMLElement);
  return _createClass(QRCodeImage, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      var _this$getAttribute, _this$getAttribute2, _this$getAttribute3;
      var widthAttribute = (_this$getAttribute = this.getAttribute('width')) !== null && _this$getAttribute !== void 0 ? _this$getAttribute : '';
      _classPrivateFieldSet(_width, this, isNaN(parseInt(widthAttribute)) ? _classPrivateFieldGet(_width, this) : parseInt(widthAttribute));
      var heightAttribute = (_this$getAttribute2 = this.getAttribute('height')) !== null && _this$getAttribute2 !== void 0 ? _this$getAttribute2 : '';
      _classPrivateFieldSet(_height, this, isNaN(parseInt(heightAttribute)) ? _classPrivateFieldGet(_height, this) : parseInt(heightAttribute));
      _classPrivateFieldSet(_alt, this, (_this$getAttribute3 = this.getAttribute('alt')) !== null && _this$getAttribute3 !== void 0 ? _this$getAttribute3 : _classPrivateFieldGet(_alt, this));
      new _theme_qr_code_generator__WEBPACK_IMPORTED_MODULE_0__.QRCode(this, {
        text: this.getAttribute('data-identifier') || '',
        width: _classPrivateFieldGet(_width, this),
        height: _classPrivateFieldGet(_height, this),
        alt: _classPrivateFieldGet(_alt, this)
      });
    }
  }]);
