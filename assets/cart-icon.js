...
var CartIcon = /*#__PURE__*/function (_Component) {
  function CartIcon() {
    ...
    _this = _callSuper(this, CartIcon, [].concat(args));
    _defineProperty(_this, "requiredRefs", ['cartBubble', 'cartBubbleText', 'cartBubbleCount']);
    /**
     * Handles the cart update event.
     * @param {CartUpdateEvent} event - The cart update event.
     */
    _defineProperty(_this, "onCartUpdate", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(event) {
        var _event$detail$data$it, _event$detail$data, _event$detail$data2;
        var itemCount, comingFromProductForm;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              itemCount = (_event$detail$data$it = (_event$detail$data = event.detail.data) === null || _event$detail$data === void 0 ? void 0 : _event$detail$data.itemCount) !== null && _event$detail$data$it !== void 0 ? _event$detail$data$it : 0;
              comingFromProductForm = ((_event$detail$data2 = event.detail.data) === null || _event$detail$data2 === void 0 ? void 0 : _event$detail$data2.source) === 'product-form-component';
              _this.renderCartBubble(itemCount, comingFromProductForm);
            case 1:
              return _context.a(2);
          }
        }, _callee);
     ...
     */
    _defineProperty(_this, "renderCartBubble", /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(itemCount, comingFromProductForm) {
        var animate,
          _args2 = arguments;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              animate = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : true;
              // If the cart update is coming from the product form, we add to the current cart count, otherwise we set the new cart count

              _this.refs.cartBubbleCount.classList.toggle('hidden', itemCount === 0);
              _this.refs.cartBubble.classList.toggle('visually-hidden', itemCount === 0);
              _this.refs.cartBubble.classList.toggle('cart-bubble--animating', itemCount > 0 && animate);
              _this.currentCartCount = comingFromProductForm ? _this.currentCartCount + itemCount : itemCount;
              _this.classList.toggle('header-actions__cart-icon--has-cart', itemCount > 0);
              sessionStorage.setItem('cart-count', JSON.stringify({
                value: String(_this.currentCartCount),
                timestamp: Date.now()
              }));
              if (animate) {
                _context2.n = 1;
            ...
            case 1:
              _context2.n = 2;
              return (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.onAnimationEnd)(_this.refs.cartBubbleText);
            case 2:
              _this.refs.cartBubble.classList.remove('cart-bubble--animating');
            case 3:
              return _context2.a(2);
          }
        }, _callee2);
     ...
     */
    _defineProperty(_this, "ensureCartBubbleIsCorrect", function () {
      var sessionStorageCount = sessionStorage.getItem('cart-count');
      var visibleCount = _this.refs.cartBubbleCount.textContent;
      if (sessionStorageCount === visibleCount || sessionStorageCount === null) return;
      try {
        var _JSON$parse = JSON.parse(sessionStorageCount),
          value = _JSON$parse.value,
          timestamp = _JSON$parse.timestamp;
        if (Date.now() - timestamp < 10000) {
          var count = parseInt(value, 10);
          if (count >= 0) {
            _this.renderCartBubble(count, false, false);
          }
        }
      } catch (_) {
        // no-op
  ...
  return _createClass(CartIcon, [{
    ...
    get: /** @type {number} */
    function get() {
      var _this$refs$cartBubble;
      return parseInt((_this$refs$cartBubble = this.refs.cartBubbleCount.textContent) !== null && _this$refs$cartBubble !== void 0 ? _this$refs$cartBubble : '0', 10);
    },
    ...
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(CartIcon, "connectedCallback", this, 3)([]);
      document.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_2__.ThemeEvents.cartUpdate, this.onCartUpdate);
      this.ensureCartBubbleIsCorrect();
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(CartIcon, "disconnectedCallback", this, 3)([]);
      document.removeEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_2__.ThemeEvents.cartUpdate, this.onCartUpdate);
    }
  }]);
