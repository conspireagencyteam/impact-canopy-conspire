...
(() => {
/*!*************************************!*\
  !*** ./src/scripts/product-form.js ***!
  \*************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ADD_TO_CART_TEXT_ANIMATION_DURATION: () => (/* binding */ ADD_TO_CART_TEXT_ANIMATION_DURATION),
...
/* harmony import */ var _theme_performance__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @theme/performance */ "./src/scripts/performance.js");
/* harmony import */ var _theme_morph__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @theme/morph */ "./src/scripts/morph.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _wrapNativeSuper(t) { var r = "function" == typeof Map ? new Map() : void 0; return _wrapNativeSuper = function _wrapNativeSuper(t) { if (null === t || !_isNativeFunction(t)) return t; if ("function" != typeof t) throw new TypeError("Super expression must either be null or a function"); if (void 0 !== r) { if (r.has(t)) return r.get(t); r.set(t, Wrapper); } function Wrapper() { return _construct(t, arguments, _getPrototypeOf(this).constructor); } return Wrapper.prototype = Object.create(t.prototype, { constructor: { value: Wrapper, enumerable: !1, writable: !0, configurable: !0 } }), _setPrototypeOf(Wrapper, t); }, _wrapNativeSuper(t); }
function _construct(t, e, r) { if (_isNativeReflectConstruct()) return Reflect.construct.apply(null, arguments); var o = [null]; o.push.apply(o, e); var p = new (t.bind.apply(t, o))(); return r && _setPrototypeOf(p, r.prototype), p; }
function _isNativeFunction(t) { try { return -1 !== Function.toString.call(t).indexOf("[native code]"); } catch (n) { return "function" == typeof t; } }
 ...
 */
var _animationTimeout = /*#__PURE__*/new WeakMap();
var _cleanupTimeout = /*#__PURE__*/new WeakMap();
var _preloadImage = /*#__PURE__*/new WeakMap();
var _AddToCartComponent_brand = /*#__PURE__*/new WeakSet();
var AddToCartComponent = /*#__PURE__*/function (_Component) {
  function AddToCartComponent() {
    ...
    _this = _callSuper(this, AddToCartComponent, [].concat(args));
    /**
     * Animates the fly to cart animation.
     */
    _classPrivateMethodInitSpec(_this, _AddToCartComponent_brand);
    _defineProperty(_this, "requiredRefs", ['addToCartButton']);
    /** @type {number | undefined} */
    _classPrivateFieldInitSpec(_this, _animationTimeout, void 0);
    /** @type {number | undefined} */
    _classPrivateFieldInitSpec(_this, _cleanupTimeout, void 0);
    _classPrivateFieldInitSpec(_this, _preloadImage, function () {
      var image = _this.dataset.productVariantMedia;
      if (!image) return;
      (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.preloadImage)(image);
    });
    return _this;
  }
  _inherits(AddToCartComponent, _Component);
  return _createClass(AddToCartComponent, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(AddToCartComponent, "connectedCallback", this, 3)([]);
      this.addEventListener('pointerenter', _classPrivateFieldGet(_preloadImage, this));
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(AddToCartComponent, "disconnectedCallback", this, 3)([]);
      if (_classPrivateFieldGet(_animationTimeout, this)) clearTimeout(_classPrivateFieldGet(_animationTimeout, this));
      if (_classPrivateFieldGet(_cleanupTimeout, this)) clearTimeout(_classPrivateFieldGet(_cleanupTimeout, this));
      this.removeEventListener('pointerenter', _classPrivateFieldGet(_preloadImage, this));
    }
    ...
    value: function handleClick(event) {
      ...
      if (!(form !== null && form !== void 0 && form.checkValidity())) return;

      // Check if adding would exceed max before animating
      var quantitySelector = /** @type {any} */form.querySelector('quantity-selector-component');
      if (quantitySelector !== null && quantitySelector !== void 0 && quantitySelector.canAddToCart) {
        var validation = quantitySelector.canAddToCart();
      ...
      var animationEnabled = this.dataset.addToCartAnimation === 'true';
      if (animationEnabled && !event.target.closest('.quick-add-modal')) {
        _assertClassBrand(_AddToCartComponent_brand, this, _animateFlyToCart).call(this);
      }
    }
  }, {
    key: "animateAddToCart",
    value:
    /**
    ...
    function animateAddToCart() {
      var _this2 = this;
      var addToCartButton = this.refs.addToCartButton;
      if (_classPrivateFieldGet(_animationTimeout, this)) clearTimeout(_classPrivateFieldGet(_animationTimeout, this));
      if (_classPrivateFieldGet(_cleanupTimeout, this)) clearTimeout(_classPrivateFieldGet(_cleanupTimeout, this));
      if (!addToCartButton.classList.contains('atc-added')) {
        addToCartButton.classList.add('atc-added');
      }
      _classPrivateFieldSet(_animationTimeout, this, setTimeout(function () {
        _classPrivateFieldSet(_cleanupTimeout, _this2, setTimeout(function () {
          _this2.refs.addToCartButton.classList.remove('atc-added');
        }, 10));
      }, ADD_TO_CART_TEXT_ANIMATION_DURATION));
    }
  }]);
}(_theme_component__WEBPACK_IMPORTED_MODULE_0__.Component);
function _animateFlyToCart() {
  var addToCartButton = this.refs.addToCartButton;
  var cartIcon = document.querySelector('.header-actions__cart-icon');
  var image = this.dataset.productVariantMedia;
  if (!cartIcon || !addToCartButton || !image) return;
  var flyToCartElement = /** @type {FlyToCart} */document.createElement('fly-to-cart');
  flyToCartElement.style.setProperty('background-image', "url(".concat(image, ")"));
...
var _ProductFormComponent_brand = /*#__PURE__*/new WeakSet();
var _onCartUpdate = /*#__PURE__*/new WeakMap();
var _onVariantUpdate = /*#__PURE__*/new WeakMap();
var _onVariantSelected = /*#__PURE__*/new WeakMap();
var ProductFormComponent = /*#__PURE__*/function (_Component2) {
  function ProductFormComponent() {
    ...
    _this3 = _callSuper(this, ProductFormComponent, [].concat(args));
    /**
     ...
     */
    _classPrivateMethodInitSpec(_this3, _ProductFormComponent_brand);
    _defineProperty(_this3, "requiredRefs", ['variantId', 'liveRegion']);
    _classPrivateFieldInitSpec(_this3, _abortController, new AbortController());
    /** @type {number | undefined} */
    _classPrivateFieldInitSpec(_this3, _timeout, void 0);
    /**
     * Updates data-cart-quantity when cart is updated from elsewhere
     * @param {CartUpdateEvent|CartAddEvent} event
     */
    _classPrivateFieldInitSpec(_this3, _onCartUpdate, /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(event) {
        var _event$detail, _event$detail2;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              if (!(((_event$detail = event.detail) === null || _event$detail === void 0 ? void 0 : _event$detail.sourceId) === _this3.id || ((_event$detail2 = event.detail) === null || _event$detail2 === void 0 || (_event$detail2 = _event$detail2.data) === null || _event$detail2 === void 0 ? void 0 : _event$detail2.source) === 'product-form-component')) {
                _context.n = 1;
                break;
              }
              return _context.a(2);
            case 1:
              _context.n = 2;
              return _assertClassBrand(_ProductFormComponent_brand, _this3, _fetchAndUpdateCartQuantity).call(_this3);
            case 2:
              return _context.a(2);
          }
        }, _callee);
     ...
     */
    _classPrivateFieldInitSpec(_this3, _onVariantUpdate, /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(event) {
        var _event$detail$resourc, _event$detail$resourc2;
        var _this3$refs, variantId, addToCartButtonContainer, currentAddToCartButton, newAddToCartButton, _this3$refs$accelerat, _this3$refs$accelerat2, _event$detail$resourc3, productVariantMedia, quantitySelector, newQuantityInput, quantityRules, newQuantityRules, isQuantityRulesChanging, _quantitySelector$get, currentQuantityValue, currentProductFormButtons, newProductFormButtons, newQuantitySelector, newQuantityInputElement, quantityLabel, newQuantityLabel, addToCartButton;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              ...
              _this3.dataset.productId = event.detail.data.newProduct.id;
              _context2.n = 2;
              break;
            case 1:
              if (!(event.detail.data.productId !== _this3.dataset.productId)) {
                _context2.n = 2;
                break;
              }
              return _context2.a(2);
            case 2:
              _this3$refs = _this3.refs, variantId = _this3$refs.variantId, addToCartButtonContainer = _this3$refs.addToCartButtonContainer;
              currentAddToCartButton = addToCartButtonContainer === null || addToCartButtonContainer === void 0 ? void 0 : addToCartButtonContainer.refs.addToCartButton;
              newAddToCartButton = event.detail.data.html.querySelector('[ref="addToCartButton"]'); // Update the variant ID
              variantId.value = (_event$detail$resourc = (_event$detail$resourc2 = event.detail.resource) === null || _event$detail$resourc2 === void 0 ? void 0 : _event$detail$resourc2.id) !== null && _event$detail$resourc !== void 0 ? _event$detail$resourc : '';
              if (!(!currentAddToCartButton && !_this3.refs.acceleratedCheckoutButtonContainer)) {
                _context2.n = 3;
                break;
              }
              return _context2.a(2);
            case 3:
              ...
              if (currentAddToCartButton) {
                ...
                if (newAddToCartButton) {
                  (0,_theme_morph__WEBPACK_IMPORTED_MODULE_4__.morph)(currentAddToCartButton, newAddToCartButton);
                }
              }
              if (_this3.refs.acceleratedCheckoutButtonContainer) {
                if (event.detail.resource == null || event.detail.resource.available == false) {
                  (_this3$refs$accelerat = _this3.refs.acceleratedCheckoutButtonContainer) === null || _this3$refs$accelerat === void 0 || _this3$refs$accelerat.setAttribute('hidden', 'true');
                } else {
                  (_this3$refs$accelerat2 = _this3.refs.acceleratedCheckoutButtonContainer) === null || _this3$refs$accelerat2 === void 0 || _this3$refs$accelerat2.removeAttribute('hidden');
                }
              }

              // Set the data attribute for the add to cart button to the product variant media if it exists
              if (event.detail.resource) {
                productVariantMedia = (_event$detail$resourc3 = event.detail.resource.featured_media) === null || _event$detail$resourc3 === void 0 || (_event$detail$resourc3 = _event$detail$resourc3.preview_image) === null || _event$detail$resourc3 === void 0 ? void 0 : _event$detail$resourc3.src;
                productVariantMedia && (addToCartButtonContainer === null || addToCartButtonContainer === void 0 ? void 0 : addToCartButtonContainer.setAttribute('data-product-variant-media', productVariantMedia + '&width=100'));
              }

              // Update quantity selector's min/max/step attributes and cart quantity for the new variant
              quantitySelector = /** @type {any} */_this3.querySelector('quantity-selector-component');
              newQuantityInput = /** @type {HTMLInputElement | null} */
              event.detail.data.html.querySelector('quantity-selector-component input[ref="quantityInput"]');
              if (quantitySelector !== null && quantitySelector !== void 0 && quantitySelector.updateConstraints && newQuantityInput) {
              ...
              quantityRules = _this3.refs.quantityRules;
              newQuantityRules = event.detail.data.html.querySelector('.quantity-rules');
              ...
              if (isQuantityRulesChanging && quantitySelector) {
                ...
                currentQuantityValue = (_quantitySelector$get = quantitySelector.getValue) === null || _quantitySelector$get === void 0 ? void 0 : _quantitySelector$get.call(quantitySelector);
                currentProductFormButtons = _this3.refs.productFormButtons;
                newProductFormButtons = event.detail.data.html.querySelector('.product-form-buttons');
                if (currentProductFormButtons && newProductFormButtons) {
                  (0,_theme_morph__WEBPACK_IMPORTED_MODULE_4__.morph)(currentProductFormButtons, newProductFormButtons);

                  // Get the NEW quantity selector after morphing and update its constraints
                  newQuantitySelector = /** @type {any} */_this3.querySelector('quantity-selector-component');
                  newQuantityInputElement = /** @type {HTMLInputElement | null} */
                  event.detail.data.html.querySelector('quantity-selector-component input[ref="quantityInput"]');
                  if (newQuantitySelector !== null && newQuantitySelector !== void 0 && newQuantitySelector.updateConstraints && newQuantityInputElement && currentQuantityValue) {
                    ...
                    newQuantitySelector.updateConstraints(newQuantityInputElement.min, newQuantityInputElement.max || null, newQuantityInputElement.step);
                  }
                }
              } else {
                // Update elements individually when layout isn't changing
                quantityLabel = _this3.querySelector('.quantity-label');
                newQuantityLabel = event.detail.data.html.querySelector('.quantity-label');
                _assertClassBrand(_ProductFormComponent_brand, _this3, _morphOrUpdateElement).call(_this3, quantityLabel, newQuantityLabel, quantitySelector);
                addToCartButton = _this3.querySelector('[ref="addToCartButtonContainer"]');
                _assertClassBrand(_ProductFormComponent_brand, _this3, _morphOrUpdateElement).call(_this3, quantityRules, newQuantityRules, addToCartButton);
              }
     ...
     */
    _classPrivateFieldInitSpec(_this3, _onVariantSelected, function () {
      var _this3$refs$addToCart;
      (_this3$refs$addToCart = _this3.refs.addToCartButtonContainer) === null || _this3$refs$addToCart === void 0 || _this3$refs$addToCart.disable();
    });
    return _this3;
  }
  _inherits(ProductFormComponent, _Component2);
  return _createClass(ProductFormComponent, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(ProductFormComponent, "connectedCallback", this, 3)([]);
      var _classPrivateFieldGet2 = _classPrivateFieldGet(_abortController, this),
        signal = _classPrivateFieldGet2.signal;
      var target = this.closest('.shopify-section, dialog, product-card');
      target === null || target === void 0 || target.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_2__.ThemeEvents.variantUpdate, _classPrivateFieldGet(_onVariantUpdate, this), {
        signal: signal
      });
      target === null || target === void 0 || target.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_2__.ThemeEvents.variantSelected, _classPrivateFieldGet(_onVariantSelected, this), {
        signal: signal
      });

      // Listen for cart updates to sync data-cart-quantity
      document.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_2__.ThemeEvents.cartUpdate, _classPrivateFieldGet(_onCartUpdate, this), {
        signal: signal
      });
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(ProductFormComponent, "disconnectedCallback", this, 3)([]);
    ...
    function handleSubmit(event) {
      var _addToCartButtonConta,
        _this4 = this;
      var _this$refs = this.refs,
        addToCartTextError = _this$refs.addToCartTextError,
        addToCartButtonContainer = _this$refs.addToCartButtonContainer;
      // Stop default behaviour from the browser
      event.preventDefault();
      if (_classPrivateFieldGet(_timeout, this)) clearTimeout(_classPrivateFieldGet(_timeout, this));

      // Check if the add to cart button is disabled and do an early return if it is
      if (addToCartButtonContainer !== null && addToCartButtonContainer !== void 0 && (_addToCartButtonConta = addToCartButtonContainer.refs.addToCartButton) !== null && _addToCartButtonConta !== void 0 && _addToCartButtonConta.disabled) return;

      // Send the add to cart information to the cart
      var form = this.querySelector('form');
      if (!form) throw new Error('Product form element missing');
      var quantitySelector = /** @type {any} */this.querySelector('quantity-selector-component');
      if (quantitySelector !== null && quantitySelector !== void 0 && quantitySelector.canAddToCart) {
        var validation = quantitySelector.canAddToCart();
        if (!validation.canAdd) {
          addToCartButtonContainer === null || addToCartButtonContainer === void 0 || addToCartButtonContainer.disable();
          var errorTemplate = this.dataset.quantityErrorMax || '';
          var errorMessage = errorTemplate.replace('{{ maximum }}', validation.maxQuantity.toString());
          if (addToCartTextError) {
            addToCartTextError.classList.remove('hidden');
            var textNode = addToCartTextError.childNodes[2];
            if (textNode) {
              textNode.textContent = errorMessage;
            } else {
              var newTextNode = document.createTextNode(errorMessage);
              addToCartTextError.appendChild(newTextNode);
            }
            _assertClassBrand(_ProductFormComponent_brand, this, _setLiveRegionText).call(this, errorMessage);
            if (_classPrivateFieldGet(_timeout, this)) clearTimeout(_classPrivateFieldGet(_timeout, this));
            _classPrivateFieldSet(_timeout, this, setTimeout(function () {
              if (!addToCartTextError) return;
              addToCartTextError.classList.add('hidden');
              _assertClassBrand(_ProductFormComponent_brand, _this4, _clearLiveRegionText).call(_this4);
            }, ERROR_MESSAGE_DISPLAY_DURATION));
          }
          setTimeout(function () {
            addToCartButtonContainer === null || addToCartButtonContainer === void 0 || addToCartButtonContainer.enable();
      ...
      var fetchCfg = (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.fetchConfig)('javascript', {
        body: formData
      });
      fetch(Theme.routes.cart_add_url, _objectSpread(_objectSpread({}, fetchCfg), {}, {
        headers: _objectSpread(_objectSpread({}, fetchCfg.headers), {}, {
          Accept: 'text/html'
        })
        ...
        if (response.status) {
          _this4.dispatchEvent(new _theme_events__WEBPACK_IMPORTED_MODULE_2__.CartErrorEvent(form.getAttribute('id') || '', response.message, response.description, response.errors));
          if (!addToCartTextError) return;
          addToCartTextError.classList.remove('hidden');

          // Reuse the text node if the user is spam-clicking
          var _textNode = addToCartTextError.childNodes[2];
          if (_textNode) {
            _textNode.textContent = response.message;
          } else {
            var _newTextNode = document.createTextNode(response.message);
            addToCartTextError.appendChild(_newTextNode);
          }

          // Create or get existing error live region for screen readers
          _assertClassBrand(_ProductFormComponent_brand, _this4, _setLiveRegionText).call(_this4, response.message);
          _classPrivateFieldSet(_timeout, _this4, setTimeout(function () {
            if (!addToCartTextError) return;
            addToCartTextError.classList.add('hidden');
          ...
          _this4.dispatchEvent(new _theme_events__WEBPACK_IMPORTED_MODULE_2__.CartAddEvent({}, _this4.id, {
            didError: true,
            source: 'product-form-component',
            itemCount: Number(formData.get('quantity')) || Number(_this4.dataset.quantityDefault),
            productId: _this4.dataset.productId
          }));
          return;
        } else {
          var _this4$refs$addToCart;
          ...
          if ((_this4$refs$addToCart = _this4.refs.addToCartButtonContainer) !== null && _this4$refs$addToCart !== void 0 && _this4$refs$addToCart.refs.addToCartButton) {
            var _addedTextElement$tex;
            var addToCartButton = _this4.refs.addToCartButtonContainer.refs.addToCartButton;
            var addedTextElement = addToCartButton.querySelector('.add-to-cart-text--added');
            var addedText = (addedTextElement === null || addedTextElement === void 0 || (_addedTextElement$tex = addedTextElement.textContent) === null || _addedTextElement$tex === void 0 ? void 0 : _addedTextElement$tex.trim()) || Theme.translations.added;
            _assertClassBrand(_ProductFormComponent_brand, _this4, _setLiveRegionText).call(_this4, addedText);
            setTimeout(function () {
              _assertClassBrand(_ProductFormComponent_brand, _this4, _clearLiveRegionText).call(_this4);
          ...
          _assertClassBrand(_ProductFormComponent_brand, _this4, _fetchAndUpdateCartQuantity).call(_this4);
          _this4.dispatchEvent(new _theme_events__WEBPACK_IMPORTED_MODULE_2__.CartAddEvent({}, id.toString(), {
            source: 'product-form-component',
            itemCount: Number(formData.get('quantity')) || Number(_this4.dataset.quantityDefault),
            productId: _this4.dataset.productId,
        ...
        _theme_performance__WEBPACK_IMPORTED_MODULE_3__.cartPerformance.measureFromEvent('add:user-action', event);
      });
    }
...
function _fetchAndUpdateCartQuantity() {
  return _fetchAndUpdateCartQuantity2.apply(this, arguments);
}
function _fetchAndUpdateCartQuantity2() {
  _fetchAndUpdateCartQuantity2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
    var variantIdInput, response, cart, cartItem, cartQty, quantitySelector, _t;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          variantIdInput = /** @type {HTMLInputElement | null} */this.querySelector('input[name="id"]');
          if (variantIdInput !== null && variantIdInput !== void 0 && variantIdInput.value) {
            _context3.n = 1;
            break;
          }
        ...
        case 3:
          cart = _context3.v;
          cartItem = cart.items.find(/** @param {any} item */
          function (item) {
            return item.variant_id.toString() === variantIdInput.value.toString();
          });
          cartQty = cartItem ? cartItem.quantity : 0; // Use public API to update quantity selector
          quantitySelector = /** @type {any} */this.querySelector('quantity-selector-component');
          if (quantitySelector !== null && quantitySelector !== void 0 && quantitySelector.setCartQuantity) {
            quantitySelector.setCartQuantity(cartQty);
          }

          // Update quantity label if it exists
          _assertClassBrand(_ProductFormComponent_brand, this, _updateQuantityLabel).call(this, cartQty);
          return _context3.a(2, cartQty);
        case 4:
          _context3.p = 4;
          _t = _context3.v;
          console.error('Failed to fetch cart quantity:', _t);
          return _context3.a(2, 0);
      }
    }, _callee3, this, [[1, 4]]);
  }));
...
function _updateQuantityLabel(cartQty) {
  var quantityLabel = this.refs.quantityLabelCartCount;
  if (quantityLabel) {
    var _quantityLabel$textCo;
    var inCartText = (_quantityLabel$textCo = quantityLabel.textContent) === null || _quantityLabel$textCo === void 0 ? void 0 : _quantityLabel$textCo.match(/\((\d+)\s+(.+)\)/);
    if (inCartText && inCartText[2]) {
      quantityLabel.textContent = "(".concat(cartQty, " ").concat(inCartText[2], ")");
    }
 ...
 * @param {*} text
 */
function _setLiveRegionText(text) {
  var liveRegion = this.refs.liveRegion;
  liveRegion.textContent = text;
}
function _clearLiveRegionText() {
  var liveRegion = this.refs.liveRegion;
 ...
 */
function _morphOrUpdateElement(currentElement, newElement) {
  var insertReferenceElement = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  if (currentElement && newElement) {
    (0,_theme_morph__WEBPACK_IMPORTED_MODULE_4__.morph)(currentElement, newElement);
...
var _FlyToCart_brand = /*#__PURE__*/new WeakSet();
var FlyToCart = /*#__PURE__*/function (_HTMLElement) {
  function FlyToCart() {
    var _this5;
    ...
    _this5 = _callSuper(this, FlyToCart, [].concat(args));
    _classPrivateMethodInitSpec(_this5, _FlyToCart_brand);
    /** @type {Element} */
    _defineProperty(_this5, "source", void 0);
    /** @type {Element} */
    _defineProperty(_this5, "destination", void 0);
    return _this5;
  }
  _inherits(FlyToCart, _HTMLElement);
  return _createClass(FlyToCart, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _assertClassBrand(_FlyToCart_brand, this, _animate).call(this);
    }
  }]);
}(/*#__PURE__*/_wrapNativeSuper(HTMLElement));
/**
...
function _animate() {
  ...
  var destinationRect = this.destination.getBoundingClientRect();
  ...
  var _animate2 = function animate(currentTime) {
    ...
    var position = bezierPoint(progress, startPoint, controlPoint1, controlPoint2, endPoint);

    //Update the position of the flying thingy
    _this6.style.setProperty('--x', "".concat(position.x, "px"));
    _this6.style.setProperty('--y', "".concat(position.y, "px"));

    // Scale down as it approaches the cart
    var scale = 1 - progress * 0.5;
    _this6.style.setProperty('--scale', "".concat(scale));
    ...
    if (progress < 1) {
      ...
      _this6.style.opacity = '0';
      (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.onAnimationEnd)(_this6, function () {
  ...
  this.style.setProperty('--x', "".concat(startPoint.x, "px"));
  this.style.setProperty('--y', "".concat(startPoint.y, "px"));
