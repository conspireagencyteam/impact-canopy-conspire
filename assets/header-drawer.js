...
/* harmony import */ var _theme_focus__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @theme/focus */ "./src/scripts/focus.js");
 ...
 */
var _onKeyUp = /*#__PURE__*/new WeakMap();
var _HeaderDrawer_brand = /*#__PURE__*/new WeakSet();
var HeaderDrawer = /*#__PURE__*/function (_Component) {
  function HeaderDrawer() {
    ...
    _this = _callSuper(this, HeaderDrawer, [].concat(args));
    /**
     * Get the closest details element to the event target
     * @param {Event | undefined} event
     * @returns {HTMLDetailsElement}
     */
    _classPrivateMethodInitSpec(_this, _HeaderDrawer_brand);
    _defineProperty(_this, "requiredRefs", ['details']);
    /**
     * Close the main menu drawer when the Escape key is pressed
     * @param {KeyboardEvent} event
     */
    _classPrivateFieldInitSpec(_this, _onKeyUp, function (event) {
      if (event.key !== 'Escape') return;
      _assertClassBrand(_HeaderDrawer_brand, _this, _close).call(_this, _assertClassBrand(_HeaderDrawer_brand, _this, _getDetailsElement).call(_this, event));
    });
    return _this;
  }
  _inherits(HeaderDrawer, _Component);
  return _createClass(HeaderDrawer, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(HeaderDrawer, "connectedCallback", this, 3)([]);
      this.addEventListener('keyup', _classPrivateFieldGet(_onKeyUp, this));
      _assertClassBrand(_HeaderDrawer_brand, this, _setupAnimatedElementListeners).call(this);
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(HeaderDrawer, "disconnectedCallback", this, 3)([]);
      this.removeEventListener('keyup', _classPrivateFieldGet(_onKeyUp, this));
    }
  }, {
    key: "isOpen",
    get:
    ...
    value: function open(event) {
      var details = _assertClassBrand(_HeaderDrawer_brand, this, _getDetailsElement).call(this, event);
      ...
      requestAnimationFrame(function () {
        ...
        setTimeout(function () {
          (0,_theme_focus__WEBPACK_IMPORTED_MODULE_1__.trapFocus)(details);
        }, 0);
      });
    }
    ...
    value: function back(event) {
      _assertClassBrand(_HeaderDrawer_brand, this, _close).call(this, _assertClassBrand(_HeaderDrawer_brand, this, _getDetailsElement).call(this, event));
    }
    ...
    value: function close() {
      _assertClassBrand(_HeaderDrawer_brand, this, _close).call(this, this.refs.details);
    }
    ...
    key: "preventInitialAccordionAnimations",
    value:
    /**
     ...
     */
    function preventInitialAccordionAnimations(details) {
      var content = details.querySelectorAll('accordion-custom .details-content');
...
function _getDetailsElement(event) {
  var _event$target$closest;
  if (!((event === null || event === void 0 ? void 0 : event.target) instanceof Element)) return this.refs.details;
  return (_event$target$closest = event.target.closest('details')) !== null && _event$target$closest !== void 0 ? _event$target$closest : this.refs.details;
}
function _close(details) {
  var _this2 = this;
  var summary = details.querySelector('summary');
  if (!summary) return;
  summary.setAttribute('aria-expanded', 'false');
  details.classList.remove('menu-open');
  (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_2__.onAnimationEnd)(details, function () {
    reset(details);
    if (details === _this2.refs.details) {
      (0,_theme_focus__WEBPACK_IMPORTED_MODULE_1__.removeTrapFocus)();
      var openDetails = _this2.querySelectorAll('details[open]:not(accordion-custom > details)');
      openDetails.forEach(reset);
    } else {
      setTimeout(function () {
        (0,_theme_focus__WEBPACK_IMPORTED_MODULE_1__.trapFocus)(_this2.refs.details);
      }, 0);
    }
  });
}
 ...
 */
function _setupAnimatedElementListeners() {
  /**
  ...
  var allAnimated = this.querySelectorAll('.menu-drawer__animated-element');
  allAnimated.forEach(function (element) {
...
function reset(element) {
  ...
  (_element$querySelecto = element.querySelector('summary')) === null || _element$querySelecto === void 0 || _element$querySelecto.setAttribute('aria-expanded', 'false');
}
})();
