...
/* harmony import */ var _theme_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @theme/dialog */ "./src/scripts/dialog.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i.return) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } r ? i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n : (o("next", 0), o("throw", 1), o("return", 2)); }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
...
var DeferredMedia = /*#__PURE__*/function (_Component) {
  function DeferredMedia() {
    ...
    _this = _callSuper(this, DeferredMedia, [].concat(args));
    /** @type {boolean} */
    _defineProperty(_this, "isPlaying", false);
    _classPrivateFieldInitSpec(_this, _abortController, new AbortController());
    /**
     * Shows the deferred media content
     */
    _defineProperty(_this, "showDeferredMedia", function () {
      _this.loadContent(true);
      _this.isPlaying = true;
      _this.updatePlayPauseHint(_this.isPlaying);
    });
    return _this;
  }
  _inherits(DeferredMedia, _Component);
  return _createClass(DeferredMedia, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(DeferredMedia, "connectedCallback", this, 3)([]);
      var signal = _classPrivateFieldGet(_abortController, this).signal;
      // If we're to use deferred media for images, we will need to run this only when it's not an image type media
      document.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_1__.ThemeEvents.mediaStartedPlaying, this.pauseMedia.bind(this), {
        signal: signal
      });
      window.addEventListener(_theme_dialog__WEBPACK_IMPORTED_MODULE_2__.DialogCloseEvent.eventName, this.pauseMedia.bind(this), {
        signal: signal
      });
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(DeferredMedia, "disconnectedCallback", this, 3)([]);
    ...
    key: "updatePlayPauseHint",
    value: function updatePlayPauseHint(isPlaying) {
      var toggleMediaButton = this.refs.toggleMediaButton;
      if (toggleMediaButton instanceof HTMLElement) {
        toggleMediaButton.classList.remove('hidden');
        var playIcon = toggleMediaButton.querySelector('.icon-play');
        if (playIcon) playIcon.classList.toggle('hidden', isPlaying);
        var pauseIcon = toggleMediaButton.querySelector('.icon-pause');
    ...
    function loadContent() {
      var _this$querySelector, _this$refs$deferredMe;
      var focus = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      if (this.getAttribute('data-media-loaded')) return;
      this.dispatchEvent(new _theme_events__WEBPACK_IMPORTED_MODULE_1__.MediaStartedPlayingEvent(this));
      var content = (_this$querySelector = this.querySelector('template')) === null || _this$querySelector === void 0 || (_this$querySelector = _this$querySelector.content.firstElementChild) === null || _this$querySelector === void 0 ? void 0 : _this$querySelector.cloneNode(true);
      if (!content) return;
      ...
      (_this$refs$deferredMe = this.refs.deferredMediaPlayButton) === null || _this$refs$deferredMe === void 0 || _this$refs$deferredMe.classList.add('deferred-media__playing');
    ...
    value: function playMedia() {
      ...
      var iframe = this.querySelector('iframe[data-video-type]');
      if (iframe) {
        var _iframe$contentWindow;
        (_iframe$contentWindow = iframe.contentWindow) === null || _iframe$contentWindow === void 0 || _iframe$contentWindow.postMessage(iframe.dataset.videoType === 'youtube' ? '{"event":"command","func":"playVideo","args":""}' : '{"method":"play"}', '*');
      } else {
        var _this$querySelector2;
        (_this$querySelector2 = this.querySelector('video')) === null || _this$querySelector2 === void 0 || _this$querySelector2.play();
      }
      this.isPlaying = true;
    ...
    value: function pauseMedia() {
      ...
      if (iframe) {
        ...
        (_iframe$contentWindow2 = iframe.contentWindow) === null || _iframe$contentWindow2 === void 0 || _iframe$contentWindow2.postMessage(iframe.dataset.videoType === 'youtube' ? '{"event":"command","func":"' + 'pauseVideo' + '","args":""}' : '{"method":"pause"}', '*');
      } else {
        var _this$querySelector3;
        (_this$querySelector3 = this.querySelector('video')) === null || _this$querySelector3 === void 0 || _this$querySelector3.pause();
      }
...
var _ProductModel_brand = /*#__PURE__*/new WeakSet();
var ProductModel = /*#__PURE__*/function (_DeferredMedia2) {
  function ProductModel() {
    ...
    _this2 = _callSuper(this, ProductModel, [].concat(args));
    /**
     ...
     */
    _classPrivateMethodInitSpec(_this2, _ProductModel_brand);
    _classPrivateFieldInitSpec(_this2, _abortController2, new AbortController());
    return _this2;
  }
  _inherits(ProductModel, _DeferredMedia2);
  return _createClass(ProductModel, [{
    ...
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(ProductModel, "disconnectedCallback", this, 3)([]);
    ...
    value: function pauseMedia() {
      ...
      _superPropGet(ProductModel, "pauseMedia", this, 3)([]);
      (_this$modelViewerUI = this.modelViewerUI) === null || _this$modelViewerUI === void 0 || _this$modelViewerUI.pause();
    }
  }, {
    key: "playMedia",
    value: function playMedia() {
      var _this$modelViewerUI2;
      _superPropGet(ProductModel, "playMedia", this, 3)([]);
      (_this$modelViewerUI2 = this.modelViewerUI) === null || _this$modelViewerUI2 === void 0 || _this$modelViewerUI2.play();
    }
    ...
    value: (function () {
      var _setupModelViewerUI = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(errors) {
        var _this3 = this;
        var element, signal, pointerStartX, pointerStartY;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              if (!errors) {
            ...
            case 1:
              ...
              _context.n = 2;
              return _assertClassBrand(_ProductModel_brand, this, _waitForModelViewerUI).call(this);
            case 2:
              if (Shopify.ModelViewerUI) {
                _context.n = 3;
                break;
              ...
              return _context.a(2);
            case 3:
              element = this.querySelector('model-viewer');
              if (element) {
                _context.n = 4;
                break;
              }
            ...
            case 5:
              ...
              pointerStartX = 0;
              pointerStartY = 0;
              element.addEventListener('pointerdown', function (/** @type {PointerEvent} */event) {
                pointerStartX = event.clientX;
                pointerStartY = event.clientY;
              }, {
                signal: signal
              });
              element.addEventListener('click', function (/** @type {PointerEvent} */event) {
                var distanceX = Math.abs(event.clientX - pointerStartX);
                var distanceY = Math.abs(event.clientY - pointerStartY);
      ...
      function setupModelViewerUI(_x) {
        return _setupModelViewerUI.apply(this, arguments);
      }
      return setupModelViewerUI;
    }())
  }]);
}(DeferredMedia);
function _waitForModelViewerUI() {
  return _waitForModelViewerUI2.apply(this, arguments);
}
function _waitForModelViewerUI2() {
  _waitForModelViewerUI2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
    var maxAttempts, interval, i;
    return _regenerator().w(function (_context2) {
