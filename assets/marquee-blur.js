 ...
 */
var _originalItems = /*#__PURE__*/new WeakMap();
var _MarqueeBlurComponent_brand = /*#__PURE__*/new WeakSet();
var _animation = /*#__PURE__*/new WeakMap();
var _slowDown = /*#__PURE__*/new WeakMap();
var _handleResize = /*#__PURE__*/new WeakMap();
var MarqueeBlurComponent = /*#__PURE__*/function (_Component) {
  function MarqueeBlurComponent() {
    var _this;
    _classCallCheck(this, MarqueeBlurComponent);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, MarqueeBlurComponent, [].concat(args));
    /**
     * Get current column count based on viewport
     * @returns {number}
     */
    _classPrivateMethodInitSpec(_this, _MarqueeBlurComponent_brand);
    _defineProperty(_this, "requiredRefs", ['wrapper', 'content', 'marqueeItems']);
    /** @type {HTMLElement[]} */
    _classPrivateFieldInitSpec(_this, _originalItems, []);
    /**
    ...
    _classPrivateFieldInitSpec(_this, _handleResize, (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.debounce)(function () {
      ...
      _assertClassBrand(_MarqueeBlurComponent_brand, _this, _fillColumnsWithItems).call(_this);
      _assertClassBrand(_MarqueeBlurComponent_brand, _this, _duplicateContent).call(_this);
      _assertClassBrand(_MarqueeBlurComponent_brand, _this, _setSpeed).call(_this);
      _assertClassBrand(_MarqueeBlurComponent_brand, _this, _restartAnimation).call(_this);
    }, 250));
    return _this;
  }
  _inherits(MarqueeBlurComponent, _Component);
  return _createClass(MarqueeBlurComponent, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(MarqueeBlurComponent, "connectedCallback", this, 3)([]);
      var marqueeItems = this.refs.marqueeItems;
      if (!marqueeItems) return;

      // Store original items before any manipulation
      _classPrivateFieldSet(_originalItems, this, Array.from(marqueeItems.children));
      if (_classPrivateFieldGet(_originalItems, this).length === 0) return;
      _assertClassBrand(_MarqueeBlurComponent_brand, this, _fillColumnsWithItems).call(this);
      _assertClassBrand(_MarqueeBlurComponent_brand, this, _duplicateContent).call(this);
      _assertClassBrand(_MarqueeBlurComponent_brand, this, _setSpeed).call(this);
      ...
      this.addEventListener('pointerleave', _assertClassBrand(_MarqueeBlurComponent_brand, this, _speedUp));
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(MarqueeBlurComponent, "disconnectedCallback", this, 3)([]);
      ...
      this.removeEventListener('pointerleave', _assertClassBrand(_MarqueeBlurComponent_brand, this, _speedUp));
    }
  }, {
    key: "clonedContent",
    get: function get() {
...
function _getColumnCount() {
  ...
  var columnsDesktop = Number(this.getAttribute('data-columns-desktop')) || 8;
  var columnsMobile = Number(this.getAttribute('data-columns-mobile')) || 3;
 ...
 */
function _fillColumnsWithItems() {
  var marqueeItems = this.refs.marqueeItems;
  if (!marqueeItems || _classPrivateFieldGet(_originalItems, this).length === 0) return;
  var columnCount = _assertClassBrand(_MarqueeBlurComponent_brand, this, _getColumnCount).call(this);
  var originalCount = _classPrivateFieldGet(_originalItems, this).length;
  ...
  for (var i = 0; i < targetCount; i++) {
    var originalIndex = i % originalCount;
    var clone = _classPrivateFieldGet(_originalItems, this)[originalIndex].cloneNode(true);
...
function _setSpeed() {
  var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _assertClassBrand(_MarqueeBlurComponent_brand, this, _calculateSpeed).call(this);
  this.style.setProperty('--marquee-speed', "".concat(value, "s"));
}
function _calculateSpeed() {
  var speedFactor = Number(this.getAttribute('data-speed-factor')) || 25;
  var columnCount = _assertClassBrand(_MarqueeBlurComponent_brand, this, _getColumnCount).call(this);
  // Speed based on number of columns - more columns = slower
  var speed = Math.sqrt(columnCount) * speedFactor;
  return speed;
}
...
function _duplicateContent() {
  ...
  var clone = /** @type {HTMLElement} */content.cloneNode(true);
