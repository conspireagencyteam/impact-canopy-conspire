...
(() => {
/*!*****************************************!*\
  !*** ./src/scripts/video-background.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   VideoBackgroundComponent: () => (/* binding */ VideoBackgroundComponent)
/* harmony export */ });
 ...
 */
var VideoBackgroundComponent = /*#__PURE__*/function (_Component) {
  function VideoBackgroundComponent() {
    var _this;
    _classCallCheck(this, VideoBackgroundComponent);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, VideoBackgroundComponent, [].concat(args));
    _defineProperty(_this, "requiredRefs", ['videoSources', 'videoElement']);
    return _this;
  }
  _inherits(VideoBackgroundComponent, _Component);
  return _createClass(VideoBackgroundComponent, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(VideoBackgroundComponent, "connectedCallback", this, 3)([]);
      var _this$refs = this.refs,
        videoSources = _this$refs.videoSources,
        videoElement = _this$refs.videoElement;
      var _iterator = _createForOfIteratorHelper(videoSources),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var source = _step.value;
          var videoSource = source.dataset.videoSource;
