 ...
 */
var _expanded = /*#__PURE__*/new WeakMap();
var _disableOnDesktop = /*#__PURE__*/new WeakMap();
var _collapsedHeight = /*#__PURE__*/new WeakMap();
var _disabledClass = /*#__PURE__*/new WeakMap();
var _ShowMoreComponent_brand = /*#__PURE__*/new WeakSet();
var _animation = /*#__PURE__*/new WeakMap();
var _animationSpeed = /*#__PURE__*/new WeakMap();
var _updateBreakpointState = /*#__PURE__*/new WeakMap();
var _expand = /*#__PURE__*/new WeakMap();
var _collapse = /*#__PURE__*/new WeakMap();
var _animateHeight = /*#__PURE__*/new WeakMap();
var ShowMoreComponent = /*#__PURE__*/function (_Component) {
  function ShowMoreComponent() {
    ...
    _this2 = _callSuper(this, ShowMoreComponent, [].concat(args));
    /**
     * @type {'MOBILE' | 'DESKTOP'}
     */
    _classPrivateMethodInitSpec(_this2, _ShowMoreComponent_brand);
    _defineProperty(_this2, "requiredRefs", ['showMoreButton', 'showMoreItems', 'showMoreContent']);
    /**
     * @type {boolean}
     */
    _classPrivateFieldInitSpec(_this2, _expanded, false);
    /**
     * @type {boolean}
     */
    _classPrivateFieldInitSpec(_this2, _disableOnDesktop, false);
    /**
     * @type {number}
     */
    _classPrivateFieldInitSpec(_this2, _collapsedHeight, 0);
    /**
     * @type {'mobile:hidden' | 'hidden'}
     */
    _classPrivateFieldInitSpec(_this2, _disabledClass, 'hidden');
    /**
     * @type {Animation | undefined}
     */
    _classPrivateFieldInitSpec(_this2, _animation, void 0);
    /**
     * @constant {number}
     */
    _classPrivateFieldInitSpec(_this2, _animationSpeed, 300);
    /**
     * Updates the current breakpoint and apprpropriate disabled class
     */
    _classPrivateFieldInitSpec(_this2, _updateBreakpointState, function () {
      _classPrivateFieldSet(_disableOnDesktop, _this2, _this2.dataset.disableOnDesktop === 'true');
      _classPrivateFieldSet(_disabledClass, _this2, _classPrivateFieldGet(_disableOnDesktop, _this2) ? 'mobile:hidden' : 'hidden');
    });
    /**
     * Handles expanding the content
     * @returns {{startHeight: number, endHeight: number}}
     */
    _classPrivateFieldInitSpec(_this2, _expand, function () {
      var _this2$refs = _this2.refs,
        showMoreItems = _this2$refs.showMoreItems,
        showMoreContent = _this2$refs.showMoreContent;
      _classPrivateFieldSet(_collapsedHeight, _this2, showMoreContent.offsetHeight);
      var startHeight = _classPrivateFieldGet(_collapsedHeight, _this2);
      showMoreItems === null || showMoreItems === void 0 || showMoreItems.forEach(function (item) {
        return item.classList.remove(_classPrivateFieldGet(_disabledClass, _this2));
      });
      return {
     ...
     * @returns {{startHeight: number, endHeight: number}}
     */
    _classPrivateFieldInitSpec(_this2, _collapse, function () {
      var showMoreContent = _this2.refs.showMoreContent;
      var startHeight = showMoreContent.offsetHeight;
      var endHeight = _classPrivateFieldGet(_collapsedHeight, _this2);
      return {
        startHeight: startHeight,
        endHeight: endHeight
      };
     ...
     */
    _classPrivateFieldInitSpec(_this2, _animateHeight, function (startHeight, endHeight) {
      var _classPrivateFieldGet2;
      var showMoreContent = _this2.refs.showMoreContent;
      showMoreContent.style.overflow = 'hidden';
      (_classPrivateFieldGet2 = _classPrivateFieldGet(_animation, _this2)) === null || _classPrivateFieldGet2 === void 0 || _classPrivateFieldGet2.cancel();
      _classPrivateFieldSet(_animation, _this2, showMoreContent.animate({
        height: ["".concat(startHeight, "px"), "".concat(endHeight, "px")]
      }, {
        duration: _classPrivateFieldGet(_animationSpeed, _this2),
        easing: 'ease-in-out'
      }));
      _classPrivateFieldGet(_animation, _this2).onfinish = function () {
        return _assertClassBrand(_ShowMoreComponent_brand, _this2, _onAnimationFinish).call(_this2);
      };
    });
    /**
     ...
     */
    _defineProperty(_this2, "toggle", function (event) {
      event.preventDefault();
      _classPrivateFieldGet(_updateBreakpointState, _this2).call(_this2);
      if (_classPrivateGetter(_ShowMoreComponent_brand, _this2, _get_currentBreakpoint) === 'DESKTOP' && _classPrivateFieldGet(_disableOnDesktop, _this2)) return;
      var _ref = !_classPrivateFieldGet(_expanded, _this2) ? _classPrivateFieldGet(_expand, _this2).call(_this2) : _classPrivateFieldGet(_collapse, _this2).call(_this2),
        startHeight = _ref.startHeight,
        endHeight = _ref.endHeight;
      _this2.dataset.expanded = _classPrivateFieldGet(_expanded, _this2) ? 'false' : 'true';
      _this2.refs.showMoreButton.setAttribute('aria-expanded', _this2.dataset.expanded);
      _classPrivateFieldGet(_animateHeight, _this2).call(_this2, startHeight, endHeight);
    });
    return _this2;
  }
  _inherits(ShowMoreComponent, _Component);
  return _createClass(ShowMoreComponent, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(ShowMoreComponent, "connectedCallback", this, 3)([]);
      _classPrivateFieldGet(_updateBreakpointState, this).call(this);
    }
  }]);
}(_theme_component__WEBPACK_IMPORTED_MODULE_0__.Component);
function _get_currentBreakpoint(_this) {
  return (0,_theme_utilities__WEBPACK_IMPORTED_MODULE_1__.isMobileBreakpoint)() ? 'MOBILE' : 'DESKTOP';
}
/**
 * Handles the animation finish event.
 */
function _onAnimationFinish() {
  var _this3 = this;
  var _this$refs = this.refs,
    showMoreContent = _this$refs.showMoreContent,
    showMoreItems = _this$refs.showMoreItems;
  if (_classPrivateFieldGet(_expanded, this)) {
    showMoreItems.forEach(function (item) {
      return item.classList.add(_classPrivateFieldGet(_disabledClass, _this3));
    });
  }
  showMoreContent.style.removeProperty('height');
  showMoreContent.style.overflow = '';
  _classPrivateFieldSet(_expanded, this, !_classPrivateFieldGet(_expanded, this));
}
