 ...
 */
var EmailSignupBlock = /*#__PURE__*/function (_HTMLElement) {
  function EmailSignupBlock() {
    var _this;
    _classCallCheck(this, EmailSignupBlock);
    _this = _callSuper(this, EmailSignupBlock);
    /** @type {number} */
    _this.lastButtonWidth = 0;
    /** @type {ResizeObserver | undefined} */
    _this.observer = undefined;
    _this.adjustInputPadding = _this.adjustInputPadding.bind(_this);
    return _this;
  }
  _inherits(EmailSignupBlock, _HTMLElement);
  return _createClass(EmailSignupBlock, [{
    ...
    value: function connectedCallback() {
      ...
      var isTextButton = this.button && this.button.classList.contains('email-signup__button--text');
      if (this.button && this.input && this.inputGroup && isTextButton) {
        this.adjustInputPadding();
        this.observer = new ResizeObserver(function () {
          _this2.adjustInputPadding();
        });
    ...
    value: function adjustInputPadding() {
      if (!this.button || !this.inputGroup) return;
      var buttonWidth = /** @type {HTMLElement} */this.button.offsetWidth;
      if (buttonWidth !== this.lastButtonWidth) {
        this.lastButtonWidth = buttonWidth;
        /** @type {HTMLElement} */
        this.inputGroup.style.setProperty('--button-actual-width', "".concat(buttonWidth, "px"));
      }
    }
  }]);
