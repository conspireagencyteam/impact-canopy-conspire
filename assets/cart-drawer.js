...
(() => {
/*!************************************!*\
  !*** ./src/scripts/cart-drawer.js ***!
  \************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _theme_dialog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @theme/dialog */ "./src/scripts/dialog.js");
 ...
 */
var _handleCartAdd = /*#__PURE__*/new WeakMap();
var CartDrawerComponent = /*#__PURE__*/function (_DialogComponent) {
  function CartDrawerComponent() {
    var _this;
    _classCallCheck(this, CartDrawerComponent);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, CartDrawerComponent, [].concat(args));
    _classPrivateFieldInitSpec(_this, _handleCartAdd, function () {
      if (_this.hasAttribute('auto-open')) {
        _this.showDialog();
      }
    });
    return _this;
  }
  _inherits(CartDrawerComponent, _DialogComponent);
  return _createClass(CartDrawerComponent, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(CartDrawerComponent, "connectedCallback", this, 3)([]);
      document.addEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_1__.CartAddEvent.eventName, _classPrivateFieldGet(_handleCartAdd, this));
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(CartDrawerComponent, "disconnectedCallback", this, 3)([]);
      document.removeEventListener(_theme_events__WEBPACK_IMPORTED_MODULE_1__.CartAddEvent.eventName, _classPrivateFieldGet(_handleCartAdd, this));
    }
  }, {
    key: "open",
    value: function open() {
       ...
       */
      customElements.whenDefined('shopify-payment-terms').then(function () {
        var _document$querySelect;
        var installmentsContent = (_document$querySelect = document.querySelector('shopify-payment-terms')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.shadowRoot;
        var cta = installmentsContent === null || installmentsContent === void 0 ? void 0 : installmentsContent.querySelector('#shopify-installments-cta');
        cta === null || cta === void 0 || cta.addEventListener('click', _this2.closeDialog, {
          once: true
        });
      });
    }
...
}(_theme_dialog__WEBPACK_IMPORTED_MODULE_0__.DialogComponent);
