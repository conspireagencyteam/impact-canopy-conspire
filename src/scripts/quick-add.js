...
export class QuickAddComponent extends Component {
  ...
  async updateQuickAddModal(productGrid) {
    ...
    const zoomDialog = productGrid.querySelector('zoom-dialog');
    if (zoomDialog) {
      zoomDialog.remove();
    }

    // Remove any standalone dialog elements that might auto-open
    const standaloneDialogs = productGrid.querySelectorAll('dialog[open]');
    standaloneDialogs.forEach(dialog => {
      dialog.remove();
    });
    ...
    const conflictingRefs = productGrid.querySelectorAll('[ref="dialog"], [ref="closeButton"]');
    conflictingRefs.forEach(element => {
    ...
    const closeButton = document.querySelector('#quick-add-dialog button[ref="closeButton"]');
    if (closeButton) {
...
class QuickAddDialog extends DialogComponent {
   ...
   */
  showDialog() {
    const dialog = this.querySelector('dialog.quick-add-modal');
